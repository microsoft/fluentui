...
`);
Default.decorators = [createDecorator()];
Default.parameters = { storyWright: { steps: defaultSteps } };
...
export const Checkbox = () =>
  ...
  `);
Checkbox.decorators = [createDecorator()];
Checkbox.parameters = { storyWright: { steps: checkboxSteps } };
...
export const Radio = () =>
  ...
  `);
Radio.decorators = [createDecorator()];
Radio.parameters = { storyWright: { steps: radioSteps } };
...
`);
WithIcons.decorators = [createDecorator()];
WithIcons.parameters = { storyWright: { steps: defaultSteps } };
...
`);
CheckboxWithIcons.decorators = [createDecorator()];
CheckboxWithIcons.parameters = { storyWright: { steps: checkboxSteps } };
...
`);
RadioWithIcons.decorators = [createDecorator()];
RadioWithIcons.parameters = { storyWright: { steps: radioSteps } };
...
`);
WithSubmenu.decorators = [createDecorator({ width: '500px', padding: '20px 0' })];
WithSubmenu.parameters = { storyWright: { steps: submenuSteps } };
