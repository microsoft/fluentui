    ...
    return (
      <div>
        ...
        <div className={ styles.featured }>
          ...
          <span className={ styles.featuredDescription } id={ styles.toolkitDescription }>The Fabric toolkit is built with Adobe XD and provides controls and layout templates that enable you to create seamless, beautiful Offices experiences. <a className={ styles.homePageLink } href='#/resources'>Learn more</a></span>
        </div>
      </div>
    );
  }
