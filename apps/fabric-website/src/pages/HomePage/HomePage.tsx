    ...
    return (
      <div>
        ...
        <div className={ styles.featured }>
          ...
          <span className={ styles.trademark }>All trademarks are the property of their respective owners. Usage of Fabric assets, such as fonts and icons, is subject to the <a href='https://static2.sharepointonline.com/files/fabric/assets/Microsoft_Fabric_Assets_License_Agreement_Sept092017.pdf'>assets license agreement</a>.</span>
