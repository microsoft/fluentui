      ...
      <div>
        ...
        <div className={css(styles.header, styles.headerComponents)}>
          ...
          <ul className={styles.features}>
            ...
            <li>
              ...
              <span className={styles.description}>
                ...
                <a href="https://github.com/OfficeDev/office-ui-fabric-react/blob/master/ghdocs/BROWSERSUPPORT.md">supported browsers</a>.
              </span>
            </li>
          </ul>
          <p>
          ...
          <img
            ...
            width="284"
            height="388"
            alt="Illustrated representation of a DatePicker and Persona list control."
          />
