          ...
          <div className="ms-Grid ms-Grid--wide">
            <div className="ms-Grid-row">
              ...
              <div className={css('ms-Grid-col ms-sm12 ms-lg8', styles.description)}>
                <p>
                  Use the resources on this page to ensure a consistent look and feel fore your project. This section includes design and
                ...
                <ul>
                  <li>
                    <a className={styles.relatedLink} href="https://aka.ms/fabric-toolkit">
                      Adobe XD Toolkit
                    </a>
                  </li>
                  <li>
                    <a className={styles.relatedLink} href="https://microsoft.sharepoint.com/teams/OfficeUIFabric97">
                      Adobe XD Toolkit (Microsoft employees)
                    </a>
                  </li>
                  <li>
                    <a className={styles.relatedLink} href="https://aka.ms/fabric-sketch-toolkit">
                      Sketch Toolkit
                    </a>
                  </li>
                  <li>
                    <a
                      ...
                      href="https://microsoft.sharepoint.com/teams/OfficeUIFabric97/SitePages/NEW-Fabric-Sketch-Toolkit!.aspx"
                    >
                      Sketch Toolkit (Microsoft employees)
                    </a>
                  </li>
                </ul>
                ...
                <ul>
                  <li>
                    <a className={styles.relatedLink} href="https://aka.ms/sharepoint-toolkit">
                ...
                <ul>
                  <li>
                    <a className={styles.relatedLink} href="https://aka.ms/addins_toolkit">
                      Add-ins XD Toolkit
                    </a>
                  </li>
                  <li>
                    <a className={styles.relatedLink} href="https://aka.ms/addins_sketch_toolkit">
                      Add-ins Sketch Toolkit
                    </a>
                  </li>
                </ul>
                ...
                <ul>
                  <li>
                    <a
                      className={styles.relatedLink}
                      href="https://static2.sharepointonline.com/files/fabric/fabric-website/files/segoeui_fabricmdl2_icon_fonts.zip"
                    >
                  ...
                  <li>
                    <a
                      className={styles.relatedLink}
                      href="https://microsoft.sharepoint.com/teams/OfficeUIFabric97/SitePages/Fabric%20MDL2%20Icons.aspx"
                    >
                ...
                <ul>
                  <li>
                    <a className={styles.relatedLink} href="#/styles/themegenerator">
                      Theme generator
                    </a>
                  </li>
                </ul>
          ...
          <div className="ms-Grid ms-Grid--wide">
            <div className="ms-Grid-row">
              ...
              <div className={css('ms-Grid-col ms-sm12 ms-lg8', styles.description)}>
                ...
                <p>
                  Check out{' '}
                  <a className={styles.relatedLink} href="https://github.com/OfficeDev/office-ui-fabric-react/blob/master/ghdocs/README.md">
                ...
                <ul>
                  <li>
                    <a className={styles.relatedLink} href="http://dev.office.com/docs/add-ins/overview/office-add-ins">
                      Add-ins overview
                    </a>
                  </li>
                  <li>
                    <a className={styles.relatedLink} href="http://dev.office.com/docs/add-ins/design/add-in-design">
                      Using Fabric in your Add-in
                    </a>
                  </li>
                  <li>
                ...
                <ul>
                  <li>
                    <a className={styles.relatedLink} href="https://aka.ms/spfx">
                      SharePoint Framework overview
                    </a>
                  </li>
                  <li>
                    <a className={styles.relatedLink} href="https://aka.ms/spfx-design-guidance">
                      Design guidance for building SharePoint experiences
                    </a>
                  </li>
                  <li>
                    <a className={styles.relatedLink} href="https://aka.ms/spfx-fabric-react">
                      Use Fabric React components in web parts
                    </a>
                  </li>
                  <li>
                    <a className={styles.relatedLink} href="https://aka.ms/spfx-tutorials">
            ...
            <div className="ms-Grid-row">
              <div className={css('ms-Grid-col ms-sm-12 ms-lg6', styles.channel)}>
                <div className={styles.imageWrapper}>
                  <img
                    src={'https://static2.sharepointonline.com/files/fabric/fabric-website/images/logo-github.svg'}
                    width="128"
                    height="128"
                    alt="Github logo"
                  />
              ...
              <div className={css('ms-Grid-col ms-sm-12 ms-lg6', styles.channel)}>
                <div className={styles.imageWrapper}>
                  <img
                    src={'https://static2.sharepointonline.com/files/fabric/fabric-website/images/logo-twitter.svg'}
                    width="128"
                    height="128"
                    alt="Twitter logo"
                  />
