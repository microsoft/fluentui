...
<img src="https://uifabric.azurewebsites.net/media/images/controls/ios/ProgressIndicator/ProgressIndicator.png" alt="Progress indicator control in a floating overlay." style="width: 25%;" />
