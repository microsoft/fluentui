...
import { PeoplePickerPageProps as ExternalProps } from '@fluentui/examples/lib/office-ui-fabric-react/PeoplePicker/PeoplePicker.doc';
...
const componentUrl =
  'https://github.com/microsoft/fluentui/blob/master/packages/office-ui-fabric-react/src/components/pickers/PeoplePicker';
