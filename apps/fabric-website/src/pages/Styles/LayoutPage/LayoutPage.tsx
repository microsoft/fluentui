...
function _otherSections(platform: Platforms): IPageSectionProps<Platforms>[] {
      ...
      return [
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                Fabric Core comes with a mobile-first, 12-column, responsive grid that you can use to create flexible layouts for a variety
                of screen sizes and device types.
              </p>
              <div className="ms-Grid" aria-label="Example Fabric Core grid where every row has a different number of columns.">
        ...
        },
        {
          ...
          content: (
            <>
              ...
              <p>
                Newer versions of Fabric Core require the <code>dir</code> attribute to be set to specify how the content should be rendered
  ...
  <div class="ms-Grid-row">
    ...
    <div class="ms-Grid-col ms-sm6 ms-md8 ms-lg10">B</div>
              ...
              <p>
                Because Fabric Core is mobile-first, any layout defined for small screens is automatically inherited by medium and large
                screens. The small size utilities (ms-sm6) are required. If you want to change the layout on larger screens, you can apply
                the other utility classes.
              </p>
              <p>
...
<div class="ms-Grid-col ms-sm8 ms-smPull4">Second in code</div>`}
              ...
              <p>
                Some designs call for certain content to be shown or hidden depending on the screen size. You can achieve this using Fabric
                Core's responsive visibility classes. These allow you to show or hide content at a specific screen size, or across a whole
                range of sizes.
              </p>
