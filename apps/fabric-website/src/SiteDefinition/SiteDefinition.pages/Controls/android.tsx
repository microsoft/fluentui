...
export const controlsPagesAndroid: INavPage[] = [
  {
    ...
    getComponent: cb =>
      require.ensure([], require =>
        cb(
          require<any>("../../../pages/Overviews/ControlsPage/ControlsPage")
            .ControlsPage
        )
      )
  },
    ...
    pages: [
      {
        ...
        getComponent: cb =>
          require.ensure([], require =>
            cb(
              require<any>("../../../pages/Controls/ButtonPage/ButtonPage")
                .ButtonPage
            )
          )
      }
    ...
    pages: [
      {
        ...
        getComponent: cb =>
          require.ensure([], require =>
            cb(
              require<any>("../../../pages/Controls/CalendarPage/CalendarPage")
                .CalendarPage
            )
          )
      },
        ...
        getComponent: cb =>
          require.ensure([], require =>
            cb(
              require<
                any
              >("../../../pages/Controls/DatePickerPage/DatePickerPage")
                .DatePickerPage
            )
          )
      },
        ...
        getComponent: cb =>
          require.ensure([], require =>
            cb(
              require<
                any
              >("../../../pages/Controls/PeoplePickerPage/PeoplePickerPage")
                .PeoplePickerPage
            )
          )
      }
    ...
    pages: [
      {
        ...
        getComponent: cb =>
          require.ensure([], require =>
            cb(
              require<any>("../../../pages/Controls/AvatarPage/AvatarPage")
                .AvatarPage
            )
          )
      },
      {
        ...
        getComponent: cb =>
          require.ensure([], require =>
            cb(
              require<any>("../../../pages/Controls/ChipPage/ChipPage").ChipPage
            )
          )
      },
      {
        ...
        getComponent: cb =>
          require.ensure([], require =>
            cb(
              require<
                any
              >("../../../pages/Controls/ListCellsPage/ListCellsPage")
                .ListCellsPage
            )
          )
      },
      {
        ...
        getComponent: cb =>
          require.ensure([], require =>
            cb(
              require<any>("../../../pages/Controls/PersonaPage/PersonaPage")
                .PersonaPage
            )
          )
      }
    ...
    pages: [
      {
        ...
        getComponent: cb =>
          require.ensure([], require =>
            cb(
              require<any>("../../../pages/Controls/SnackbarPage/SnackbarPage")
                .SnackbarPage
            )
          )
      }
    ...
    pages: [
      {
        ...
        getComponent: cb =>
          require.ensure([], require =>
            cb(
              require<any>("../../../pages/Controls/SpinnerPage/SpinnerPage")
                .SpinnerPage
            )
          )
      }
    ...
    pages: [
        ...
        getComponent: cb =>
          require.ensure([], require =>
            cb(
              require<
                any
              >("../../../pages/Controls/BottomSheetPage/BottomSheetPage")
                .BottomSheetPage
            )
          )
      },
      {
        ...
        getComponent: cb =>
          require.ensure([], require =>
            cb(
              require<any>("../../../pages/Controls/DrawerPage/DrawerPage")
                .DrawerPage
            )
          )
      },
        ...
        getComponent: cb =>
          require.ensure([], require =>
            cb(
              require<
                any
              >("../../../pages/Controls/PopupMenuPage/PopupMenuPage")
                .PopupMenuPage
            )
          )
      },
      {
        ...
        getComponent: cb =>
          require.ensure([], require =>
            cb(
              require<any>("../../../pages/Controls/TooltipPage/TooltipPage")
                .TooltipPage
            )
          )
      }
    ...
    pages: [
        ...
        getComponent: cb =>
          require.ensure([], require =>
            cb(
              require<
                any
              >("../../../pages/Controls/SeparatorPage/SeparatorPage")
                .SeparatorPage
            )
          )
      },
      {
        ...
        getComponent: cb =>
          require.ensure([], require =>
            cb(
              require<any>("../../../pages/Controls/TextPage/TextPage").TextPage
            )
          )
      }
    ]
