...
export const CrossPlatformLogoColor = (props?: ISVGIconProps) => {
  ...
  return (
    ...
    >
      ...
      <path d="M1 25V1H65V49H25" stroke="url(#paint0_linear)" strokeWidth="2" strokeLinecap="square" />
      <path d="M1 25V1H65V49H25" stroke="url(#paint1_linear)" strokeWidth="2" strokeLinecap="square" />
      <path d="M1 25V1H65V49H25" stroke="url(#paint2_linear)" strokeWidth="2" strokeLinecap="square" />
      <path d="M1 25V1H65V49H25" stroke="url(#paint3_linear)" strokeWidth="2" strokeLinecap="square" />
