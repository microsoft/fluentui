...
storiesOf('MessageBar', module)
  ...
  .add('Root dismiss', () => <MessageBar onDismiss={noop}>Info/default message bar. {link}</MessageBar>)
  ...
  .add('Root truncated', () => (
    <MessageBar truncated={true} isMultiline={false}>
      ...
      magna. Integer porta purus pulvinar, hendrerit felis eget, condimentum mauris. {link}
    </MessageBar>
  ))
  .add('Root actions', () => (
    <MessageBar
  ...
  .add('Error', () => <MessageBar messageBarType={MessageBarType.error}>Error message bar. {link}</MessageBar>)
  .add('Blocked', () => <MessageBar messageBarType={MessageBarType.blocked}>Blocked message bar. {link}</MessageBar>)
  .add('Severe Warning', () => (
    <MessageBar messageBarType={MessageBarType.severeWarning}>Severe Warning message bar. {link}</MessageBar>
  ))
  .add('Success', () => <MessageBar messageBarType={MessageBarType.success}>Success message bar. {link}</MessageBar>)
  .add('Warning', () => <MessageBar messageBarType={MessageBarType.warning}>Warning message bar. {link}</MessageBar>);
