...
storiesOf('Accordion Converged', module)
  ...
  .addStory(
    ...
    () => (
      <Accordion openItems={[]}>
        <AccordionItem value={0}>
          <AccordionHeader expandIcon={<Circle20Regular />} expandIconPosition="start">
            Expand Icon Start
          </AccordionHeader>
          <AccordionPanel>Expand Icon Start Panel</AccordionPanel>
        </AccordionItem>
        <AccordionItem value={1}>
          <AccordionHeader expandIcon={<Circle20Regular />} expandIconPosition="end">
            Expand Icon End
          </AccordionHeader>
          <AccordionPanel>Expand Icon End Panel</AccordionPanel>
        </AccordionItem>
        <AccordionItem value={2}>
          <AccordionHeader inline expandIcon={<Circle20Regular />} expandIconPosition="end">
  ...
  .addStory(
    ...
    () => (
      <Accordion openItems={[]}>
        <AccordionItem value={0}>
          <AccordionHeader icon={<Circle20Regular />} expandIconPosition="start">
            Icon Start
          </AccordionHeader>
          <AccordionPanel>Icon Start Panel</AccordionPanel>
        </AccordionItem>
        <AccordionItem value={1}>
          <AccordionHeader icon={<Circle20Regular />} expandIconPosition="end">
            Icon End
          </AccordionHeader>
          <AccordionPanel>Icon End Panel</AccordionPanel>
        </AccordionItem>
        <AccordionItem value={2}>
          <AccordionHeader inline icon={<Circle20Regular />} expandIconPosition="end">
            Icon Inline End
          </AccordionHeader>
