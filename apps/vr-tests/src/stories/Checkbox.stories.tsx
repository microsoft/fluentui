...
const indeterminateSteps = new Steps()
...
UncontrolledIndeterminateCheckbox.parameters = {
  steps: indeterminateSteps,
};
...
UncontrolledIndeterminateDefaultCheckedCheckbox.parameters = {
  steps: indeterminateSteps,
};
...
ControlledIndeterminateCheckboxWithoutOnChangeCallback.parameters = {
  steps: indeterminateSteps,
};
...
UncontrolledAndControlledIndeterminateCheckbox.parameters = {
  steps: indeterminateSteps,
};
