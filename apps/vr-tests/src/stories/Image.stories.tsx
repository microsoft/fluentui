...
const imagePropsFitContain = {
  src: 'http://placehold.it/700x300',
  imageFit: ImageFit.contain
};

const imagePropsFitCover = {
  src: 'http://placehold.it/500x500',
  imageFit: ImageFit.cover
};

const imagePropsMaximizeFrame = {
  src: 'http://placehold.it/500x500',
  imageFit: ImageFit.cover,
  maximizeFrame: true
};
...
const imageStories = {
  ...
  stories: {
    ...
    'Maximize frame, landscape container': () => (
      <div>
    ...
    'Maximize frame, portrait container': () => (
      <Layer>sdfsfdsf</Layer>
    )
  }
};

runStories('Image', imageStories);