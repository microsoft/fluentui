...
import { MainPanelContentWrapper, MainPanelInnerContent, MainPanelNumericalWidth } from '../../shared/MainPanelStyles';
          ...
          <Stack gap={32}>
            ...
            <Stack horizontal gap={columnSpace}>
              ...
              <Stack.Item className={sampleColumn} grow={1}>
                <Stack gap={32}>
                  <Slider max={11} />
                  <Toggle onText="On" offText="Off" inlineLabel label="Label on the control's left" />
                  <Pivot>
