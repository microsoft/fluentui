...
export const AccessibilityDetailsList: React.StatelessComponent<IAccessibilityDetailsListProps> = (
  ...
  for (let i = 0; i < allContrastRatioPairs.length; i++) {
    items.push({
      ...
      stringToMatchLeftPanel: allContrastRatioPairs[i].stringToMatchLeftPanel,
  ...
  columns = [
    ...
    { key: 'stringToMatchLeftPanel', name: 'Color pair', fieldName: 'stringToMatchLeftPanel', minWidth: 100, maxWidth: 200 },
