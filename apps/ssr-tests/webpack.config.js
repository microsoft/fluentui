...
module.exports = resources.createConfig('ssr-tests', false, {
  ...
  resolve: {
    alias: {
      ...
      '@uifabric/fabric-website-resources/src': path.join(__dirname, '../../packages/@uifabric/fabric-website-resources/src'),
      '@uifabric/fabric-website-resources/lib': path.join(__dirname, '../../packages/@uifabric/fabric-website-resources/lib'),
