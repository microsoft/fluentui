...
export async function getPerfRegressions() {
  ...
  console.log(
    `##vso[task.setvariable variable=PerfCommentFilePathReactComponents;]apps/perf-test-react-components/dist/perfCounts.html`,
  );
  console.log(`##vso[task.setvariable variable=PerfCommentStatusReactComponents;]${status}`);
}
