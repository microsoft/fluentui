...
<Meta title="Concepts/Upgrading/from v0/Components/Loader Upgrade" />
...
| `inline`        | n/a             |                                          |
| `label`         | `label`         |                                          |
| `labelPosition` | `labelPosition` | The default value changes to 'after'     |
| `size`          | `size`          |                                          |
| `styles`        | `className`     |                                          |
| `svg`           | n/a             |                                          |
