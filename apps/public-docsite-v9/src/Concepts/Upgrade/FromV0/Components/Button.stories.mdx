...
| icon              | keep it as is. See [Button + Icon integration](#./Button-+-Icon-integration) in this document             |
| iconOnly          | REMOVED: see [Migrate iconOnly prop](#./Migrate-`iconOnly`-prop) in this document                         |
| iconPosition      | keep it as is                                                                                             |
| inverted          | REMOVED: use styles and color tokens to set a proper styling \*                                           |
| loader, loading   | REMOVED: see [Migrate loading and loader props](#./Migrate-`loading`-and-`loader`-props) in this document |
