...
| icon                      | keep it as is                                                                                            |
| image                     | see [Migrate image prop](#./Migrate-`image`-prop) in this document                                       |
| label                     | use `initials` prop instead                                                                              |
| name                      | keep it as is                                                                                            |
| size                      | see [Migrate size prop](#./Migrate-`size`-prop) in this document                                         |
| square                    | replace with `shape="square"`                                                                            |
| status                    | see [Migrate status prop](#./Migrate-`status`-prop) in this document                                     |
