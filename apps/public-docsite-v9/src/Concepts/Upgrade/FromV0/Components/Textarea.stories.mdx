...
Fluent UI Northstar (v0) provides the `TextArea` control to allow users to enter and edit multi-line text. Fluen UI v9 provides a `Textarea` control, but has a different API.
