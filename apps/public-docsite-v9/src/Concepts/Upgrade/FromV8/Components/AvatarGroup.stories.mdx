...
v9 also provides a function `partitionAvatarGroupItems` that will split the items provided with the right behavior based on the layout provided. It is highly
encouraged to use this function as each layout has a specific way of arranging the items.
