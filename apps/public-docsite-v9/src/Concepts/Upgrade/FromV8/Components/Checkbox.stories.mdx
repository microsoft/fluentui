...
The main difference between v8 and v9 `Checkbox` is that v9 offers a circular variant. v9 handles checked and indeterminate differently from v0, v9 combines both into the `checked` and `defaultChecked` props.
