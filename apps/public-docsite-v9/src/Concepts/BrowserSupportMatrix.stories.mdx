...
ECMAScript features, Fluent UI will be targetting ES2020 and thus will be shipping an ES2020 compliant bundle which will be fully compatible with the
...
- As previously mentioned, Fluent UI will be targetting ES2020 as its Typescript target. Some ES2020 features are already present
...
2. Since Fluent UI will be transpiling down and shipping an ES2020 bundle, Fluent UI developers will internally develop against the latest ES standards.
