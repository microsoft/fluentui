...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>`loading`</td>
      <td>Not supported -> use onLoad and onError events</td>
    </tr>
    <tr>
      <td>`onLoadingStateChange`</td>
      <td>Not supported -> use onLoad and onError events</td>
    </tr>
    <tr>
      <td>`shouldFadeIn`</td>
      <td>Not supported -> implement animation via makeStyles and className + onLoad</td>
    </tr>
    <tr>
      <td>`shouldStartVisible`</td>
      <td>Not supported -> use onLoad and onError events</td>
    </tr>
    <tr>
      <td>`theme`</td>
      <td>Use `FluentProvider` to customize the theme</td>
    </tr>
  </tbody>
</table>
