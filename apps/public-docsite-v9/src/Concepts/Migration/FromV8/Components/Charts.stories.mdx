...
But they work across v8 and v9 themes using the v8ThemeShim.
...
Refer [Fluent v8 charts](https://aka.ms/fluentCharting) for detailed examples and code snippets of available charts.
