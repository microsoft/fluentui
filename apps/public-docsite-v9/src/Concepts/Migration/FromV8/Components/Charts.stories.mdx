...
<Meta title="Concepts/Migration/from v8/Components/Charts" />

# Charts Migration Guide

Fluent Chart controls are built on fluent v8 stack. But they work across v8 and v9 themes using the v8ThemeShim.
Currently charts are brand invariant and don't require a BrandVariant palette.
This would likely change as we onboard new products and their unique theme requirements.
See below examples for different scenarios of using chart with v9 theme.

Refer aka.ms/fluentCharting for detailed component wise usage.

Supporting all v9 concepts for charts is planned and coming soon.
Complete [this](https://aka.ms/chartingv9survey) short survey to share your data viz scenarios for v9.
You can also report any bugs
...
Wrap any custom jsx element like HoverCard, or Callout in an explicit FluentProvider contex.
...
Refer to the [sample application](https://github.com/microsoft/fluentui-charting-contrib/tree/main/tools/v9-migration) for complete source code.
