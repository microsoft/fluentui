...
const RadioGroupBasicExample = () => {
  ...
  return (
    <>
      ...
      <RadioGroup aria-labelledby={labelId} defaultValue="B" required>
...
| v8                   | v9                    | Notes                                                                |
| -------------------- | --------------------- | -------------------------------------------------------------------- |
| `componentRef`       | `ref`                 | v9 provides access to the underlying DOM node, not `IChoiceGroup`    |
...
| `disabled`           | `disabled`            | Apply to `RadioGroup` to disable every option                        |
...
| `labelId`          | n/a          | Provide an id to the `label` slot via shorthand props or a custom component                                    |
