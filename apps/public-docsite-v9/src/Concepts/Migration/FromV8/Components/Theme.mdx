...
To be use v9 components inside v8 components like `Panel` & `Callout`, please enable [portal compatibility](/docs/concepts-migration-from-v8-troubleshooting--docs#portal-compatibility).
