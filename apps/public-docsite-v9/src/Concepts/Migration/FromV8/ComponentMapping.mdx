...
| DetailsList            | [DataGrid](/docs/components-datagrid--docs)                                                                                                             | Use `Table` for simple read-only tables or `DataGrid` for interactive sorting and selection. |
...
| Icon                   | [@fluentui/react-icons package](https://react.fluentui.dev/?path=/story/icons-catalog--docs)                                                            | v9 provides more customization options.                                                      |
...
| OverflowSet            | [Overflow](/docs/components-overflow--docs)                                                                                                             | Replace render callbacks with `OverflowItem` children and an overflow menu.                  |
