...
| accessibility             | see [migrate-custom-accessibility.md](../migrate-custom-accessibility.md)                                                                               |
...
⚠️ **If this is your first migration**, please read [the general guide on how to migrate styles](../migrate-styles.md).
...
See [Toolbar Overflow Items example](https://react.fluentui.dev/?path=/docs/preview-components-toolbar--default#overflow-items)
