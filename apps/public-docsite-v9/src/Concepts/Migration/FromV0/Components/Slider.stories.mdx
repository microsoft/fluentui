...
To help with the migration we also offer a mixin that [can be checked here](/?path=/docs/migration-shims-v0-slidermixin--fluid)
...
Slider upgrade doc in V9: [Slider upgrade to V9](https://react.fluentui.dev/?path=/docs/concepts-upgrading-from-v8-components-slider-upgrade--v-8-example)
