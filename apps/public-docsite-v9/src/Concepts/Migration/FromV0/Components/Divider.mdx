...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>important</td>
      <td>see Migrate important prop in this document</td>
    </tr>
    <tr>
      <td>size</td>
    ...
    <tr>
      <td>color</td>
      <td>
        replace `color="brand"` with `appearance="brand"`. For other color value, add style override with makeStyles and
        color tokens
      </td>
    </tr>
  </tbody>
