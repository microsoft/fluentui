...
- things to consider when planning migrate work
...
We recommend first migrating v7 to v8. The migrate is mostly fixing a few breaking changes and replacing some deprecated components or props with newer versions.
...
We won't sugarcoat it; migrating from v8 to v9 is more involved than the previous v7 to v8 migrate.
