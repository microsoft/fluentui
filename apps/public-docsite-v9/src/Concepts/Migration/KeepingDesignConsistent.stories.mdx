...
If your migration effort is small, you can migrate all at once, or your users are OK with some inconsistency, you might decide to avoid extra effort and live with it.
