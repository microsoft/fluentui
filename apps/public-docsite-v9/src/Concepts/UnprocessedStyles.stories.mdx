...
| `@fluentui-copilot/*`        | ⚠️ Yes                 | ✅ Available          | [v0.28.4+](https://www.npmjs.com/package/@fluentui-copilot/react-copilot/v/0.28.4), [older major version back-ports / v0.25.3-hotfix.1](https://www.npmjs.com/package/@fluentui-copilot/react-copilot/v/0.25.3-hotfix.1) |
