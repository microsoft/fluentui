      ...
      return [
        {
          ...
          content: require('!raw-loader!@fluentui/public-docsite/src/pages/Overviews/GetStartedPage/docs/web/GetStartedDevelopExisting.md') as string,
        ...
        },
        {
          ...
          content: require('!raw-loader!@fluentui/public-docsite/src/pages/Overviews/GetStartedPage/docs/web/GetStartedDevelopSimple.md') as string,
        },
        {
          sectionName: 'Next steps with Fluent UI React',
          jumpLinkName: enDash + ' Next steps',
          editUrl: baseUrl + 'docs/web/GetStartedNextSteps.md',
          content: require('!raw-loader!@fluentui/public-docsite/src/pages/Overviews/GetStartedPage/docs/web/GetStartedNextSteps.md') as string,
        },
        {
          sectionName: 'Fabric Core',
          editUrl: baseUrl + 'docs/web/GetStartedDevelopCore.md',
          content: require('!raw-loader!@fluentui/public-docsite/src/pages/Overviews/GetStartedPage/docs/web/GetStartedDevelopCore.md') as string,
        },
        {
          sectionName: 'Use our design language in your site',
          jumpLinkName: 'Design language',
          editUrl: baseUrl + 'docs/web/GetStartedDesign.md',
          content: require('!raw-loader!@fluentui/public-docsite/src/pages/Overviews/GetStartedPage/docs/web/GetStartedDesign.md') as string,
        },
      ];
