...
```jsx
const MediaObject: React.FC<{}> = ({ children }) => {
  const styles = useStyles();

  return (
    <div className={styles.parent}>
      {/** Media goes here 🖼️ **/}
      <div className={styles.text}>{/** Text lines go here 📝 **/}</div>
    </div>
  );
};
```
...
const MediaObject: React.FC<{}> = ({ children }) => {
  ...
  return (
    <div className={styles.parent}>
      <div className={styles.media}>{/** This should be your media 🖼️ **/}</div>
      {/** Text line goes here 📝 **/}
      {/** Text line goes here 📝 **/}
      {/** Text line goes here 📝 **/}
      {/** Text line goes here 📝 **/}
...
const MediaObject: React.FC<{}> = ({ children }) => {
  ...
  return (
    <div className={styles.parent}>
      <div className={styles.media}>{/** This should be your media 🖼️ **/}</div>
      <span className={styles.text}>{/** This should be your text line 📝 **/}</span>
      <span className={styles.text}>{/** This should be your text line 📝 **/}</span>
      <span className={styles.text}>{/** This should be your text line 📝 **/}</span>
      {/** ... **/}
    </div>
