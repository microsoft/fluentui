    ...
    plugin(({ addBase }) => {
      addBase({
        ':root': {
          ...
          '--status-success-foreground': theme.colorStatusSuccessForeground1,
          '--success-surface': theme.colorStatusSuccessBackground1,
          '--status-warning-foreground': theme.colorStatusWarningForeground1,
          '--warning-surface': theme.colorStatusWarningBackground1,
          '--status-danger-foreground': theme.colorStatusDangerForeground1,
          '--danger-surface': theme.colorStatusDangerBackground1,
        },
        '.dark': {
          ...
          '--status-success-foreground': webDarkTheme.colorStatusSuccessForeground1,
          '--success-surface': webDarkTheme.colorStatusSuccessBackground1,
          '--status-warning-foreground': webDarkTheme.colorStatusWarningForeground1,
          '--warning-surface': webDarkTheme.colorStatusWarningBackground1,
          '--status-danger-foreground': webDarkTheme.colorStatusDangerForeground1,
          '--danger-surface': webDarkTheme.colorStatusDangerBackground1,
        },
      });
    }),
  ],
