...
<div className="components-hero">
  <div className="hero-subtitle">
    ...
    <a href="/react/motion/introduction">Fluent Motion System</a>.
  </div>
</div>
...
- **[Fade](/react/motion/components-preview/fade)** — Simple opacity transitions
- **[Scale](/react/motion/components-preview/scale)** — Grow and shrink animations
- **[Collapse](/react/motion/components-preview/collapse)** — Expandable height/width
- **[Slide](/react/motion/components-preview/slide)** — Directional slide animations
- **[Blur](/react/motion/components-preview/blur)** — Focus/blur effects
- **[Rotate](/react/motion/components-preview/rotate)** — 3D rotation effects
- **[Stagger](/react/motion/choreography-preview/stagger)** — Sequential animation choreography
- **[Motion Atoms](/react/motion/components-preview/atoms)** — Building blocks for custom components
