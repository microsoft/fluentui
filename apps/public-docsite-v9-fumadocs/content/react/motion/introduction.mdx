...
**Most users start with Molecules** — the pre-built components like `<Fade>` and `<Scale>` that work out of the box. When you need a custom effect, you can compose atoms together using the factories. See <a href="/react/motion/components-preview/atoms">Motion Atoms</a> for the full API.
...
The full set of duration and easing tokens is available on the <a href="/react/motion/tokens">Motion Tokens</a> page.
...
See all curves with interactive previews on the <a href="/react/motion/tokens">Motion Tokens</a> page.
...
See all components with interactive demos on the <a href="/react/motion/components-preview/introduction">Motion Components</a> page.
...
For most use cases, you don't need the factories — use the <a href="/react/motion/components-preview/introduction">pre-built Motion Components</a> instead.
...
<div className="principles-grid">
  <Card appearance="filled">
    ...
    <div>
      Dive into <a href="/react/motion/apis/create-presence-component">createPresenceComponent</a> and{' '}
      <a href="/react/motion/apis/create-motion-component">createMotionComponent</a> for full API documentation.
    </div>
  </Card>
  <Card appearance="filled">
    <CardHeader header={<h3>🧩 Use Pre-built Components</h3>} />
    <div>
      Explore the <a href="/react/motion/components-preview/introduction">Motion Components</a> for ready-to-use
      animations.
    </div>
  </Card>
  <Card appearance="filled">
    ...
    <div>
      See all available <a href="/react/motion/tokens">Motion Tokens</a> for durations and easing curves.
    </div>
  </Card>
  <Card appearance="filled">
    <CardHeader header={<h3>🔄 Migrate from Other Libraries</h3>} />
    <div>
      Coming from Framer Motion or GSAP? Check our <a href="/react/motion/migration">Migration Guide</a>.
    </div>
  </Card>
  <Card appearance="filled">
    <CardHeader header={<h3>⚛️ Motion Atoms</h3>} />
    <div>
      Build custom animations by composing <a href="/react/motion/components-preview/atoms">low-level atoms</a> like{' '}
      <code>fadeAtom</code> and <code>scaleAtom</code>.
    </div>
  </Card>
</div>
