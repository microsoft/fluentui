...
For detailed accessibility guidance, see [Accessibility](/react/guide/accessibility/components-overview).

## Relationship to other customization options

- Use [Styling Components](/react/guide/styling-components) for standard style overrides.
- Use [Advanced Styling Techniques](/react/guide/advanced-styling-techniques) for app-wide style hook customization.
- Use [Customizing Components with Slots](/react/guide/customizing-components-with-slots) for part-level composition within existing components.
