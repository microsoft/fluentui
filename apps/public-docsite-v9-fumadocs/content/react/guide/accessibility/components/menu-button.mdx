...
Like `Button`, `MenuButton` requires an accessible label. The label rules from [Button](/react/guide/accessibility/components/button) apply unchanged.
