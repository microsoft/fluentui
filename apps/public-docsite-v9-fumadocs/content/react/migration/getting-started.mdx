...
See the [Customizing Components with Slots](/react/guide/customizing-components-with-slots) topic for more details.
...
See [Keeping Design Consistent](/react/migration/keeping-design-consistent).
