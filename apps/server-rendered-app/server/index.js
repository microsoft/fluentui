...
const ReactMinScripts =
  `<script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/react/17.0.1/umd/react.production.min.js"></script>` +
  `<script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/react-dom/17.0.1/umd/react-dom.production.min.js"></script>`;

const ReactScripts =
  `<script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/react/17.0.1/umd/react.development.js"></script>` +
  `<script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/react-dom/17.0.1/umd/react-dom.development.js"></script>`;
