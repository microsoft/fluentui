...
export default {
  title: 'Table layout flex',
} satisfies Meta<typeof Table>;

export const SizeMediumStory = () => <SizeMedium noNativeElements={true} />;
...
export const SizeSmallStory = () => <SizeSmall noNativeElements={true} />;
SizeSmallStory.storyName = 'size - small';

export const SizeExtraSmallStory = () => <SizeExtraSmall noNativeElements={true} />;
SizeExtraSmallStory.storyName = 'size - extra small';

export const PrimaryCellStory = () => <PrimaryCell noNativeElements={true} />;
PrimaryCellStory.storyName = 'primary cell';

export const MultiselectStory = () => <Multiselect noNativeElements={true} />;
...
export const MultiselectCheckedBrand = () => (
  <MultiselectChecked noNativeElements={true} selectedRowAppearance="brand" />
);
...
export const MultiselectMixedBrand = () => <MultiselectMixed noNativeElements={true} selectedRowAppearance="brand" />;
...
export const SingleSelectStory = () => <SingleSelect noNativeElements={true} />;
...
export const SingleSelectCheckedBrand = () => (
  <SingleSelectChecked noNativeElements={true} selectedRowAppearance="brand" />
);
...
export const MultiselectCheckedNeutral = () => (
  <MultiselectChecked noNativeElements={true} selectedRowAppearance="neutral" />
);
...
export const MultiselectMixedNeutral = () => (
  <MultiselectMixed noNativeElements={true} selectedRowAppearance="neutral" />
);
...
export const SingleSelectCheckedNeutral = () => (
  <SingleSelectChecked noNativeElements={true} selectedRowAppearance="neutral" />
);
...
export const SingleSelectCheckedStory = () => <SingleSelectChecked noNativeElements={true} />;
