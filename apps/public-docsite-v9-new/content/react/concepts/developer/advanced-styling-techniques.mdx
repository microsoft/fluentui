...
> This page focuses on style customization of existing Fluent components. If you need architecture-level control over rendering and want Fluent behavior primitives without default styling, see [Building custom components](?path=/docs/react/concepts/developer/building-custom-controls).
...
import { FANCY_CUSTOM_STYLE_HOOKS } from '@repo/apps/public-docsite-v9/src/Concepts/FancyAppCustomStyleHooksValue.ts';
...
import { useFancyButtonStyles } from '@repo/apps/public-docsite-v9/src/Concepts/useFancyButtonStyles';
...
```diff
// App.tsx
+ import { FANCY_CUSTOM_STYLE_HOOKS } from '@repo/apps/public-docsite-v9/src/Concepts/FancyAppCustomStyleHooksValue';
