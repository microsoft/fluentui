...
Like `Button`, `MenuButton` requires an accessible label. The label rules from [Button](/react/concepts/developer/accessibility/components/button#docs) apply unchanged.
