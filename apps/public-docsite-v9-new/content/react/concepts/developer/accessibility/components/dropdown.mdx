...
import clickImg from '@repo/packages/react-components/react-combobox/stories/src/assets/Dropdown/dropdown-click.png';
import collapsedImg from '@repo/packages/react-components/react-combobox/stories/src/assets/Dropdown/dropdown-collapsed.png';
import hoverImg from '@repo/packages/react-components/react-combobox/stories/src/assets/Dropdown/dropdown-hover.png';
import keySelectImg from '@repo/packages/react-components/react-combobox/stories/src/assets/Dropdown/dropdown-key-select.png';
import multiselect1Img from '@repo/packages/react-components/react-combobox/stories/src/assets/Dropdown/dropdown-multiselection1.png';
import multiselect2Img from '@repo/packages/react-components/react-combobox/stories/src/assets/Dropdown/dropdown-multiselection2.png';
import navImg from '@repo/packages/react-components/react-combobox/stories/src/assets/Dropdown/dropdown-nav.png';
import openImg from '@repo/packages/react-components/react-combobox/stories/src/assets/Dropdown/dropdown-open.png';
import optionHoverImg from '@repo/packages/react-components/react-combobox/stories/src/assets/Dropdown/dropdown-option-hover.png';
import selectedOpenImg from '@repo/packages/react-components/react-combobox/stories/src/assets/Dropdown/dropdown-selected-open.png';
import semanticsImg from '@repo/packages/react-components/react-combobox/stories/src/assets/Dropdown/dropdown-semantics.png';
import tabbingImg from '@repo/packages/react-components/react-combobox/stories/src/assets/Dropdown/dropdown-tabbing.png';
