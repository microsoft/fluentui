...
The [AccordionHeader](/docs/react/accordion#default) component uses `createFocusOutlineStyle` to style the default outline style when focus is detected

[See the default example](/docs/react/accordion#default)
...
The [Link](/docs/react/link#default) component uses `createCustomFocusIndicatorStyle` to add a double underlined focus indication style

[See the default example](/docs/react/link#default)
