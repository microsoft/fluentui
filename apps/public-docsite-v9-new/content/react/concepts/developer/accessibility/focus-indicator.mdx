...
The [AccordionHeader](/react/components/accordion#default) component uses `createFocusOutlineStyle` to style the default outline style when focus is detected

[See the default example](/react/components/accordion#default)
...
The [Link](/react/components/link#default) component uses `createCustomFocusIndicatorStyle` to add a double underlined focus indication style

[See the default example](/react/components/link#default)
