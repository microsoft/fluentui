...
Using components themselves does not guarantee that an application or a page will be accessible. Please see the [Accessible Experiences](/react/concepts/developer/accessibility/experiences) page for further points on achieving good level of usability.
...
- Displaying [**focus indicator**](/react/concepts/developer/accessibility/focus-indicator) when keyboard is used to interact with them
