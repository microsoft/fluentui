...
import { SlotSketch } from '@repo/apps/public-docsite-v9/src/Concepts/Slots/SlotSketch.stories';
...
- If you want to change how a component behaves, make significant layout and style changes,
  ...
  See [Building custom components](?path=/docs/react/concepts/developer/building-custom-controls) for guidance.
