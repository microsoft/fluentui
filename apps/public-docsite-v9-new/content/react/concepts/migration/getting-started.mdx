...
See the [Customizing Components with Slots](/react/concepts/developer/customizing-components-with-slots) topic for more details.
...
See [Keeping Design Consistent](/react/concepts/migration/keeping-design-consistent).
