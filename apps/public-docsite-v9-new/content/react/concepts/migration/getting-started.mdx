...
See the [Customizing Components with Slots](/docs/react/concepts/developer/customizing-components-with-slots) topic for more details.
...
See [Keeping Design Consistent](/docs/react/concepts/migration/keeping-design-consistent).
