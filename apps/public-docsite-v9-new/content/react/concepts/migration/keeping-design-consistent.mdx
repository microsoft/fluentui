...
Read [Styling Components](/docs/react/concepts/developer/styling-components) for details.

Because `FluentProvider` defines design token values as CSS variables, you can reference them your own component styles.
Read [Theming](/docs/react/concepts/developer/theming) to see examples.
...
See _Extending themes with new tokens_ section in [Theming](/docs/react/concepts/developer/theming).
