...
import { ComponentsGrid } from '@repo/packages/react-components/react-motion-components-preview/stories/src/Introduction/ComponentsGrid';
import { InOutDemo } from '@repo/packages/react-components/react-motion-components-preview/stories/src/Introduction/InOutDemo';
import { VariantsDemo } from '@repo/packages/react-components/react-motion-components-preview/stories/src/Introduction/VariantsDemo';
...
<div className="components-hero">
  ...
  <div className="hero-subtitle">
    ...
    <a href="?path=/docs/react/introduction">Fluent Motion System</a>.
  </div>
</div>
...
- **[Fade](?path=/docs/react/fade)** — Simple opacity transitions
- **[Scale](?path=/docs/react/scale)** — Grow and shrink animations
- **[Collapse](?path=/docs/react/collapse)** — Expandable height/width
- **[Slide](?path=/docs/react/slide)** — Directional slide animations
- **[Blur](?path=/docs/react/blur)** — Focus/blur effects
- **[Rotate](?path=/docs/react/rotate)** — 3D rotation effects
- **[Stagger](?path=/docs/react/choreography/stagger)** — Sequential animation choreography
- **[Motion Atoms](?path=/docs/react/motion/components-preview/atoms)** — Building blocks for custom components
