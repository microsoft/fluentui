...
- **[Fade](/docs/react/fade#docs)** — Simple opacity transitions
- **[Scale](/docs/react/scale#docs)** — Grow and shrink animations
- **[Collapse](/docs/react/collapse#docs)** — Expandable height/width
- **[Slide](/docs/react/slide#docs)** — Directional slide animations
- **[Blur](/docs/react/blur#docs)** — Focus/blur effects
- **[Rotate](/docs/react/rotate#docs)** — 3D rotation effects
- **[Stagger](/docs/react/choreography/stagger#docs)** — Sequential animation choreography
- **[Motion Atoms](/react/motion/components-preview/atoms#docs)** — Building blocks for custom components
