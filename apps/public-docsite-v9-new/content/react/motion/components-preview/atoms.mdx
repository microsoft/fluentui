...
<div className="atoms-hero">
  <div className="hero-subtitle">
    The smallest building blocks in the <a href="/react/motion/introduction">Fluent Motion System</a>. Each atom
...
<div className="warning-banner">
  ...
  the pre-built <a href="/react/motion/components-preview/introduction">Motion Components</a> like <code>Fade</code>,{' '}
  <code>Scale</code>, etc.
</div>

## What are Motion Atoms?

In the Fluent Motion System's <a href="/react/motion/introduction#an-atomic-motion-system">atomic model</a>, **atoms** are single one-way animations — keyframes changing one property over time. They're the foundation that <a href="/react/motion/components-preview/introduction">Motion Components</a> (molecules) are built from.
...
- [Motion Components](/react/motion/components-preview/introduction) — Pre-built presence animations (molecules)
- [createPresenceComponent](/react/motion/apis/create-presence-component) — Factory for presence components
- [createMotionComponent](/react/motion/apis/create-motion-component) — Factory for one-way motion
- [Motion Tokens](/react/motion/tokens) — Duration and easing values
