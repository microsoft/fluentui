...
import { AtomsDemo } from '@repo/packages/react-components/react-motion-components-preview/stories/src/Atoms/AtomsDemo';
import { ComposingAtomsDemo } from '@repo/packages/react-components/react-motion-components-preview/stories/src/Atoms/ComposingAtomsDemo';
...
<div className="atoms-hero">
  ...
  <div className="hero-subtitle">
    The smallest building blocks in the <a href="?path=/docs/react/introduction">Fluent Motion System</a>. Each atom
    produces a single animation effect that can be composed into richer motion.
  </div>
</div>

<div className="warning-banner">
  <strong>⚠️ Advanced API:</strong> Atoms are for developers creating custom motion components. For most use cases, use
  the pre-built <a href="?path=/docs/react/motion/components-preview/introduction">Motion Components</a> like{' '}
  <code>Fade</code>, <code>Scale</code>, etc.
</div>

## What are Motion Atoms?

In the Fluent Motion System's <a href="?path=/docs/react/introduction#an-atomic-motion-system">atomic model</a>, **atoms** are single one-way animations — keyframes changing one property over time. They're the foundation that <a href="?path=/docs/react/motion/components-preview/introduction">Motion Components</a> (molecules) are built from.
...
- [Motion Components](?path=/docs/react/motion/components-preview/introduction) — Pre-built presence animations (molecules)
- [createPresenceComponent](?path=/docs/react/create-presence-component) — Factory for presence components
- [createMotionComponent](?path=/docs/react/create-motion-component) — Factory for one-way motion
- [Motion Tokens](?path=/docs/react/motion/tokens) — Duration and easing values
