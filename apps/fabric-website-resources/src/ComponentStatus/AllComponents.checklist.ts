...
export const AllComponentsStatus: IComponentStatusState = {
  ActivityItem: require<any>('office-ui-fabric-react/lib/components/ActivityItem/ActivityItem.checklist').ActivityItemStatus,
  ...
  ChoiceGroup: require<any>('office-ui-fabric-react/lib/components/ChoiceGroup/ChoiceGroup.checklist').ChoiceGroupStatus,
  ColorPicker: require<any>('office-ui-fabric-react/lib/components/ColorPicker/ColorPicker.checklist').ColorPickerStatus,
  ...
  ContextualMenu: require<any>('office-ui-fabric-react/lib/components/ContextualMenu/ContextualMenu.checklist').ContextualMenuStatus,
  DatePicker: require<any>('office-ui-fabric-react/lib/components/DatePicker/DatePicker.checklist').DatePickerStatus,
  DetailsList: require<any>('office-ui-fabric-react/lib/components/DetailsList/DetailsList.checklist').DetailsListStatus,
  ...
  GroupedList: require<any>('office-ui-fabric-react/lib/components/GroupedList/GroupedList.checklist').GroupedListStatus,
  ...
  PeoplePicker: require<any>('office-ui-fabric-react/lib/components/pickers/PeoplePicker/PeoplePicker.checklist').PeoplePickerStatus,
  ...
  ResizeGroup: require<any>('office-ui-fabric-react/lib/components/ResizeGroup/ResizeGroup.checklist').ResizeGroupStatus,
  ScrollablePane: require<any>('office-ui-fabric-react/lib/components/ScrollablePane/ScrollablePane.checklist').ScrollablePaneStatus,
  ...
  TeachingBubble: require<any>('office-ui-fabric-react/lib/components/TeachingBubble/TeachingBubble.checklist').TeachingBubbleStatus,
