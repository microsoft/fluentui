...
console.log(path.join(__dirname, '../../packages/legacy/src'));
module.exports = [
  ...resources.createConfig(BUNDLE_NAME, IS_PRODUCTION, {
    ...
    resolve: {
      alias: {
        ...
        '@uifabric/legacy/lib': path.join(__dirname, '../../packages/legacy/lib'),
        '@uifabric/legacy$': path.join(__dirname, '../../packages/legacy/lib'),
