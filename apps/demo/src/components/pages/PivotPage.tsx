...
import { PivotBasicExample } from 'office-ui-fabric-react/lib/components/Pivot/examples/Pivot.Basic.Example';
import { DemoPage } from '../DemoPage';
import { IDemoPageProps } from '../DemoPage.types';
import { PivotIconCountExample } from 'office-ui-fabric-react/lib/components/Pivot/examples/Pivot.IconCount.Example';
import { PivotLargeExample } from 'office-ui-fabric-react/lib/components/Pivot/examples/Pivot.Large.Example';
import { PivotTabsExample } from 'office-ui-fabric-react/lib/components/Pivot/examples/Pivot.Tabs.Example';
import { PivotTabsLargeExample } from 'office-ui-fabric-react/lib/components/Pivot/examples/Pivot.TabsLarge.Example';
import { PivotFabricExample } from 'office-ui-fabric-react/lib/components/Pivot/examples/Pivot.Fabric.Example';
import { PivotOnChangeExample } from 'office-ui-fabric-react/lib/components/Pivot/examples/Pivot.OnChange.Example';
import { PivotRemoveExample } from 'office-ui-fabric-react/lib/components/Pivot/examples/Pivot.Remove.Example';
import { PivotOverrideExample } from 'office-ui-fabric-react/lib/components/Pivot/examples/Pivot.Override.Example';
import { PivotSeparateExample } from 'office-ui-fabric-react/lib/components/Pivot/examples/Pivot.Separate.Example';
import { PivotStatus } from 'office-ui-fabric-react/lib/components/Pivot/Pivot.checklist';
