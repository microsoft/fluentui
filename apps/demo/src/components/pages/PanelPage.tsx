...
import { PanelSmallRightExample } from 'office-ui-fabric-react/lib/components/Panel/examples/Panel.SmallRight.Example';
import { DemoPage } from '../DemoPage';
import { IDemoPageProps } from '../DemoPage.types';
import { PanelSmallLeftExample } from 'office-ui-fabric-react/lib/components/Panel/examples/Panel.SmallLeft.Example';
import { PanelSmallFluidExample } from 'office-ui-fabric-react/lib/components/Panel/examples/Panel.SmallFluid.Example';
import { PanelMediumExample } from 'office-ui-fabric-react/lib/components/Panel/examples/Panel.Medium.Example';
import { PanelLargeExample } from 'office-ui-fabric-react/lib/components/Panel/examples/Panel.Large.Example';
import { PanelLargeFixedExample } from 'office-ui-fabric-react/lib/components/Panel/examples/Panel.LargeFixed.Example';
import { PanelExtraLargeExample } from 'office-ui-fabric-react/lib/components/Panel/examples/Panel.ExtraLarge.Example';
import { PanelCustomExample } from 'office-ui-fabric-react/lib/components/Panel/examples/Panel.Custom.Example';
import { PanelHiddenOnDismissExample } from 'office-ui-fabric-react/lib/components/Panel/examples/Panel.HiddenOnDismiss.Example';
import { PanelLightDismissExample } from 'office-ui-fabric-react/lib/components/Panel/examples/Panel.LightDismiss.Example';
import { PanelLightDismissCustomExample } from 'office-ui-fabric-react/lib/components/Panel/examples/Panel.LightDismissCustom.Example';
import { PanelNonModalExample } from 'office-ui-fabric-react/lib/components/Panel/examples/Panel.NonModal.Example';
import { PanelFooterExample } from 'office-ui-fabric-react/lib/components/Panel/examples/Panel.Footer.Example';
import { PanelStatus } from 'office-ui-fabric-react/lib/components/Panel/Panel.checklist';
