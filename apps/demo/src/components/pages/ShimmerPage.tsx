...
import { ShimmerBasicExample } from 'office-ui-fabric-react/lib/components/Shimmer/examples/Shimmer.Basic.Example';
import { ShimmerCustomElementsExample } from 'office-ui-fabric-react/lib/components/Shimmer/examples/Shimmer.CustomElements.Example';
import { ShimmerLoadDataExample } from 'office-ui-fabric-react/lib/components/Shimmer/examples/Shimmer.LoadData.Example';
import { ShimmerApplicationExample } from 'office-ui-fabric-react/lib/components/Shimmer/examples/Shimmer.Application.Example';
import { ShimmerStylingExample } from 'office-ui-fabric-react/lib/components/Shimmer/examples/Shimmer.Styling.Example';
import { ComponentStatus } from '..tatus/ComponentStatus';
import { ShimmerStatus } from 'office-ui-fabric-react/lib/components/Shimmer/Shimmer.checklist';
  ...
  public render(): JSX.Element {
    return (
      <ComponentPage
        ...
        propertiesTables={
          <PropertiesTableSet
            sources={[require<string>('!raw-loader!office-ui-fabric-react/src/components/Shimmer/Shimmer.types.ts')]}
          />
        }
        overview={
          <PageMarkdown>
        ...
        componentStatus={<ComponentStatus {...ShimmerStatus} />}
      />
    );
  }
}
