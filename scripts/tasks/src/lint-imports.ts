...
function lintImports(
  ...
  const allowedDeepImports = [
    ...
    '@fluentui/react-examples/src/react-charting/DeclarativeChart/schema/fluent_area',
    '@fluentui/react-examples/src/react-charting/DeclarativeChart/schema/fluent_donut',
    '@fluentui/react-examples/src/react-charting/DeclarativeChart/schema/fluent_gauge',
    '@fluentui/react-examples/src/react-charting/DeclarativeChart/schema/fluent_heatmap',
    '@fluentui/react-examples/src/react-charting/DeclarativeChart/schema/fluent_horizontalbar',
    '@fluentui/react-examples/src/react-charting/DeclarativeChart/schema/fluent_line',
    '@fluentui/react-examples/src/react-charting/DeclarativeChart/schema/fluent_pie',
    '@fluentui/react-examples/src/react-charting/DeclarativeChart/schema/fluent_sankey',
    '@fluentui/react-examples/src/react-charting/DeclarativeChart/schema/fluent_verticalbar_histogram',
    '@fluentui/react-examples/src/react-charting/DeclarativeChart/schema/fluent_verticalbar',
