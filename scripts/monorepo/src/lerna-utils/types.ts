...
// types taken from @see https://github.com/lerna/lerna/blob/main/libs/core/src/lib/project-graph-with-packages.ts
...
export type LernaUtils = {
  detectProjects(): Promise<{
