/**
 * Local Fork of @types/enzyme@3.10.19
 */
...
import {
  ...
  Component,
  // This is bug within the npm types - JSX doesn't exist on react module in v16,17
  //    JSX,
  ReactElement,
...
export class ShallowWrapper<P = {}, S = {}, C = Component> {
  ...
  find<C2 extends Component>(componentClass: ComponentClass<C2['props']>): ShallowWrapper<C2['props'], C2['state'], C2>;
