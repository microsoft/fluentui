...
export class CalloutPosition {
  public getRelativePositions(props: ICalloutProps, hostElement: HTMLElement, calloutElement: HTMLElement) {
    ...
    if (hostElement && targetElement && calloutElement) {
      ...
      calloutType = this._switchCalloutType(parsedDirectionalHint, calloutSizeWindowSizeInfo);
      ...
      if (calloutType === CalloutType.vertical) {
        ...
        actualHorizontalDirection = this._getActualHorizontalDirectionforVerticalCallout(horizontalAlignmentHint, calloutSizeWindowSizeInfo);

        // Set the actualVerticalDirection based on the window space
        actualVerticalDirection = this._getActualVerticalDirectionforVerticalCallout(verticalAlignmentHint, calloutSizeWindowSizeInfo);

        // Calculate position based on actualHorizontalDirection and actualVerticalDirection
        positionInfo = this._calculatePositionsforVerticalCallout(actualVerticalDirection, actualHorizontalDirection, calloutSizeWindowSizeInfo, positionInfo);
        ...
        actualHorizontalDirection = this._getActualHorizontalDirectionforHorizontalCallout(horizontalAlignmentHint, calloutSizeWindowSizeInfo);

        // Set the actualVerticalDirection based on the window space
        actualVerticalDirection = this._getActualVerticalDirectionforHorizontalCallout(verticalAlignmentHint, calloutSizeWindowSizeInfo);

        // Calculate position based on actualHorizontalDirection and actualVerticalDirection
        positionInfo = this._calculatePositionsforHorizontalCallout(actualVerticalDirection, actualHorizontalDirection, calloutSizeWindowSizeInfo, positionInfo);
      }
    }
  ...
  private _switchCalloutType(parsedDirectionalHint: IParsedDirectionalHint, calloutSizeWindowSizeInfo: ICalloutSizeWindowSizeInfo) {
  ...
  private _getActualHorizontalDirectionforVerticalCallout(horizontalAlignmentHint: HorizontalAlignmentHint, calloutSizeWindowSizeInfo: ICalloutSizeWindowSizeInfo) {
  ...
  private _getActualVerticalDirectionforVerticalCallout(verticalAlignmentHint: VerticalAlignmentHint, calloutSizeWindowSizeInfo: ICalloutSizeWindowSizeInfo) {
    let { targetRect, calloutRect, windowSize, gapSpace } = calloutSizeWindowSizeInfo;
    let actualVerticalDirection: VerticalAlignmentHint;
  ...
  private _calculatePositionsforVerticalCallout(
  ...
  private _getActualHorizontalDirectionforHorizontalCallout(horizontalAlignmentHint: HorizontalAlignmentHint, calloutSizeWindowSizeInfo: ICalloutSizeWindowSizeInfo) {
    let { targetRect, calloutRect, windowSize, gapSpace } = calloutSizeWindowSizeInfo;
    let actualHorizontalDirection: HorizontalAlignmentHint;
  ...
  private _getActualVerticalDirectionforHorizontalCallout(verticalAlignmentHint: VerticalAlignmentHint, calloutSizeWindowSizeInfo: ICalloutSizeWindowSizeInfo) {
  ...
  private _calculatePositionsforHorizontalCallout(
    actualVerticalDirection: VerticalAlignmentHint,
    actualHorizontalDirection: HorizontalAlignmentHint,
    calloutSizeWindowSizeInfo: ICalloutSizeWindowSizeInfo,
    positionInfo: IPositionInfo
