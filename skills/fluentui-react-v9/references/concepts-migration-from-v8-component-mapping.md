...
| `FocusTrapZone`          | [`Tabster`](<[https://tabster.io/](https://tabster.io/)>)                                                                                        | Use `Tabster`.                                                               |
| `FocusZone`              | [`Tabster`](<[https://tabster.io/](https://tabster.io/)>)                                                                                        | Use `Tabster`.                                                               |
...
- [**Accordion**](./?path=/docs/components-accordion--docs): Allowing to toggle the display of content by expanding or collapsing sections.
- [**Avatar**](./?path=/docs/components-avatar--docs): Replaces `Persona` for rendering user images.
- [**AvatarGroup**](./?path=/docs/components-avatargroup--docs): Replaces `Facepile`.
- [**Badge**](./?path=/docs/components-badge-badge--docs): Displays text and/or an icon.
- [**CounterBadge**](./?path=/docs/components-badge-counter-badge--docs): Displays Badge numerical values.
- [**PresenceBadge**](./?path=/docs/components-badge-presencebadge--docs): Displays Badge status.
- [**Carousel**](./?path=/docs/components-carousel--docs): Sliding window of elements controlled by previous, next, and direct pagination buttons.
- [**Drawer**](./?path=/docs/components-drawer--docs): Replaces `Panel` for side-drawer navigation.
- [**InfoLabel**](./?path=/docs/components-badge-presencebadge--docs):An InfoLabel is a Label with an InfoButton at the end.
- [**Popover**](./?path=/docs/components-popover--docs): Enhanced version of `Callout` with improved accessibility.
- [**TabList**](./?path=/docs/components-tablist--docs): Replaces `Pivot` for tabbed navigation.
- [**ProgressBar**](./?path=/docs/components-progressbar--docs): Renamed from `ProgressIndicator`, with similar functionality but refined API.
- [**Input**](./?path=/docs/components-input--docs): A new input component replacing `TextField` for simpler text input handling.
- [**Skeleton**](./?path=/docs/components-skeleton--docs): A new input component replacing `Shimmer`.
- [**Switch**](./?path=/docs/components-switch--docs): A new component replacing `Toggle` for binary options.
- [**SwatchPicker**](./?path=/docs/components-swatchpicker--docs): A new component replacing `SwatchColorPicker` with added functionality.
- [**Toast**](./?path=/docs/components-badge-presencebadge--docs):A Toasts displays temporary content to the user.
- [**TeachingPopover**](./?path=/docs/components-teachingpopover--docs): A new component in v9 that replaces `TeachingBubble` and `Coachmark` in v8.
