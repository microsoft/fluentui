# Migration Shims/V0/ButtonMixins

The [Button](https://fluentsite.z22.web.core.windows.net/0.65.0/components/button/definition) Mixins add styles for the disabled cursor and for `@fluentui/react-northstar` icon
