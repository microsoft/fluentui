...
Using components themselves does not guarantee that an application or a page will be accessible. Please see the [Accessible Experiences](?path=/docs/concepts-developer-accessibility-experiences--docs) page for further points on achieving good level of usability.
...
- Displaying [**focus indicator**](?path=/docs/concepts-developer-accessibility-focus-indicator--docs) when keyboard is used to interact with them
