...
- CSS Modules already ship in-repo only in stories: packages/react-components/react-headless-components-preview/stories/src/\*_/_.module.css (40+ files with variant classes, [data-disabled] selectors, var(--token)). The library package itself ships pure JS (files: ['_.md','dist/_.d.ts','lib','lib-commonjs'], sideEffects: false)
