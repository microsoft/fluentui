...
| S-B–S-D charts        | D17 VR extension + C1–C7 conversion + plumbing                                                         | 19 sets 187/187 clean; jest 912/86/998 _(at this stage only — the charts suite has grown twice since; the current count is in `theming-css-native.md`'s 2b re-gate table. Do not lift this cell into a PR body.)_; 0 `.styles.raw.js` | `charts-c3.md`…`charts-c6-c7.md`                            |
...
| Serializer retirement | `@griffel/jest-serializer` out of 71 configs, generator, root devDep                                   | probe: 1 pure-churn snapshot (C7 sentinel); charts 912/86 _(at this stage only — superseded, see `theming-css-native.md`)_ + 5 icon-heavy packages green                                                                              | `5cc993350a` `98a7a77d81`                                   |
