...
import { AxisScaleType } from '../../types/IDataPoint';
import {
  generateDateTicks,
...
import { IPolarChartProps } from './PolarChart.types';
...
const normalizeAngle = (deg: number, direction: IPolarChartProps['direction']) =>
...
export const createAngularScale = (
  ...
  opts: {
    ...
    tickStep?: number | string;
    tick0?: number | Date;
    direction?: IPolarChartProps['direction'];
    unit?: NonNullable<IPolarChartProps['angularAxis']>['unit'];
  } = {},
