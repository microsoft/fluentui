...
import { useChartHoverCardStyles_unstable } from './useChartHoverCardStyles.styles';
import { LegendShape } from '../Legends/Legends.types';
import { YValueHover } from '../CommonComponents/index';
import { ChartHoverCardProps } from './ChartHoverCard.types';

export const ChartHoverCard: React.FunctionComponent<ChartHoverCardProps> = props => {
  const classes = useChartHoverCardStyles_unstable(props);
            ...
            {!!props.ratio && (
              <div className={classes.ratio}>
                <>
                  ...
                  <span className={classes.denominator}>{convertToLocaleString(props.ratio[1], props.culture)}</span>
                </>
              </div>
            )}
          </div>
