...
import { ChartHoverCardProps, ChartHoverCardStyles } from './ChartHoverCard.types';

/**
 * @internal
 */
export const hoverCardClassNames: SlotClassNames<ChartHoverCardStyles> = {
...
export const useChartHoverCardStyles_unstable = (props: ChartHoverCardProps): ChartHoverCardStyles => {
  ...
  return {
    ...
    calloutBlockContainertoDrawShapefalse: mergeClasses(
      hoverCardClassNames.calloutBlockContainertoDrawShapefalse,
    ...
    calloutBlockContainertoDrawShapetrue: mergeClasses(
      hoverCardClassNames.calloutBlockContainertoDrawShapetrue,
      baseStyles.calloutBlockContainertoDrawShapetrue /*props.styles?.calloutBlockContainertoDrawShapetrue*/,
    ),
    shapeStyles: mergeClasses(hoverCardClassNames.shapeStyles, baseStyles.shapeStyles /*props.styles?.shapeStyles*/),
    calloutlegendText: mergeClasses(
      hoverCardClassNames.calloutlegendText,
      baseStyles.calloutLegendText /*props.styles?.calloutlegendText*/,
    ),
    calloutContentY: mergeClasses(
      hoverCardClassNames.calloutContentY,
    ...
    descriptionMessage: mergeClasses(
      hoverCardClassNames.descriptionMessage,
      baseStyles.descriptionMessage /*props.styles?. descriptionMessage*/,
    ),
    ratio: mergeClasses(hoverCardClassNames.ratio, baseStyles.ratio /*props.styles?.ratio*/),
    numerator: mergeClasses(hoverCardClassNames.numerator, baseStyles.numerator /*props.styles?.numerator*/),
    denominator: mergeClasses(hoverCardClassNames.denominator, baseStyles.denominator /*props.styles?.denominator*/),
    calloutInfoContainer: mergeClasses(hoverCardClassNames.calloutInfoContainer, baseStyles.calloutInfoContainer),
  };
};
