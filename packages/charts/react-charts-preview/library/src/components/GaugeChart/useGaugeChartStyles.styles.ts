...
const useStyles = makeStyles({
  ...
  segment: {
    ...
    fill: 'var(--solidFill)',
    fillOpacity: 'var(--opacity)',
  },
  gradientSegment: {
    width: '100%',
    height: '100%',
    background: 'var(--gradientFill)',
    opacity: 'var(--opacity)',
  },
  legendsContainer: {
    width: 'var(--chartWidth)',
  ...
  calloutBlockContainer: {
    ...
    borderLeft: 'var(--toDrawShape) ? none : 4px solid var(--lineColor)',
    paddingLeft: 'var(--toDrawShape) ? 0 : 8px',
    display: 'var(--toDrawShape) ? flex : block',
  },
  shapeStyles: {
    marginRight: '8px',
  },
...
export const useGaugeChartStyles_unstable = (props: GaugeChartProps): GaugeChartStyles => {
  ...
  return {
    ...
    legendsContainer: mergeClasses(gaugeChartClassNames.legendsContainer, baseStyles.legendsContainer),
