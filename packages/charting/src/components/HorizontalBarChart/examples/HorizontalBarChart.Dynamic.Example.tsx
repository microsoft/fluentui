...
export class HorizontalBarChartDynamicExample extends React.Component<IHorizontalBarChartProps, IExampleState> {
  private _colors = [
    [DefaultPalette.blueLight, DefaultPalette.blue, DefaultPalette.blueDark],
    [DefaultPalette.yellowLight, DefaultPalette.orangeLight, DefaultPalette.red],
