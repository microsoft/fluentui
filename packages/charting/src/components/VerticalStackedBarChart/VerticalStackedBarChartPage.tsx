...
const VerticalBarChartCalloutExampleCode = require('!raw-loader!@uifabric/charting/src/components/VerticalStackedBarChart/examples/VerticalStackedBarChart.Callout.Example.tsx') as string;
