...
export class AreaChartLiteBase extends React.PureComponent<IAreaChartProps, IAreaChartState> {
  ...
  public render(): JSX.Element {
    ...
    const { colors, opacity, stackedInfo } = this._createSet(this.props.data);
  ...
  private _drawGraph = (containerHeight: number, xScale: any, yScale: any, xElement: SVGElement): JSX.Element[] => {
    ...
    //const { pointLineOptions } = this.props.data;
    const area = d3Area()
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  //(this.state.selectedLegend === '' && this.state.activeLegend === legend)
  //     );
  //   };
