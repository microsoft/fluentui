...
const WeeklyDayPickerInlineExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-date-time/WeeklyDayPicker/WeeklyDayPicker.Inline.Example.tsx') as string;
const WeeklyDayPickerInlineExpandableExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-date-time/WeeklyDayPicker/WeeklyDayPicker.Inline.Expandable.Example.tsx') as string;
        ...
        propertiesTables={
          <PropertiesTableSet
            sources={[
              require<
                string
              >('!raw-loader!@fluentui/react-date-time/src/components/WeeklyDayPicker/WeeklyDayPicker.types.ts'),
            ]}
          />
        }
      />
