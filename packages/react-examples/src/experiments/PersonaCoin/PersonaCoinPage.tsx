...
const PersonaCoinExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/PersonaCoin/PersonaCoin.Example.tsx') as string;
const PersonaCoinSizeAndColorExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/PersonaCoin/PersonaCoinSizeAndColor.Example.tsx') as string;
