...
const PaginationButtonsBasicExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/Pagination/Pagination.Buttons.Basic.Example.tsx') as string;
const PaginationButtonsCustomizationExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/Pagination/Pagination.Buttons.Customization.Example.tsx') as string;
const PaginationButtonsCustomizationRoundExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/Pagination/Pagination.Buttons.Customization.Round.Example.tsx') as string;
const PaginationComboBoxExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/Pagination/Pagination.ComboBox.Example.tsx') as string;
