...
const VirtualizedListBasicExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/VirtualizedList/VirtualizedList.Basic.Example.tsx') as string;
const VirtualizedListBasicExample2Code = require('!raw-loader!@fluentui/react-examples/src/experiments/VirtualizedList/VirtualizedList.Basic2.Example.tsx') as string;
