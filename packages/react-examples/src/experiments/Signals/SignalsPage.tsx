...
const SignalFieldBasicExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/Signals/SignalField.Basic.Example.tsx') as string;

import { SignalsBasicExample } from './Signals.Basic.Example';
const SignalsBasicExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/Signals/Signals.Basic.Example.tsx') as string;
