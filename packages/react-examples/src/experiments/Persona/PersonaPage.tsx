...
const PersonaExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/Persona/Persona.Example.tsx') as string;
const VerticalPersonaExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/Persona/VerticalPersona.Example.tsx') as string;
