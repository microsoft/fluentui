...
const ButtonExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/Button/Button.Example.tsx') as string;
const MenuButtonExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/Button/MenuButton/MenuButton.Example.tsx') as string;
const SplitButtonExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/Button/SplitButton/SplitButton.Example.tsx') as string;
const ButtonKeytipsExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/Button/Button.Keytips.Example.tsx') as string;
const ButtonSlotsExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/Button/Button.Slots.Example.tsx') as string;
const ButtonStylesExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/Button/Button.Styles.Example.tsx') as string;
const ButtonToggleExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/Button/Button.Toggle.Example.tsx') as string;
const ButtonTokensExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/Button/Button.Tokens.Example.tsx') as string;
const ButtonVariantsExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/Button/Button.Variants.Example.tsx') as string;
