...
const TilesListBasicExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/TilesList/TilesList.Basic.Example.tsx') as string;

import { TilesListDocumentExample } from './TilesList.Document.Example';
const TilesListDocumentExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/TilesList/TilesList.Document.Example.tsx') as string;

import { TilesListMediaExample } from './TilesList.Media.Example';

const TilesListMediaExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/TilesList/TilesList.Media.Example.tsx') as string;
