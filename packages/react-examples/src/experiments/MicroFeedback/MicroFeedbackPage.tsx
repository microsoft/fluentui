...
const MicroFeedbackExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/MicroFeedback/MicroFeedback.Example.tsx') as string;
const MicroFeedbackCalloutExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/MicroFeedback/MicroFeedbackCallout.Example.tsx') as string;
const MicroFeedbackStackExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/MicroFeedback/MicroFeedbackStack.Example.tsx') as string;
    ...
    return (
      <ComponentPage
        ...
        propertiesTables={
          <PropertiesTableSet
            sources={[
              require<string>('!raw-loader!@uifabric/experiments/src/components/MicroFeedback/MicroFeedback.types.ts'),
            ]}
          />
        }
        overview={
