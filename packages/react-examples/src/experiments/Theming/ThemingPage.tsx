...
const ThemingSchemesVariantExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/Theming/Theming.Schemes.Variant.Example.tsx') as string;
const ThemingSchemesCustomExampleCode = require('!raw-loader!@fluentui/react-examples/src/experiments/Theming/Theming.Schemes.Custom.Example.tsx') as string;
