...
const FocusZonePhotosExampleCode = require('!raw-loader!@fluentui/react-examples/src/office-ui-fabric-react/FocusZone/FocusZone.Photos.Example.tsx') as string;
const FocusZoneListExampleCode = require('!raw-loader!@fluentui/react-examples/src/office-ui-fabric-react/FocusZone/FocusZone.List.Example.tsx') as string;
const FocusZoneDisabledExampleCode = require('!raw-loader!@fluentui/react-examples/src/office-ui-fabric-react/FocusZone/FocusZone.Disabled.Example.tsx') as string;
const FocusZoneTabbableCode = require('!raw-loader!@fluentui/react-examples/src/office-ui-fabric-react/FocusZone/FocusZone.Tabbable.Example.tsx') as string;

const FocusZoneHorizontalMenuExampleCode = require('!raw-loader!@fluentui/react-examples/src/office-ui-fabric-react/FocusZone/FocusZone.HorizontalMenu.Example.tsx') as string;
...
export const FocusZonePageProps: IDocPageProps = {
  ...
  overview: require<
    string
  >('!raw-loader!@fluentui/react-examples/src/office-ui-fabric-react/FocusZone/docs/FocusZoneOverview.md'),
