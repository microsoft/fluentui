...
const ContextualMenuScreenReaderExampleCode = require('!raw-loader!@fluentui/react-examples/src/office-ui-fabric-react/ContextualMenu/ContextualMenu.ScreenReader.Example.tsx') as string;

export const ContextualMenuPageProps: IDocPageProps = {
  title: 'ContextualMenu',
  componentName: 'ContextualMenu',
  componentUrl:
    'https://github.com/microsoft/fluentui/tree/7.0/packages/office-ui-fabric-react/src/components/ContextualMenu',
  examples: [
    {
