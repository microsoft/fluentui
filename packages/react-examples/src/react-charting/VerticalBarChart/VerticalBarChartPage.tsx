...
import { VerticalBarPerfOneExample } from './VerticalBarChart.PerfOne.Example';
...
const VerticalBarChartPerfOneExampleCode = require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/VerticalBarChart/VerticalBarChart.PerfOne.Example.tsx') as string;
      ...
      <ComponentPage
        ...
        exampleCards={
          <div>
            ...
            <ExampleCard title="VerticalBarChart rotate label" code={VerticalBarChartPerfOneExampleCode}>
              <VerticalBarPerfOneExample />
            </ExampleCard>
          </div>
        }
        propertiesTables={
