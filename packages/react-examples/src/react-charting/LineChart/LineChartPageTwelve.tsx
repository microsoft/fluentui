...
import { LineChartPerfTwelveExample } from './LineChart.PerfAnalysisTwelve.Example';
...
const LineChartPerfAnalysisTwelveExampleCode =
  require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/LineChart/LineChart.PerfAnalysisTwelve.Example.tsx') as string;
...
export class LineChartPageTwelve extends React.Component<IComponentDemoPageProps, {}> {
  public render(): JSX.Element {
    return (
      <ComponentPage
        title="Line Chart Page Twelve"
        componentName="LineChartPerfTwelveExample"
        exampleCards={
          <div>
            ...
            <ExampleCard title="LineChart custom Perf Data " code={LineChartPerfAnalysisTwelveExampleCode}>
              <LineChartPerfTwelveExample />
            </ExampleCard>
