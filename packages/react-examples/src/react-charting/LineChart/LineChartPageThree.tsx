...
const LineChartPerfAnalysisThreeExampleCode =
  require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/LineChart/LineChart.PerfAnalysisThree.Example.tsx') as string;
