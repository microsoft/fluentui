...
import { LineChartPerfThirteenExample } from './LineChart.PerfAnalysisThirteen.Example';
...
const LineChartPerfAnalysisThirteenExampleCode =
  require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/LineChart/LineChart.PerfAnalysisThirteen.Example.tsx') as string;
...
export class LineChartPageThirteen extends React.Component<IComponentDemoPageProps, {}> {
  public render(): JSX.Element {
    return (
      <ComponentPage
        title="Line Chart Page Thirteen"
        componentName="LineChartPerfThirteenExample"
        exampleCards={
          <div>
            ...
            <ExampleCard title="LineChart custom Perf Data " code={LineChartPerfAnalysisThirteenExampleCode}>
              <LineChartPerfThirteenExample />
            </ExampleCard>
