...
import { LineChartPerfFourExample } from './LineChart.PerfAnalysisFour.Example';
...
const LineChartPerfAnalysisFourExampleCode =
  require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/LineChart/LineChart.PerfAnalysisFour.Example.tsx') as string;
...
export class LineChartPageFour extends React.Component<IComponentDemoPageProps, {}> {
  public render(): JSX.Element {
    return (
      <ComponentPage
        title="Line Chart Page Four"
        componentName="LineChartPerfFourExample"
        exampleCards={
          <div>
            ...
            <ExampleCard title="LineChart custom Perf Data " code={LineChartPerfAnalysisFourExampleCode}>
              <LineChartPerfFourExample />
            </ExampleCard>
