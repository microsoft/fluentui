...
import { LineChartPerfElevenExample } from './LineChart.PerfAnalysisEleven.Example';
...
const LineChartPerfAnalysisElevenExampleCode =
  require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/LineChart/LineChart.PerfAnalysisEleven.Example.tsx') as string;
...
export class LineChartPageEleven extends React.Component<IComponentDemoPageProps, {}> {
  public render(): JSX.Element {
    return (
      <ComponentPage
        title="Line Chart Page Eleven"
        componentName="LineChartPerfElevenExample"
        exampleCards={
          <div>
            ...
            <ExampleCard title="LineChart custom Perf Data " code={LineChartPerfAnalysisElevenExampleCode}>
              <LineChartPerfElevenExample />
            </ExampleCard>
