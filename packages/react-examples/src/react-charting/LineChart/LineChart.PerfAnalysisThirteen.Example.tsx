...
export class LineChartPerfThirteenExample extends React.Component<{}, ILineChartBasicState> {
  ...
  private _perfTwoExample(): JSX.Element {
    ...
    for (let i: number = 0; i < 20; i++) {
      ...
      //chartPoints.push(this._getChartData(data[2], 'Legend 3', 'Title', this._colors[2]));
      //chartPoints.push(this._getChartData(data[3], 'Legend 4', 'Title', this._colors[3]));
      //chartPoints.push(this._getChartData(data[4], 'Legend 5', 'Title', this._colors[4]));
      const chartData = {
