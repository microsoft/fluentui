...
import { LineChartPerfTenExample } from './LineChart.PerfAnalysisTen.Example';
...
const LineChartPerfAnalysisTenExampleCode =
  require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/LineChart/LineChart.PerfAnalysisTen.Example.tsx') as string;
...
export class LineChartPageTen extends React.Component<IComponentDemoPageProps, {}> {
  public render(): JSX.Element {
    return (
      <ComponentPage
        title="Line Chart Page Ten"
        componentName="LineChartPerfTenExample"
        exampleCards={
          <div>
            ...
            <ExampleCard title="LineChart custom Perf Data " code={LineChartPerfAnalysisTenExampleCode}>
              <LineChartPerfTenExample />
            </ExampleCard>
