...
import { LineChartPerfSixExample } from './LineChart.PerfAnalysisSix.Example';
...
const LineChartPerfAnalysisSixExampleCode =
  require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/LineChart/LineChart.PerfAnalysisSix.Example.tsx') as string;
...
export class LineChartPageSix extends React.Component<IComponentDemoPageProps, {}> {
  public render(): JSX.Element {
    return (
      <ComponentPage
        title="Line Chart Page Six"
        componentName="LineChartPerfSixExample"
        exampleCards={
          <div>
            ...
            <ExampleCard title="LineChart custom Perf Data " code={LineChartPerfAnalysisSixExampleCode}>
              <LineChartPerfSixExample />
            </ExampleCard>
