...
import { LineChartPerfFiveExample } from './LineChart.PerfAnalysisFive.Example';
...
const LineChartPerfAnalysisFiveExampleCode =
  require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/LineChart/LineChart.PerfAnalysisFive.Example.tsx') as string;
...
export class LineChartPageSix extends React.Component<IComponentDemoPageProps, {}> {
  public render(): JSX.Element {
    return (
      <ComponentPage
        title="Line Chart Page Five"
        componentName="LineChartPerfFiveExample"
        exampleCards={
          <div>
            ...
            <ExampleCard title="LineChart custom Perf Data " code={LineChartPerfAnalysisFiveExampleCode}>
              <LineChartPerfFiveExample />
            </ExampleCard>
