...
export class LineChartPerfEightExample extends React.Component<{}, ILineChartBasicState> {
  ...
  private _perfTwoExample(): JSX.Element {
    ...
    for (let i: number = 0; i < 5; i++) {
      ...
      chartPoints.push(this._getChartData(data[1], 'Legend 2', 'Title', this._colors[1]));
      const chartData = {
