...
import { LineChartPerfEightExample } from './LineChart.PerfAnalysisEight.Example';
...
const LineChartPerfAnalysisEightExampleCode =
  require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/LineChart/LineChart.PerfAnalysisEight.Example.tsx') as string;
...
export class LineChartPageEight extends React.Component<IComponentDemoPageProps, {}> {
  public render(): JSX.Element {
    return (
      <ComponentPage
        title="Line Chart Page Eight"
        componentName="LineChartPerfEightExample"
        exampleCards={
          <div>
            ...
            <ExampleCard title="LineChart custom Perf Data " code={LineChartPerfAnalysisEightExampleCode}>
              <LineChartPerfEightExample />
            </ExampleCard>
