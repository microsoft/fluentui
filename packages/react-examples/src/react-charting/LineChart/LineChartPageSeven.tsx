...
import { LineChartPerfSevenExample } from './LineChart.PerfAnalysisSeven.Example';
...
const LineChartPerfAnalysisSevenExampleCode =
  require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/LineChart/LineChart.PerfAnalysisSeven.Example.tsx') as string;
...
export class LineChartPageSeven extends React.Component<IComponentDemoPageProps, {}> {
  public render(): JSX.Element {
    return (
      <ComponentPage
        title="Line Chart Page Seven"
        componentName="LineChartPerfSevenExample"
        exampleCards={
          <div>
            ...
            <ExampleCard title="LineChart custom Perf Data " code={LineChartPerfAnalysisSevenExampleCode}>
              <LineChartPerfSevenExample />
            </ExampleCard>
