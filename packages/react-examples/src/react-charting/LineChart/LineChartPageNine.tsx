...
import { LineChartPerfNineExample } from './LineChart.PerfAnalysisNine.Example';
...
const LineChartPerfAnalysisNineExampleCode =
  require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/LineChart/LineChart.PerfAnalysisNine.Example.tsx') as string;
...
export class LineChartPageNine extends React.Component<IComponentDemoPageProps, {}> {
  public render(): JSX.Element {
    return (
      <ComponentPage
        title="Line Chart Page Nine"
        componentName="LineChartPerfNineExample"
        exampleCards={
          <div>
            ...
            <ExampleCard title="LineChart custom Perf Data " code={LineChartPerfAnalysisNineExampleCode}>
              <LineChartPerfNineExample />
            </ExampleCard>
