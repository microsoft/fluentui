...
const LineChartPerfAnalysisOneExampleCode =
  require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/LineChart/LineChart.PerfAnalysisOne.Example.tsx') as string;
...
export class LineChartPageOne extends React.Component<IComponentDemoPageProps, {}> {
