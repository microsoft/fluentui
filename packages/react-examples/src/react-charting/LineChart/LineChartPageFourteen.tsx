...
import { LineChartPerfFourteenExample } from './LineChart.PerfAnalysisFourteen.Example';
...
const LineChartPerfAnalysisFourteenExampleCode =
  require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/LineChart/LineChart.PerfAnalysisFourteen.Example.tsx') as string;
...
export class LineChartPageFourteen extends React.Component<IComponentDemoPageProps, {}> {
  public render(): JSX.Element {
    return (
      <ComponentPage
        title="Line Chart Page Fourteen"
        componentName="LineChartPerfFourteenExample"
        exampleCards={
          <div>
            ...
            <ExampleCard title="LineChart custom Perf Data " code={LineChartPerfAnalysisFourteenExampleCode}>
              <LineChartPerfFourteenExample />
            </ExampleCard>
