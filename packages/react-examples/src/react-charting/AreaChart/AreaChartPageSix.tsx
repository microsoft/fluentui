...
import { AreaChartPerfSixExample } from './AreaChart.PerfAnalysisSix.Example';
...
const AreaChartPerfSixExampleCode = require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/AreaChart/AreaChart.PerfAnalysisSix.Example.tsx') as string;

export class AreaChartSix extends React.Component<IComponentDemoPageProps, {}> {
  public render(): JSX.Element {
    return (
      <ComponentPage
        title="Area Chart Page Six"
        componentName="AreaChartPerfExampleSix"
        exampleCards={
          <div>
            ...
            <ExampleCard title="Area chart custom Accessibility" code={AreaChartPerfSixExampleCode}>
              <AreaChartPerfSixExample />
            </ExampleCard>
          </div>
        }
        propertiesTables={
