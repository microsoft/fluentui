...
import { AreaChartPerfSevenExample } from './AreaChart.PerfAnalysisSeven.Example';
...
const AreaChartPerfSevenExampleCode = require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/AreaChart/AreaChart.PerfAnalysisSeven.Example.tsx') as string;

export class AreaChartSeven extends React.Component<IComponentDemoPageProps, {}> {
  public render(): JSX.Element {
    return (
      <ComponentPage
        title="Area Chart Page Seven"
        componentName="AreaChartPerfExampleSeven"
        exampleCards={
          <div>
            ...
            <ExampleCard title="Area chart custom Accessibility" code={AreaChartPerfSevenExampleCode}>
              <AreaChartPerfSevenExample />
            </ExampleCard>
          </div>
        }
        propertiesTables={
