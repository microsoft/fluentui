...
const AreaChartPerfNineExampleCode = require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/AreaChart/AreaChart.PerfAnalysisSeven.Example.tsx') as string;
