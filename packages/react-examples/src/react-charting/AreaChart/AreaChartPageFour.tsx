...
import { AreaChartPerfFourExample } from './AreaChart.PerfAnalysisFour.Example';
...
const AreaChartPerfFourExampleCode = require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/AreaChart/AreaChart.PerfAnalysisFour.Example.tsx') as string;

export class AreaChartFour extends React.Component<IComponentDemoPageProps, {}> {
  public render(): JSX.Element {
    return (
      <ComponentPage
        title="Area Chart Page Four"
        componentName="AreaChartPerfExampleFour"
        exampleCards={
          <div>
            ...
            <ExampleCard title="Area chart custom Accessibility" code={AreaChartPerfFourExampleCode}>
              <AreaChartPerfFourExample />
            </ExampleCard>
          </div>
        }
        propertiesTables={
