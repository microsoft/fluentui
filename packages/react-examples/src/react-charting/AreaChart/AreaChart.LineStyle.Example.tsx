...
import { AreaChart, IChartProps, ILineChartPoints } from '@fluentui/react-charting';
...
export class AreaChartLineStyleExample extends React.Component<{}, IAreaChartBasicState> {
