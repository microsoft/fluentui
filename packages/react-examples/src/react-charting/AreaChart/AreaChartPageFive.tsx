...
import { AreaChartPerfFiveExample } from './AreaChart.PerfAnalysisFive.Example';
...
const AreaChartPerfFiveExampleCode = require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/AreaChart/AreaChart.PerfAnalysisFive.Example.tsx') as string;

export class AreaChartFive extends React.Component<IComponentDemoPageProps, {}> {
  public render(): JSX.Element {
    return (
      <ComponentPage
        title="Area Chart Page Five"
        componentName="AreaChartPerfExampleFive"
        exampleCards={
          <div>
            ...
            <ExampleCard title="Area chart custom Accessibility" code={AreaChartPerfFiveExampleCode}>
              <AreaChartPerfFiveExample />
            </ExampleCard>
          </div>
        }
        propertiesTables={
