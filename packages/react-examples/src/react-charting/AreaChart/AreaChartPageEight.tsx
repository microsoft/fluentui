...
import { AreaChartPerfEightExample } from './AreaChart.PerfAnalysisEight.Example';
...
const AreaChartPerfEightExampleCode = require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/AreaChart/AreaChart.PerfAnalysisEight.Example.tsx') as string;

export class AreaChartEight extends React.Component<IComponentDemoPageProps, {}> {
  public render(): JSX.Element {
    return (
      <ComponentPage
        title="Area Chart Page Eight"
        componentName="AreaChartPerfExampleEight"
        exampleCards={
          <div>
            ...
            <ExampleCard title="Area chart custom Accessibility" code={AreaChartPerfEightExampleCode}>
              <AreaChartPerfEightExample />
            </ExampleCard>
          </div>
        }
        propertiesTables={
