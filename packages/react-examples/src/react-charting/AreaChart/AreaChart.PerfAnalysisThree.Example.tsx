...
export class AreaChartPerfThreeExample extends React.Component<{}, IAreaChartBasicState> {
  ...
  private _basicExample(): JSX.Element {
    ...
    for (let i: number = 0; i < 18; i++) {
      const chartPoints = [];
      chartPoints.push(this._getChartData(this._getData(i + 1), 'Legend 1', 'Title', this._colors[i % 9]));
