...
import { AreaChartPerfElevenExample } from './AreaChart.PerfAnalysisEleven.Example';
...
const AreaChartPerfElevenExampleCode = require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/AreaChart/AreaChart.PerfAnalysisNine.Example.tsx') as string;

export class AreaChartEleven extends React.Component<IComponentDemoPageProps, {}> {
  public render(): JSX.Element {
    return (
      <ComponentPage
        title="Area Chart Page Eleven"
        componentName="AreaChartPerfExampleEleven"
        exampleCards={
          <div>
            ...
            <ExampleCard title="Area chart custom Accessibility" code={AreaChartPerfElevenExampleCode}>
              <AreaChartPerfElevenExample />
            </ExampleCard>
          </div>
        }
        propertiesTables={
