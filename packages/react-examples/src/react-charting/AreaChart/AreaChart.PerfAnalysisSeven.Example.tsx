...
export class AreaChartPerfSevenExample extends React.Component<{}, IAreaChartBasicState> {
  ...
  private _basicExample(): JSX.Element {
    ...
    for (let i: number = 0; i < 10; i++) {
      ...
      //chartPoints.push(this._getChartData(this._getData(i + 1), 'Legend 2', 'Title', this._colors[7]));
