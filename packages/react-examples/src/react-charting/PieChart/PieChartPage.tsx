...
const PieChartBasicExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-charting/PieChart/PieChart.Basic.Example.tsx') as string;
const PieChartDynamicExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-charting/PieChart/PieChart.Dynamic.Example.tsx') as string;
    ...
    return (
      <ComponentPage
        ...
        propertiesTables={
          <PropertiesTableSet
            sources={[
              require<string>('!raw-loader!@fluentui/react-charting/src/components/PieChart/PieChart.types.ts'),
            ]}
          />
        }
