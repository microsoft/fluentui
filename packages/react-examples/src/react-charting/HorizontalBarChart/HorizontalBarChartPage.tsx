...
const HorizontalBarChartPlotlyExampleCode =
  require('!raw-loader?esModule=false!@fluentui/react-examples/src/react-charting/HorizontalBarChart/HorizontalBarChart.plotly.Example.tsx') as string;
      ...
      <ComponentPage
        ...
        exampleCards={
          <div>
            ...
            <ExampleCard title="HorizontalBarChart Plotly" code={HorizontalBarChartPlotlyExampleCode}>
              <HorizontalBarChartPlotlyExample />
            </ExampleCard>
          </div>
        }
        propertiesTables={
