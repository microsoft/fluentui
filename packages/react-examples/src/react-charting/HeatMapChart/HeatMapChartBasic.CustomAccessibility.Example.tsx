...
import { HeatMapChart, IHeatMapChartDataPoint, IHeatMapChartProps, DataVizPalette, getColorFromToken } from '@fluentui/react-charting';
      ...
      <>
        ...
        <div style={rootStyle}>
          <HeatMapChart
            ...
            rangeValuesForColorScale={[getColorFromToken(DataVizPalette.color6), getColorFromToken(DataVizPalette.color10)]}
            enableReflow={true}
          />
        </div>
      </>
