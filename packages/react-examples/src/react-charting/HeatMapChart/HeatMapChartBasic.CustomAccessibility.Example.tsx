        ...
        data: [
          {
            ...
            callOutAccessibilityData: { ariaLabel: 'Bar 1 of 10 air quality is seems to be very nice today' },
          },
          {
            x: xPoint[0],
            y: yPoint[1],
            ...
            callOutAccessibilityData: { ariaLabel: 'Bar 2 of 10 today we have a good air quality in the alaska' },
          },
          {
            x: xPoint[1],
            y: yPoint[0],
            ...
            callOutAccessibilityData: { ariaLabel: 'Bar 3 of 10 a sudden rise of 150 units in the ohio today' },
          },
          {
            x: xPoint[2],
            y: yPoint[0],
            ...
            callOutAccessibilityData: {
              ariaLabel: 'Bar 4 of 10 air quality seems to decrease only 15 units from yesterday',
            },
          },
          {
            x: xPoint[6],
            ...
            callOutAccessibilityData: { ariaLabel: 'Bar 5 of 10 air comes to control little bit more that yesterday' },
          },
          {
            x: xPoint[0],
            y: yPoint[3],
            ...
            callOutAccessibilityData: { ariaLabel: 'Bar 6 of 10 1st day in the week, DC witnesses a good air quality' },
          },
          {
            x: xPoint[4],
            y: yPoint[4],
            ...
            callOutAccessibilityData: {
              ariaLabel:
                'Bar 7 of 10 Air quality index is decreases exactly 200 units giving the people of NYC a good hope',
            },
          },
        ],
      },
        ...
        data: [
          {
            ...
            callOutAccessibilityData: {
              ariaLabel: 'Bar 8 of 10 alaska has just reported nearly 100 units hike air quality',
            },
          },
          {
            x: xPoint[6],
            ...
            callOutAccessibilityData: { ariaLabel: 'Bar 9 of 10 alaska to 300' },
          },
          {
            x: xPoint[5],
            y: yPoint[2],
            ...
            callOutAccessibilityData: { ariaLabel: 'Bar 10 of 10 air comes to control little bit' },
          },
          {
            x: xPoint[1],
            y: yPoint[3],
            ...
            callOutAccessibilityData: {
              ariaLabel: 'Bar 1 of 10 washington DC witnesses a hike of nearly 100 units in air quality',
            },
          },
          {
            x: xPoint[4],
            ...
            callOutAccessibilityData: { ariaLabel: 'Bar 1 of 10 a 200% hike in the air quality index' },
          },
          {
            x: xPoint[5],
            y: yPoint[3],
            ...
            callOutAccessibilityData: { ariaLabel: 'Bar 1 of 10 60 units decreased form yesterday.' },
          },
        ],
      },
      {
        ...
        data: [
          {
            ...
            callOutAccessibilityData: { ariaLabel: 'Bar 1 of 10 a sudden spike in the badness of the air quality' },
          },
          {
            x: xPoint[3],
            y: yPoint[0],
            ...
            callOutAccessibilityData: {
              ariaLabel: 'Bar 1 of 10 stuation gor worse in air quality, due to industrial smoke',
            },
          },
          {
            x: xPoint[4],
