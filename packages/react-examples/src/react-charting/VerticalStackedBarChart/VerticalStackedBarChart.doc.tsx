...
const VerticalStackedBarChartPlotlyExampleCode =
...
export const VerticalStackedBarChartPageProps: IDocPageProps = {
  ...
  examples: [
    ...
    {
      title: 'VerticalStackedBarChart Plotly',
      code: VerticalStackedBarChartPlotlyExampleCode,
      view: <VerticalStackedBarChartPlotlyExample />,
    },
  ],
