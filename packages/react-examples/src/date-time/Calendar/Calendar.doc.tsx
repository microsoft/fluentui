...
export const CalendarPageProps: IDocPageProps = {
  ...
  componentUrl: 'https://github.com/microsoft/fluentui/tree/master/packages/date-time/src/components/Calendar',
  examples: [
    {
      title: 'Calendar',
  ...
  overview: require<string>('!raw-loader!@fluentui/react-examples/src/date-time/Calendar/docs/CalendarOverview.md'),
