...
const CheckboxIndeterminateExampleCode = require('!raw-loader?esModule=false!@fluentui/react-examples/src/react/Checkbox/Checkbox.Indeterminate.Example.tsx') as string;
...
export const CheckboxPageProps: IDocPageProps = {
  ...
  overview: require<
    string
  >('!raw-loader?esModule=false!@fluentui/react-examples/src/react/Checkbox/docs/CheckboxOverview.md'),
  bestPractices: require<
    string
  >('!raw-loader?esModule=false!@fluentui/react-examples/src/react/Checkbox/docs/CheckboxBestPractices.md'),
