...
const ListBasicExampleCode = require('!raw-loader!@fluentui/react-examples/src/office-ui-fabric-react/List/List.Basic.Example.tsx') as string;
const ListGridExampleCode = require('!raw-loader!@fluentui/react-examples/src/office-ui-fabric-react/List/List.Grid.Example.tsx') as string;
const ListScrollingExampleCode = require('!raw-loader!@fluentui/react-examples/src/office-ui-fabric-react/List/List.Scrolling.Example.tsx') as string;
const ListGhostingExampleCode = require('!raw-loader!@fluentui/react-examples/src/office-ui-fabric-react/List/List.Ghosting.Example.tsx') as string;
...
export const ListPageProps: IDocPageProps = {
  ...
  overview: require<
    string
  >('!raw-loader!@fluentui/react-examples/src/office-ui-fabric-react/List/docs/ListOverview.md'),
  bestPractices: require<
    string
  >('!raw-loader!@fluentui/react-examples/src/office-ui-fabric-react/List/docs/ListBestPractices.md'),
