...
const DropdownBasicExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/Dropdown/Dropdown.Basic.Example.tsx') as string;
const DropdownControlledExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/Dropdown/Dropdown.Controlled.Example.tsx') as string;
const DropdownControlledMultiExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/Dropdown/Dropdown.ControlledMulti.Example.tsx') as string;
const DropdownCustomExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/Dropdown/Dropdown.Custom.Example.tsx') as string;
const DropdownErrorExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/Dropdown/Dropdown.Error.Example.tsx') as string;
const DropdownRequiredExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/Dropdown/Dropdown.Required.Example.tsx') as string;
...
export const DropdownPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@fluentui/react-examples/src/react-next/Dropdown/docs/DropdownOverview.md'),
  bestPractices: require<
    string
  >('!raw-loader!@fluentui/react-examples/src/react-next/Dropdown/docs/DropdownBestPractices.md'),
