...
const SpinButtonBasicExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/SpinButton/SpinButton.Basic.Example.tsx') as string;
const SpinButtonBasicDisabledExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/SpinButton/SpinButton.BasicDisabled.Example.tsx') as string;
const SpinButtonStatefulExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/SpinButton/SpinButton.Stateful.Example.tsx') as string;
const SpinButtonBasicWithIconExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/SpinButton/SpinButton.BasicWithIcon.Example.tsx') as string;
const SpinButtonBasicWithIconDisabledExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/SpinButton/SpinButton.BasicWithIconDisabled.Example.tsx') as string;
const SpinButtonBasicWithEndPositionExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/SpinButton/SpinButton.BasicWithEndPosition.Example.tsx') as string;
const SpinButtonCustomStyledExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/SpinButton/SpinButton.CustomStyled.Example.tsx') as string;
...
export const SpinButtonPageProps: IDocPageProps = {
  ...
  overview: require<
    string
  >('!raw-loader!@fluentui/react-examples/src/react-next/SpinButton/docs/SpinButtonOverview.md'),
  bestPractices: require<
    string
  >('!raw-loader!@fluentui/react-examples/src/react-next/SpinButton/docs/SpinButtonBestPractices.md'),
