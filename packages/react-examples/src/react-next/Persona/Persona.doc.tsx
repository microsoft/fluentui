...
const PersonaInitialsExampleCode = require('!raw-loader!@fluentui/react-next/src/components/Persona/Persona.Initials.Example.tsx') as string;
const PersonaBasicExampleCode = require('!raw-loader!@fluentui/react-next/src/components/Persona/Persona.Basic.Example.tsx') as string;
const PersonaAlternateExampleCode = require('!raw-loader!@fluentui/react-next/src/components/Persona/Persona.Alternate.Example.tsx') as string;
const PersonaColorsExampleCode = require('!raw-loader!@fluentui/react-next/src/components/Persona/Persona.Colors.Example.tsx') as string;
const PersonaCustomRenderExampleCode = require('!raw-loader!@fluentui/react-next/src/components/Persona/Persona.CustomRender.Example.tsx') as string;
const PersonaCustomCoinRenderExampleCode = require('!raw-loader!@fluentui/react-next/src/components/Persona/Persona.CustomCoinRender.Example.tsx') as string;
const UnknownPersonaExampleCode = require('!raw-loader!@fluentui/react-next/src/components/Persona/Persona.UnknownPersona.Example.tsx') as string;
const PersonaPresenceExampleCode = require('!raw-loader!@fluentui/react-next/src/components/Persona/Persona.Presence.Example.tsx') as string;

export const PersonaPageProps: IDocPageProps = {
  title: 'Persona',
  componentName: 'Persona',
  componentUrl: 'https://github.com/microsoft/fluentui/tree/7.0/packages/react-next/src/components/Persona',
  examples: [
    {
