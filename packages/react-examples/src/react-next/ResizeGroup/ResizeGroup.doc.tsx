...
const ResizeGroupBasicExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/ResizeGroup/ResizeGroup.OverflowSet.Example.tsx') as string;

const ResizeGroupVerticalExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/ResizeGroup/ResizeGroup.VerticalOverflowSet.Example.tsx') as string;

const ResizeGroupFlexBoxExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/ResizeGroup/ResizeGroup.FlexBox.Example.tsx') as string;

export const ResizeGroupPageProps: IDocPageProps = {
  title: 'ResizeGroup',
  componentName: 'ResizeGroup',
  componentUrl: 'https://github.com/microsoft/fluentui/tree/7.0/packages/react-next/src/components/ResizeGroup',
  examples: [
    {
  ...
  bestPractices: require<
    string
  >('!raw-loader!@fluentui/react-examples/src/react-next/ResizeGroup/docs/ResizeGroupOverview.md'),
  dos: require<string>('!raw-loader!@fluentui/react-examples/src/react-next/ResizeGroup/docs/ResizeGroupDos.md'),
  donts: require<string>('!raw-loader!@fluentui/react-examples/src/react-next/ResizeGroup/docs/ResizeGroupDonts.md'),
