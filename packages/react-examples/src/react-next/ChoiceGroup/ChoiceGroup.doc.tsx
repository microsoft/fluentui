...
const ChoiceGroupBasicExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/ChoiceGroup/ChoiceGroup.Basic.Example.tsx') as string;
const ChoiceGroupControlledExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/ChoiceGroup/ChoiceGroup.Controlled.Example.tsx') as string;
const ChoiceGroupLabelExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/ChoiceGroup/ChoiceGroup.Label.Example.tsx') as string;
const ChoiceGroupCustomExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/ChoiceGroup/ChoiceGroup.Custom.Example.tsx') as string;
const ChoiceGroupImageExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/ChoiceGroup/ChoiceGroup.Image.Example.tsx') as string;
const ChoiceGroupIconExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-next/ChoiceGroup/ChoiceGroup.Icon.Example.tsx') as string;
...
export const ChoiceGroupPageProps: IDocPageProps = {
  ...
  overview: require<
    string
  >('!raw-loader!@fluentui/react-examples/src/react-next/ChoiceGroup/docs/ChoiceGroupOverview.md'),
  bestPractices: require<
    string
  >('!raw-loader!@fluentui/react-examples/src/react-next/ChoiceGroup/docs/ChoiceGroupBestPractices.md'),
