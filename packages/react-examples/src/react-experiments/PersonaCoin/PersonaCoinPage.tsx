...
const PersonaCoinExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-experiments/PersonaCoin/PersonaCoin.Example.tsx') as string;
const PersonaCoinSizeAndColorExampleCode = require('!raw-loader!@fluentui/react-examples/src/react-experiments/PersonaCoin/PersonaCoinSizeAndColor.Example.tsx') as string;
  ...
  return (
    <ComponentPage
      ...
      propertiesTables={
        <PropertiesTableSet
          sources={[
            require<string>('!raw-loader!@fluentui/react-experiments/src/components/PersonaCoin/PersonaCoin.types.ts'),
          ]}
        />
      }
      overview={
