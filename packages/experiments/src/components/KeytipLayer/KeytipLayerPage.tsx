    ...
    return (
      <ComponentPage
        ...
        overview={
          <div>
            <p>
              A KeytipLayer is the component to add to your app to enable Keytips. It can be added anywhere in your document, but must only
              be added once. Use the registerKeytip utility helper to add a Keytip to your app through the component render() function it
              belongs to.
            </p>
            <p>
              Key sequences can be defined to enter and exit Keytip mode. These sequences can be any keys along with modifiers (Alt, Shift
