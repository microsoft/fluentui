...
const ExtendedPeoplePickerBasicExampleCode = require('!raw-loader!@uifabric/experiments/src/components/ExtendedPicker/examples/ExtendedPeoplePicker.Basic.Example.tsx') as string;
  ...
  public render(): JSX.Element {
    return (
      <ComponentPage
        ...
        propertiesTables={
          <PropertiesTableSet
            sources={[require<string>('!raw-loader!@uifabric/experiments/src/components/ExtendedPicker/BaseExtendedPicker.types.ts')]}
          />
        }
        overview={
          <div>
