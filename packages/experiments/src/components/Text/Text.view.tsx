...
export const TextView: ITextComponent['view'] = props => {
  ...
  // TODO: Resolve error:
  // react-dom.development.js:500 Warning: React does not recognize the `_defaultStyles` prop on a DOM element.
  // If you intentionally want it to appear in the DOM as a custom attribute, spell it as lowercase `_defaultstyles` instead.
