export namespace Depths {
  ...
  export const depth16 = '0 6.4px 16.4px 0 rgba(0, 0, 0, 0.132), 0 1.2px 3.6px 0 rgba(0, 0, 0, 0.108)';
  export const depth64 = '0 25.6px 57.6px 0 rgba(0, 0, 0, 0.132), 0 4.8px 14.4px 0 rgba(0, 0, 0, 0.108)';
}
