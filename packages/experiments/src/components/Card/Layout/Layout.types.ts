...
import { IAction } from '@uifabric/experiments/lib/components/Card/ActionBar/ActionBar.types';
...
export interface ICardContentDetails {
   ...
   */
  content: IBodyTextProps | IThumbnailItemProps | ICompoundButtonStackProps;
}
