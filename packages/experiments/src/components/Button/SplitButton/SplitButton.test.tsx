...
describe('SplitButton', () => {
  ...
  it('renders a disabled primary SplitButton correctly', () => {
    const component = renderer.create(
      <SplitButton disabled primary icon="Add" content="Disabled primary button" menu={menuProps} />,
    );
    const tree = component.toJSON();
    expect(tree).toMatchSnapshot;
  });
  ...
  it('renders a primary SplitButton with its first action disabled correctly', () => {
    const component = renderer.create(
      <SplitButton
        ...
        primary
        icon="Add"
        content="First action disabled primary button"
        menu={menuProps}
      />,
    );
    const tree = component.toJSON();
  ...
  it('focuses correctly when focus is triggered via ISplitButton interface', () => {
    ...
    const buttons = wrapper.getDOMNode().querySelectorAll('span.ms-SplitButton > button.ms-Button') as NodeListOf<
      HTMLButtonElement
    >;
