...
export function getOpenGraphPropertiesCard(url: string): IChicletCardProps {
...
export function getOpenGraphPropertiesXsmall(url: string): IChicletXsmallProps {
  const attributes: IChicletXsmallProps = {};
