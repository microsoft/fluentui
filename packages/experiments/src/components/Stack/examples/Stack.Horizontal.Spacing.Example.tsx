      ...
      <Stack gap={10}>
        <Stack horizontal horizontalAlign="space-between">
          <Stack>
            ...
            <Stack horizontal styles={styles} gap={10} padding={10}>
              <span>1</span>
              <span>2</span>
              <span>3</span>
            </Stack>
          ...
          <Stack>
            ...
            <Stack horizontal styles={styles} gap="10%" padding="s1 15%">
              <span>1</span>
              <span>2</span>
              <span>3</span>
            </Stack>
        ...
        <Stack horizontal horizontalAlign="space-between">
          <Stack>
            ...
            <Stack horizontal styles={styles} gap="s2" padding="s2">
              <span>1</span>
              <span>2</span>
              <span>3</span>
            </Stack>
          ...
          <Stack>
            ...
            <Stack horizontal styles={styles} gap="s1" padding="s1">
              <span>1</span>
              <span>2</span>
              <span>3</span>
            </Stack>
          ...
          <Stack>
            ...
            <Stack horizontal styles={styles} gap="m" padding="m">
              <span>1</span>
              <span>2</span>
              <span>3</span>
            </Stack>
        ...
        <Stack horizontal horizontalAlign="space-between">
          <Stack>
            ...
            <Stack horizontal styles={styles} gap="l1" padding="l1">
              <span>1</span>
              <span>2</span>
              <span>3</span>
            </Stack>
          ...
          <Stack>
            ...
            <Stack horizontal styles={styles} gap="l2" padding="l2">
              <span>1</span>
              <span>2</span>
              <span>3</span>
            </Stack>
