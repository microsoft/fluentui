  ...
  public render(): JSX.Element {
    ...
    return (
      <Stack gap={10}>
        ...
        <Stack horizontal wrap gap={'40 30'} className={styles.root}>
          <Stack horizontal wrap gap={'30 10'} className={styles.stackOne}>
            <span>1</span>
            <span>2</span>
            <span>3</span>
            <span>4</span>
          ...
          <Stack horizontal wrap gap={'50 20'} className={styles.stackTwo}>
            <span>1</span>
            <span>2</span>
            <span>3</span>
          </Stack>
