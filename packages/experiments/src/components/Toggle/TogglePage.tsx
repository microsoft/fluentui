  ...
  public render(): JSX.Element {
    return (
      <ComponentPage
        ...
        overview={
          <Markdown>
            {require<string>('!raw-loader!office-ui-fabric-react/src/packages/react-inputs/components/Toggle/docs/ToggleOverview.md')}
          </Markdown>
        }
        bestPractices={<div />}
        dos={
          <Markdown>
            {require<string>('!raw-loader!office-ui-fabric-react/src/packages/react-inputs/components/Toggle/docs/ToggleDos.md')}
          </Markdown>
        }
        donts={
          <Markdown>
            {require<string>('!raw-loader!office-ui-fabric-react/src/packages/react-inputs/components/Toggle/docs/ToggleDonts.md')}
          </Markdown>
        }
