                ...
                propertiesTables={
                    <PropertiesTableSet
                        sources={[
                            require<
                                string
                            >('!raw-loader!business-app-fabric/src/components/Accordion/Accordion.types.tsx')
                        ]}
                    />
                }
                overview={
                    <div>
                        <p>
                            The Accordion component creates a collapsible section where a parent button is used to show
                            or hide the children elements.
                        </p>
                    </div>
                }
