...
const PeopleSelectedItemsListExampleCode = require('!raw-loader!@uifabric/experiments/src/components/SelectedItemsList/examples/SelectedPeopleList.Basic.Example') as string;
  ...
  public render(): JSX.Element {
    return (
      <ComponentPage
        ...
        propertiesTables={
          <PropertiesTableSet
            sources={[require<string>('!raw-loader!@uifabric/experiments/src/components/SelectedItemsList/BaseSelectedItemsList.types.ts')]}
          />
        }
        overview={<div />}
        bestPractices={<div />}
