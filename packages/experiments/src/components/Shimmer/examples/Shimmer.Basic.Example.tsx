  ...
  public render(): JSX.Element {
    return (
      ...
      <div style={{ padding: '2px' }}>
        ...
        <Shimmer lineElements={[{ type: ElemType.circle }, { type: ElemType.gap, widthInPercentage: 2 }, { type: ElemType.line }]} />
        ...
        <div className="shimmerBasicExample-wrapper">
          <Shimmer isBaseStyle={true} widthInPixel={350}>
            {getRenderedElements(
              [{ type: ElemType.line, widthInPixel: 40, height: 40 }, { type: ElemType.gap, widthInPixel: 10, height: 40 }],
              40
            )}
            <div
              // tslint:disable-next-line:jsx-ban-props
        ...
        <div className="shimmerBasicExample-wrapper">
          <Shimmer isBaseStyle={true} widthInPixel={550}>
