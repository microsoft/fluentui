...
import { TokenSetType } from '../types/Theme';

export function getStyleObjectFromTokens(
  ...
  if (tokens) {
    for (const name of Object.keys(tokens)) {
      ...
      if (varValue && typeof varValue === 'object') {
        getStyleObjectFromTokens(varValue as { [key: string]: TokenSetType }, varName, style);
      } else {
