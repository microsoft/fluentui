...
export const TextPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Text/docs/TextOverview.md'),
  bestPractices: require<
    string
  >('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Text/docs/TextBestPractices.md'),
  dos: require<string>('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Text/docs/TextDos.md'),
  donts: require<string>('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Text/docs/TextDonts.md'),
