...
const TagPickerExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Pickers/TagPicker.Basic.Example.tsx') as string;
const PickerCustomResultExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Pickers/Picker.CustomResult.Example.tsx') as string;
