...
export const FloatingPeoplePickerPageProps: IDocPageProps = {
  ...
  overview: require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/FloatingPeoplePicker/docs/FloatingPeoplePickerOverview.md') as string,
  bestPractices: require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/FloatingPeoplePicker/docs/FloatingPeoplePickerBestPractices.md') as string,
  dos: require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/FloatingPeoplePicker/docs/FloatingPeoplePickerDos.md') as string,
  donts: require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/FloatingPeoplePicker/docs/FloatingPeoplePickerDonts.md') as string,
