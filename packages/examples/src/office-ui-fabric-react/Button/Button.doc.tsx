...
const ButtonActionExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/Button.Action.Example.tsx') as string;
const ButtonAnchorExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/Button.Anchor.Example.tsx') as string;
const ButtonCommandBarExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/Button.CommandBar.Example.tsx') as string;
const ButtonCompoundExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/Button.Compound.Example.tsx') as string;
const ButtonContextualMenuExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/Button.ContextualMenu.Example.tsx') as string;
const ButtonCustomSplitExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/Button.CustomSplit.Example.tsx') as string;
const ButtonDefaultExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/Button.Default.Example.tsx') as string;
const ButtonIconExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/Button.Icon.Example.tsx') as string;
const ButtonIconWithTooltipExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/Button.IconWithTooltip.Example.tsx') as string;
const ButtonScreenReaderExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/Button.ScreenReader.Example.tsx') as string;
const ButtonSplitExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/Button.Split.Example.tsx') as string;
const ButtonToggleExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/Button.Toggle.Example.tsx') as string;
const ButtonCommandExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/Button.Command.Example.tsx') as string;
