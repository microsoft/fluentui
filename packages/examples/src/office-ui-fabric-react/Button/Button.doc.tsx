...
const ButtonActionExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/examples/Button.Action.Example.tsx') as string;
const ButtonAnchorExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/examples/Button.Anchor.Example.tsx') as string;
const ButtonCommandBarExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/examples/Button.CommandBar.Example.tsx') as string;
const ButtonCompoundExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/examples/Button.Compound.Example.tsx') as string;
const ButtonContextualMenuExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/examples/Button.ContextualMenu.Example.tsx') as string;
const ButtonCustomSplitExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/examples/Button.CustomSplit.Example.tsx') as string;
const ButtonDefaultExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/examples/Button.Default.Example.tsx') as string;
const ButtonIconExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/examples/Button.Icon.Example.tsx') as string;
const ButtonIconWithTooltipExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/examples/Button.IconWithTooltip.Example.tsx') as string;
const ButtonScreenReaderExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/examples/Button.ScreenReader.Example.tsx') as string;
const ButtonSplitExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/examples/Button.Split.Example.tsx') as string;
const ButtonToggleExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/examples/Button.Toggle.Example.tsx') as string;
const ButtonCommandExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/examples/Button.Command.Example.tsx') as string;
...
export const ButtonPageProps = (props: IButtonDocPageProps): IDocPageProps => ({
  ...
  overview: require<string>('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/docs/ButtonOverview.md'),
  bestPractices: require<
    string
  >('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Button/docs/ButtonBestPractices.md'),
