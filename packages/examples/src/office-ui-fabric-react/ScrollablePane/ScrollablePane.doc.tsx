...
export const ScrollablePanePageProps: IDocPageProps = {
  ...
  overview: require<
    string
  >('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/ScrollablePane/docs/ScrollablePaneOverview.md'),
  bestPractices: require<
    string
  >('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/ScrollablePane/docs/ScrollablePaneBestPractices.md'),
