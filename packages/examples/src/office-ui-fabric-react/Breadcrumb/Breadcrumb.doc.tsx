...
const BreadcrumbBasicExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Breadcrumb/examples/Breadcrumb.Basic.Example.tsx') as string;
const BreadcrumbCollapsingExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Breadcrumb/examples/Breadcrumb.Collapsing.Example.tsx') as string;
const BreadcrumbStaticExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Breadcrumb/examples/Breadcrumb.Static.Example.tsx') as string;
