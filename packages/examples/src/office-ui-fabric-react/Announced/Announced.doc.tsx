...
export const AnnouncedPageProps: IDocPageProps = {
  ...
  overview: require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Announced/docs/AnnouncedOverview.md'),
...
export const AnnouncedQuickActionsPageProps: IDocPageProps = {
  ...
  overview: require<
    string
  >('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Announced/docs/QuickActions/Overview.md'),
  dos: require<string>('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Announced/docs/QuickActions/Dos.md'),
  donts: require<
    string
  >('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Announced/docs/QuickActions/Donts.md'),
  isHeaderVisible: false,
};
...
export const AnnouncedSearchResultsPageProps: IDocPageProps = {
  ...
  overview: require<
    string
  >('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Announced/docs/SearchResults/Overview.md'),
  dos: require<string>('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Announced/docs/SearchResults/Dos.md'),
  donts: require<
    string
  >('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Announced/docs/SearchResults/Donts.md'),
  isHeaderVisible: false,
};
...
export const AnnouncedLazyLoadingPageProps: IDocPageProps = {
  ...
  overview: require<
    string
  >('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Announced/docs/Asynchronous/Overview.md'),
  dos: require<string>('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Announced/docs/Asynchronous/Dos.md'),
  donts: require<
    string
  >('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Announced/docs/Asynchronous/Donts.md'),
  isHeaderVisible: false,
};
...
export const AnnouncedBulkOperationsPageProps: IDocPageProps = {
  ...
  overview: require<
    string
  >('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Announced/docs/BulkLongRunning/Overview.md'),
  dos: require<
    string
  >('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Announced/docs/BulkLongRunning/Dos.md'),
  donts: require<
    string
  >('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Announced/docs/BulkLongRunning/Donts.md'),
  isHeaderVisible: false,
};
