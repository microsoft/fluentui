...
const PanelBasicExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Panel/Panel.Basic.Example.tsx') as string;
const PanelSizesExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Panel/Panel.Sizes.Example.tsx') as string;
const PanelConfirmDismissExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Panel/Panel.ConfirmDismiss.Example.tsx') as string;
const PanelControlledExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Panel/Panel.Controlled.Example.tsx') as string;
const PanelHiddenOnDismissExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Panel/Panel.HiddenOnDismiss.Example.tsx') as string;
const PanelLightDismissExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Panel/Panel.LightDismiss.Example.tsx') as string;
const PanelLightDismissCustomExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Panel/Panel.LightDismissCustom.Example.tsx') as string;
const PanelNonModalExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Panel/Panel.NonModal.Example.tsx') as string;
const PanelFooterExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Panel/Panel.Footer.Example.tsx') as string;
const PanelNavigationExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Panel/Panel.Navigation.Example.tsx') as string;
const PanelHandleDismissTargetExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Panel/Panel.HandleDismissTarget.Example.tsx') as string;
