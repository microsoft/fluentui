...
const SwatchColorPickerBasicExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/SwatchColorPicker/SwatchColorPicker.Basic.Example.tsx') as string;
