...
const RatingBasicExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Rating/Rating.Basic.Example.tsx') as string;
const RatingButtonControlledExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Rating/Rating.ButtonControlled.Example.tsx') as string;
