...
const ToggleBasicExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Toggle/Toggle.Basic.Example.tsx') as string;
const ToggleCustomLabelExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Toggle/Toggle.CustomLabel.Example.tsx') as string;
