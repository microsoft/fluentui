...
export const CalloutPageProps: IDocPageProps = {
  ...
  overview: require<
    string
  >('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Callout/docs/CalloutOverview.md'),
  bestPractices: require<
    string
  >('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Callout/docs/CalloutBestPractices.md'),
