...
const LinkBasicExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Link/examples/Link.Basic.Example.tsx') as string;
...
export const LinkPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Link/docs/LinkOverview.md'),
  bestPractices: require<
    string
  >('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Link/docs/LinkBestPractices.md'),
