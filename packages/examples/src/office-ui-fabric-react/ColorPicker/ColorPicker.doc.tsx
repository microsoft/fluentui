...
const ColorPickerBasicExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/ColorPicker/examples/ColorPicker.Basic.Example.tsx') as string;
