  ...
  public render(): JSX.Element {
    return (
      <ComponentPage
        ...
        overview={
          <Markdown>
            {require<string>('!raw-loader!@fluentui/examples/src/experiments/Slider/docs/SliderOverview.md')}
          </Markdown>
        }
        bestPractices={<div />}
        dos={
          <Markdown>
            {require<string>('!raw-loader!@fluentui/examples/src/experiments/Slider/docs/SliderDos.md')}
          </Markdown>
        }
        donts={
          <Markdown>
            {require<string>('!raw-loader!@fluentui/examples/src/experiments/Slider/docs/SliderDonts.md')}
          </Markdown>
        }
