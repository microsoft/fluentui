  ...
  public render(): JSX.Element {
    return (
      <ComponentPage
        ...
        overview={
          <Markdown>
            {require<string>('!raw-loader!@fluentui/examples/src/experiments/Button/docs/ButtonOverview.md')}
          </Markdown>
        }
        bestPractices={<div />}
        dos={
          <Markdown>
            {require<string>('!raw-loader!@fluentui/examples/src/experiments/Button/docs/ButtonDos.md')}
          </Markdown>
        }
        donts={
          <Markdown>
            {require<string>('!raw-loader!@fluentui/examples/src/experiments/Button/docs/ButtonDonts.md')}
          </Markdown>
        }
