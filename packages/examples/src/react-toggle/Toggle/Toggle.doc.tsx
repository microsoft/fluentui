...
export const TogglePageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@fluentui/examples/src/react-toggle/Toggle/docs/ToggleOverview.md'),
  bestPractices: '',
  dos: require<string>('!raw-loader!@fluentui/examples/src/react-toggle/Toggle/docs/ToggleDos.md'),
  donts: require<string>('!raw-loader!@fluentui/examples/src/react-toggle/Toggle/docs/ToggleDonts.md'),
