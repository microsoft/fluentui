...
import { PivotOverflowMenuExample } from './examples/Pivot.OverflowMenu.Example';
...
const PivotOverflowMenuExampleCode = require('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Pivot/examples/Pivot.OverflowMenu.Example.tsx') as string;
...
export const PivotPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Pivot/docs/PivotOverview.md'),
  bestPractices: '',
  dos: require<string>('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Pivot/docs/PivotDos.md'),
  donts: require<string>('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/Pivot/docs/PivotDonts.md'),
