...
const SliderBasicExampleCode = require('!raw-loader!@fluentui/examples/src/react-slider/Slider/Slider.Basic.Example.tsx') as string;
const SliderVerticalExampleCode = require('!raw-loader!@fluentui/examples/src/react-slider/Slider/Slider.Vertical.Example.tsx') as string;
