...
export const CardPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@fluentui/examples/src/react-cards/Card/docs/CardOverview.md'),
  bestPractices: '',
  dos: require<string>('!raw-loader!@fluentui/examples/src/react-cards/Card/docs/CardDos.md'),
  donts: require<string>('!raw-loader!@fluentui/examples/src/react-cards/Card/docs/CardDonts.md'),
