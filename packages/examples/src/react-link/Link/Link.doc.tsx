...
export const LinkPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@fluentui/examples/src/react-link/Link/docs/LinkOverview.md'),
  bestPractices: '',
  dos: require<string>('!raw-loader!@fluentui/examples/src/react-link/Link/docs/LinkDos.md'),
  donts: require<string>('!raw-loader!@fluentui/examples/src/react-link/Link/docs/LinkDonts.md'),
