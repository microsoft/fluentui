...
const CheckboxBasicExampleCode = require('!raw-loader!@fluentui/examples/src/react-checkbox/Checkbox/Checkbox.Basic.Example.tsx') as string;
const CheckboxOtherExampleCode = require('!raw-loader!@fluentui/examples/src/react-checkbox/Checkbox/Checkbox.Other.Example.tsx') as string;
const CheckboxIndeterminateExampleCode = require('!raw-loader!@fluentui/examples/src/react-checkbox/Checkbox/Checkbox.Indeterminate.Example.tsx') as string;
