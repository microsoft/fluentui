...
const CalloutBasicExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/Callout/Callout.Basic.Example.tsx') as string;
const StatusCalloutExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/Callout/Callout.Status.Example.tsx') as string;
const CalloutFocusTrapExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/Callout/Callout.FocusTrap.Example.tsx') as string;
const CalloutDirectionalExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/Callout/Callout.Directional.Example.tsx') as string;
const CalloutCoverExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/Callout/Callout.Cover.Example.tsx') as string;
