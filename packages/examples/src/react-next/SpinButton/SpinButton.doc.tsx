...
export const SpinButtonPageProps: IDocPageProps = {
  ...
  bestPractices: '',
  dos: require<string>('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/SpinButton/docs/SpinButtonDos.md'),
  donts: require<
    string
  >('!raw-loader!@fluentui/examples/src/office-ui-fabric-react/SpinButton/docs/SpinButtonDonts.md'),
