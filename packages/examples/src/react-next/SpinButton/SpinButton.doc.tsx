...
export const SpinButtonPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@fluentui/examples/src/react-next/SpinButton/docs/SpinButtonOverview.md'),
  bestPractices: require<
    string
  >('!raw-loader!@fluentui/examples/src/react-next/SpinButton/docs/SpinButtonBestPractices.md'),
