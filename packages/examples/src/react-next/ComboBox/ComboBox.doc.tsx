...
const ComboBoxBasicExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/ComboBox/ComboBox.Basic.Example.tsx') as string;

const ComboBoxTogglesExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/ComboBox/ComboBox.Toggles.Example.tsx') as string;

const ComboBoxControlledExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/ComboBox/ComboBox.Controlled.Example.tsx') as string;

const ComboBoxVirtualizedExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/ComboBox/ComboBox.Virtualized.Example.tsx') as string;

const ComboBoxErrorHandlingExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/ComboBox/ComboBox.ErrorHandling.Example.tsx') as string;

const ComboBoxCustomStyledExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/ComboBox/ComboBox.CustomStyled.Example.tsx') as string;
