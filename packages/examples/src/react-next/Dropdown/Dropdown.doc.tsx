...
const DropdownBasicExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/Dropdown/examples/Dropdown.Basic.Example.tsx') as string;
const DropdownControlledExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/Dropdown/examples/Dropdown.Controlled.Example.tsx') as string;
const DropdownControlledMultiExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/Dropdown/examples/Dropdown.ControlledMulti.Example.tsx') as string;
const DropdownCustomExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/Dropdown/examples/Dropdown.Custom.Example.tsx') as string;
const DropdownErrorExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/Dropdown/examples/Dropdown.Error.Example.tsx') as string;
const DropdownRequiredExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/Dropdown/examples/Dropdown.Required.Example.tsx') as string;
