...
const FloatingPeoplePickerBasicExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/FloatingPeoplePicker/PeoplePicker/examples/FloatingPeoplePicker.Basic.Example.tsx') as string;
