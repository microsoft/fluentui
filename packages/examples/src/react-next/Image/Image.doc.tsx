...
const ImageDefaultExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/Image/Image.Default.Example.tsx') as string;
const ImageCenterExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/Image/Image.Center.Example.tsx') as string;
const ImageContainExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/Image/Image.Contain.Example.tsx') as string;
const ImageCoverExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/Image/Image.Cover.Example.tsx') as string;
const ImageCenterContainExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/Image/Image.CenterContain.Example.tsx') as string;
const ImageCenterCoverExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/Image/Image.CenterCover.Example.tsx') as string;
const ImageNoneExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/Image/Image.None.Example.tsx') as string;
const ImageMaximizeFrameExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/Image/Image.MaximizeFrame.Example.tsx') as string;
