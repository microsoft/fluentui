...
const TeachingBubbleBasicExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/TeachingBubble/TeachingBubble.Basic.Example.tsx') as string;
const TeachingBubbleWideExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/TeachingBubble/TeachingBubble.Wide.Example.tsx') as string;
const TeachingBubbleCondensedExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/TeachingBubble/TeachingBubble.Condensed.Example.tsx') as string;
const TeachingBubbleIllustrationExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/TeachingBubble/TeachingBubble.Illustration.Example.tsx') as string;
const TeachingBubbleWideIllustrationExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/TeachingBubble/TeachingBubble.WideIllustration.Example.tsx') as string;
const TeachingBubbleSmallHeadlineExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/TeachingBubble/TeachingBubble.SmallHeadline.Example.tsx') as string;
const TeachingBubbleMultiStepExampleCode = require('!raw-loader!@fluentui/examples/src/react-next/TeachingBubble/TeachingBubble.MultiStep.Example.tsx') as string;
