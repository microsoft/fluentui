  ...
  return {
    callout: {
      ...
      selectors: {
        ...
        '.ms-DatePicker-yearOption--disabled': { color: DarkTheme.palette.neutralPrimary },
        '.ms-DatePicker-monthOption--disabled': { color: DarkTheme.palette.neutralPrimary },
        '.ms-DatePicker-day--disabled': { color: DarkTheme.palette.neutralPrimary },
        '.ms-DatePicker-nextDecade--disabled': { color: DarkTheme.palette.neutralPrimary },
        '.ms-DatePicker-prevDecade--disabled': { color: DarkTheme.palette.neutralPrimary },
        '.ms-DatePicker-prevYear--disabled': { color: DarkTheme.palette.neutralPrimary },
        '.ms-DatePicker-nextYear--disabled': { color: DarkTheme.palette.neutralPrimary },
        '.ms-DatePicker-prevMonth--disabled': { color: DarkTheme.palette.neutralPrimary },
        '.ms-DatePicker-nextMonth--disabled': { color: DarkTheme.palette.neutralPrimary },
