 ...
 */
const FileTypeIconMap: {[key: string]: { type?: ItemType, extensions?: string[], iconType?: string}} = {
    'accdb': { extensions: ['accdb', 'mdb'] },
    'archive': { type: ItemType.Unknown, extensions: ['7z', 'ace', 'arc', 'arj', 'dmg', 'gz', 'iso', 'lzh', 'pkg', 'rar', 'sit', 'tgz', 'tar', 'z'] },
    ...
    'ods': { extensions: ['ods'] },
    'odt': { extensions: ['odt'] },
    'one': { type: ItemType.OneNote, extensions: ['one', 'onepkg'] }, // this is a format for exported single-file notebook pages
    ...
    'vector': { type: ItemType.Unknown, extensions: ['ai', 'dgn', 'pd', 'emf', 'eps', 'indd', 'indt', 'ps', 'svg', 'svgz', 'wmf', 'oxps', 'xps', 'xd', 'sketch'] },
