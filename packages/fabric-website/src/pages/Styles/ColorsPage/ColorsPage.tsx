    ...
    return (
      <div>
        ...
        <div className={ pageStyles.u_maxTextWidth }>
          ...
          <p>Fabric includes 9 theme colors and 11 neutral colors. Each has helper classes for text, background, border, and hover states. When selecting colors, refer to the <a href={ baseURL + 'dist/files/ColorAccessibility_29Sep2016.pdf' }>color accessibility guidance (PDF)</a> to ensure that your text can be ready by everyone.</p>
        </div>
