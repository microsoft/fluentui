...
const DashboardGridLayoutDragApiExampleCode = require('!raw-loader!@uifabric/dashboard-grid-layout/src/components/DashboardGridLayout/examples/DashboardGridLayout.DragApi.Example.tsx') as string;
