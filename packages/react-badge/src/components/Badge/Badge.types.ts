...
import type { ComponentProps, ComponentSlotProps, ComponentState } from '@fluentui/react-utilities';
...
export type BadgeSlots = {
  ...
  root: ComponentSlotProps<React.ComponentType<Omit<React.HTMLAttributes<HTMLElement>, 'color'>>>;
  icon?: ComponentSlotProps<React.ComponentType<React.HTMLAttributes<HTMLElement>>>;
};
