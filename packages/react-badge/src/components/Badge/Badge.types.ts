...
import type { ComponentProps, ComponentState, ObjectSlotProps } from '@fluentui/react-utilities';
...
export type BadgeSlots = {
  ...
  root: ObjectSlotProps<Omit<React.HTMLAttributes<HTMLElement>, 'color'>>;
  icon?: ObjectSlotProps<React.HTMLAttributes<HTMLElement>>;
};
