...
export const Default = (props: Partial<CarouselProps>) => (
  <Carousel circular={true} defaultValue={'test-1'} cardWidth={'25%'} {...props}>
    <CarouselSlider>
      <CarouselCard tabIndex={0} value="test-1">
        {TestDiv('test-1', 'lightgrey')}
      </CarouselCard>
      <CarouselCard tabIndex={0} value="test-2">
        {TestDiv('test-2', 'lightblue')}
      </CarouselCard>
      <CarouselCard tabIndex={0} value="test-3">
        {TestDiv('test-3', 'BlanchedAlmond')}
      </CarouselCard>
      <CarouselCard tabIndex={0} value="test-4">
        {TestDiv('test-4', 'DarkKhaki')}
      </CarouselCard>
      <CarouselCard tabIndex={0} value="test-5">
        {TestDiv('test-5', 'blue')}
      </CarouselCard>
      <CarouselCard tabIndex={0} value="test-6">
        {TestDiv('test-6', 'green')}
      </CarouselCard>
      <CarouselCard tabIndex={0} value="test-7">
        {TestDiv('test-7', 'red')}
      </CarouselCard>
      <CarouselCard tabIndex={0} value="test-8">
