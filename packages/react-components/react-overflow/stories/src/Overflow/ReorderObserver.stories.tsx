  ...
  docs: {
    description: {
      story: [
        ...
        '',
        'Resize the container to see the resize-driven flow, or press **Reverse',
        'order** to trigger a React-only reorder. With the observer in place, the',
        'visibility flips immediately; remove the component to observe the stale',
        'state described in [#36068](https://github.com/microsoft/fluentui/issues/36068).',
      ].join('\n'),
    },
  },
};
