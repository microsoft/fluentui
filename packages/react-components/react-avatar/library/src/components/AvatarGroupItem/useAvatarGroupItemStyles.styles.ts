...
const useRootStyles = makeStyles({
  ...
  nonOverflowItem: {
    borderRadius: `var(--ctrl-token-AvatarGroupItem-299, var(--semantic-token-AvatarGroupItem-300, ${tokens.borderRadiusCircular}))`,
  },
});
...
const useSpreadStyles = makeStyles({
  s: {
    '&:not(:first-child)': {
      marginLeft: `var(--ctrl-token-AvatarGroupItem-305, var(--semantic-token-AvatarGroupItem-306, ${tokens.spacingHorizontalS}))`,
    },
  },
  mNudge: {
    '&:not(:first-child)': {
      marginLeft: `var(--ctrl-token-AvatarGroupItem-307, var(--semantic-token-AvatarGroupItem-308, ${tokens.spacingHorizontalMNudge}))`,
    },
  },
  m: {
    '&:not(:first-child)': {
      marginLeft: `var(--ctrl-token-AvatarGroupItem-309, var(--semantic-token-AvatarGroupItem-310, ${tokens.spacingHorizontalM}))`,
    },
  },
  l: {
    '&:not(:first-child)': {
      marginLeft: `var(--ctrl-token-AvatarGroupItem-311, var(--semantic-token-AvatarGroupItem-312, ${tokens.spacingHorizontalL}))`,
    },
  },
  xl: {
    '&:not(:first-child)': {
      marginLeft: `var(--ctrl-token-AvatarGroupItem-313, var(--semantic-token-AvatarGroupItem-314, ${tokens.spacingHorizontalXL}))`,
    },
  },
});
...
const usePieStyles = makeStyles({
  ...
  thick: {
    [avatarGroupItemDividerWidthVar]: `var(--ctrl-token-AvatarGroupItem-315, var(--semantic-token-AvatarGroupItem-316, ${tokens.strokeWidthThick}))`,
  },
  thicker: {
    [avatarGroupItemDividerWidthVar]: `var(--ctrl-token-AvatarGroupItem-317, var(--semantic-token-AvatarGroupItem-318, ${tokens.strokeWidthThicker}))`,
  },
  thickest: {
    [avatarGroupItemDividerWidthVar]: `var(--ctrl-token-AvatarGroupItem-319, var(--semantic-token-AvatarGroupItem-320, ${tokens.strokeWidthThickest}))`,
  },
});
