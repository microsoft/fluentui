...
import { getNativeElementProps, mergeCallbacks, slot, useId } from '@fluentui/react-utilities';
...
export const useAvatar_unstable = (props: AvatarProps, ref: React.Ref<HTMLElement>): AvatarState => {
  ...
  const root: AvatarState['root'] = slot(
    ...
    { required: true, elementType: 'span' },
  );
  const [imageHidden, setImageHidden] = React.useState<true | undefined>(undefined);
  const image: AvatarState['image'] = slot(props.image, {
  ...
  let initials: AvatarState['initials'] = slot(props.initials, {
    required: true,
    defaultProps: {
  ...
  const badge: AvatarState['badge'] = slot(props.badge, {
