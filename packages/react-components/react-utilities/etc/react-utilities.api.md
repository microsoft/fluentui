...
// @public
export type ForwardRefComponent<Props extends PropsTemplate> = 'ref' extends keyof PropsPrimaryProps<Props> ? React_2.ForwardRefExoticComponent<Props & Pick<PropsPrimaryProps<Props>, 'ref'>> : never;
