...
// @public
export function getNativeProps<Props extends Record<string, any>, E extends Extract<keyof Props, string> = never>(props: Props, allowedPropNames: Array<string> | Record<string, 1>, excludedPropNames?: E[]): Omit<Props, E>;
