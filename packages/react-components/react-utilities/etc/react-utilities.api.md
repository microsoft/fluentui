...
// @public
export type ComponentProps<Slots extends SlotPropsRecord, Primary extends keyof Slots = 'root'> = Omit<Slots, Primary & 'root'> & WithoutSlotRenderFunction<ExtractSlotProps<Slots[Primary]>>;
...
export type ForwardRefComponent<Props> = 'ref' extends keyof Props ? NamedExoticComponent<Props> : NamedExoticComponent<Props & React_2.RefAttributes<InferredElementRefType<Props>>>;
...
// @public
export type Slot<Type extends keyof React_2.JSX.IntrinsicElements | ComponentType<any> | SlotPropsDataType, AlternateAs extends keyof React_2.JSX.IntrinsicElements = never> = IsSingleton<Extract<Type, string>> extends true ? WithSlotShorthandValue<Type extends keyof React_2.JSX.IntrinsicElements ? {
    as?: Type;
...
export type SlotComponentType<Props> = WithoutSlotRenderFunction<Props> & FunctionComponent<{
    ...
    [SLOT_ELEMENT_TYPE_SYMBOL]: ComponentType<Props> | (Props extends AsIntrinsicElement<infer As> ? As : keyof React_2.JSX.IntrinsicElements);
};
