...
// @public
export type SplitButtonBaseState = ComponentState<SplitButtonBaseSlots> & Omit<ButtonBaseState, 'components' | 'iconOnly' | 'root'> & Omit<MenuButtonBaseState, 'components' | 'iconOnly' | 'root'>;
