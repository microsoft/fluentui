...
- <FullscreenLink
    ...
    parent={parentPath}
    story="mail-settings-horizontal-tablist"
  />
- <FullscreenLink
    content="TabList / Mail settings with vertical tablist"
    parent={parentPath}
    story="mail-settings-vertical-tablist"
  />
- <FullscreenLink
    content="TabList / Mail settings with overflow tablist"
    parent={parentPath}
    story="mail-settings-overflow-tablist"
  />
...
- <FullscreenLink content="ToggleButton / Device controls" parent={parentPath} story="device-controls-togle-buttons" />
