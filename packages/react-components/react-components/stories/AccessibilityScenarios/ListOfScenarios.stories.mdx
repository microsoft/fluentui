...
- <FullscreenLink content="Card / User profiles" parent={parentPath} story="user-profile-cards" />
...
- <FullscreenLink
    content="Combobox / Questionnaire about your favorites"
    parent={parentPath}
    story="favorites-comboboxes"
  />

## Component: Dropdown

- <FullscreenLink
    content="Dropdown / Questionnaire about your favorites"
    parent={parentPath}
    story="favorites-dropdowns"
  />

## Component: Fields

- <FullscreenLink content="Fields / Ticket order form" parent={parentPath} story="ticket-order-form-fields" />

## Component: Input

- <FullscreenLink content="Input / Registration form" parent={parentPath} story="registration-form-inputs" />
...
- <FullscreenLink content="Select / Questionnaire about your favorites" parent={parentPath} story="favorites-selects" />
...
- <FullscreenLink content="SpinButton / donation form" parent={parentPath} story="donation-form-spin-buttons" />
...
- <FullscreenLink content="Toolbar / Text editor toolbars" parent={parentPath} story="text-editor-toolbars" />
