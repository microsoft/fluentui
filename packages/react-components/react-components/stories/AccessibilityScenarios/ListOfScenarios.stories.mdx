...
- <FullscreenLink content="Dialog / User prompts" parent={parentPath} story="user-prompting-dialogs" />

## Component: InfoButton

- <FullscreenLink content="InfoButton / Files listing" parent={parentPath} story="files-listing-info-buttons" />

## Component: InfoLabel

- <FullscreenLink content="InfoLabel/ Registration form" parent={parentPath} story="registration-form-info-labels" />
...
- <FullscreenLink content="Table / Files activity" parent={parentPath} story="files-activity-tables" />
