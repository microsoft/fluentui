  ...
  docs: {
    description: {
      story: [
        ...
        '',
        '> ⚠️ _Very few use cases would actually require listening to position updates. Please renderer that_',
        '_there is a difference between **open/close state** which is normally handled in React_',
      ].join('\n'),
    },
  },
};
