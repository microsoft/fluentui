  ...
  docs: {
    description: {
      story: [
        ...
        '',
        'Note:',
        'When disabling transforms, add `width: max-content` (or a fixed width) to the floating element to prevent positioning issues due to layout affecting the floating element.',
        '',
