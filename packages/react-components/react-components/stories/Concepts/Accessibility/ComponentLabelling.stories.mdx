...
<ul>
  ...
  <li>
    Wrap the element with <code>div</code> element. This element should has role="group" and label. After this the
    wrapping grouper element will be narrated. Please see simple code example:
