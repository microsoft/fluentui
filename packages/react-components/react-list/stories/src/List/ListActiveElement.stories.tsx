...
import { List, ListItem, type ListProps } from '@fluentui/react-components';
...
export const ListActiveElement = () => {
  ...
  const onSelectionChange = React.useCallback<NonNullable<ListProps['onSelectionChange']>>((_, data) => {
