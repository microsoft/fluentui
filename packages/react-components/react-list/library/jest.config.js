...
module.exports = {
   ...
   * `@griffel/jest-serializer` as well: no react-list source imports Griffel any more, but
   ...
   * is serialized by `@griffel/jest-serializer` alone and keeps its `fuicm-*` name — the
