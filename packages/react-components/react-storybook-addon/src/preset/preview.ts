...
import { withMaterialTypeProvider } from '../decorators/withSemiTransparentBg';
import { withReactStrictMode } from '../decorators/withReactStrictMode';
import { withAriaLive } from '../decorators/withAriaLive';
import { THEME_ID } from '../constants';

export const decorators = [withFluentProvider, withAriaLive, withMaterialTypeProvider, withReactStrictMode];
