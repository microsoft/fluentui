...
> & {
  ...
  onChange?: (ev: React.ChangeEvent<HTMLInputElement>, data: CheckboxOnChangeData) => void; // callback should be typed with EventHandler, but we can't break existing callbacks
