...
export const colorAreaCSSVars = {
  ...
  sliderProgressXVar: `--fui-SliderX--progress`,
  sliderProgressYVar: `--fui-SliderY--progress`,
...
const useThumbStyles = makeStyles({
  thumb: {
    transform: 'translateX(-50%)', // for vertical use 50%
    left: `var(${sliderProgressXVar})`,
    top: `var(${sliderProgressYVar})`,
    gridRowStart: '2',
    gridRowEnd: '2',
    gridColumnStart: '2',
    gridColumnEnd: '2',
