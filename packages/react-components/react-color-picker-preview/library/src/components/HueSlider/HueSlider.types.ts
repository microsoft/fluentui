 ...
 * HueSlider Props
 */
export type HueSliderProps = Omit<
  ComponentProps<Partial<HueSliderSlots>, 'input'>,
...
/**
 * State used in rendering HueSlider
 */
export type HueSliderState = ComponentState<HueSliderSlots> & Pick<HueSliderProps, 'vertical'>;
