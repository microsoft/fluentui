...
export const DatePicker: React.FunctionComponent<DatePickerProps> = React.forwardRef<HTMLDivElement, DatePickerProps>(
  (propsWithoutDefaults, forwardedRef) => {
    ...
    const calloutDismissed = (ev?: Event | React.MouseEvent<HTMLElement> | React.KeyboardEvent<HTMLElement>): void => {
      calendarDismissed();
    };
