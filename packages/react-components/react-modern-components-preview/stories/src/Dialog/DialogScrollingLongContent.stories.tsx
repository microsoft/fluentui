...
export const ScrollingLongContent = (): React.ReactNode => {
  return (
    <Dialog>
      <DialogTrigger>
...
ScrollingLongContent.parameters = {
  docs: {
    description: {
      story: 'By default `DialogBody` should grow until it fits viewport size, overflowed content will be scrollable',
    },
  },
};
