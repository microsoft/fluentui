...
import type { InlineDrawerProps } from '@fluentui/react-modern-components-preview/drawer';
import {
  DrawerBody,
  DrawerHeader,
  DrawerHeaderTitle,
...
const DrawerInlineExample = ({ setOpen, ...props }: DrawerInlineExampleProps): React.ReactNode => {
