...
export const Resizable = (): React.ReactNode => {
  ...
  const resize = React.useCallback(
    ({ clientX }: { clientX: number }) => {
      ...
      animationFrame.current = targetWindow.requestAnimationFrame(() => {
  ...
  React.useEffect(() => {
    ...
    targetWindow.addEventListener('mousemove', resize);
    targetWindow.addEventListener('mouseup', stopResizing);

    return () => {
      targetWindow.cancelAnimationFrame(animationFrame.current);
      targetWindow.removeEventListener('mousemove', resize);
      targetWindow.removeEventListener('mouseup', stopResizing);
    };
  }, [resize, stopResizing, targetDocument]);
