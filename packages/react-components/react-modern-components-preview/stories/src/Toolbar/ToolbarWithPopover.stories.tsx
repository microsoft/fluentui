...
import { Toolbar, ToolbarButton, ToolbarDivider } from '@fluentui/react-modern-components-preview/toolbar';
...
export const WithPopover = (props: Partial<ToolbarProps>): React.ReactNode => {
