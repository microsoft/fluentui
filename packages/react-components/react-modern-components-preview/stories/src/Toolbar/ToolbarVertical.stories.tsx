...
import { Toolbar, ToolbarToggleButton } from '@fluentui/react-modern-components-preview/toolbar';
import type { ToolbarProps } from '@fluentui/react-modern-components-preview/toolbar';

export const Vertical = (props: Partial<ToolbarProps>): React.ReactNode => (
