...
import type { ToolbarProps, ToolbarButtonProps } from '@fluentui/react-modern-components-preview/toolbar';
...
export const OverflowItems = (props: Partial<ToolbarProps>): React.ReactNode => (
  <div
    style={{
      resize: 'horizontal',
      overflow: 'hidden',
