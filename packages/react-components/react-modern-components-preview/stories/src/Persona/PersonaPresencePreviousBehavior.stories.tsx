...
import { makeStyles, presenceAvailableRegular, presenceOfflineRegular, tokens } from '@fluentui/react-components';
...
export const PresencePreviousBehavior = (): React.ReactNode => {
  ...
  return (
    <div className={styles.root}>
      ...
      <Persona
        avatar={{ badge: { status: 'away', outOfOffice: true } }}
        name="Kevin Sturgis"
        secondaryText="Away - OOF"
      />
      <Persona
        avatar={{ badge: { status: 'offline', outOfOffice: true } }}
        name="Kevin Sturgis"
