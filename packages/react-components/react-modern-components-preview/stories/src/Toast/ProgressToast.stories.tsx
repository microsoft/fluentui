...
import { Button, Link, ProgressBar, Text, ToastTrigger, useId } from '@fluentui/react-components';
import {
  Toaster,
  Toast,
  ToastBody,
...
const DownloadProgressBar = ({ onDownloadEnd }: { onDownloadEnd: () => void }): React.ReactNode => {
