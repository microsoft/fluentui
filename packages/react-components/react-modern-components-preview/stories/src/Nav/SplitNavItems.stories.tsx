...
import type { SplitNavItemProps, MenuButtonProps, TooltipProps } from '@fluentui/react-components';
import {
  NavCategory,
  NavCategoryItem,
  NavDrawer,
...
import { Hamburger, AppItem, AppItemStatic, SplitNavItem } from '@fluentui/react-components';
import {
  Label,
  Menu,
  MenuItem,
...
export const SplitNavItems = (): React.ReactNode => {
