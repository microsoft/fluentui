...
import type { NavDrawerProps, NavDensity } from '@fluentui/react-modern-components-preview/nav';
import {
  NavCategory,
  NavCategoryItem,
  NavDrawer,
...
import { Hamburger, AppItem, AppItemStatic } from '@fluentui/react-components';
...
export const VariableDensityItems = (props: Partial<NavDrawerProps>): React.ReactNode => {
