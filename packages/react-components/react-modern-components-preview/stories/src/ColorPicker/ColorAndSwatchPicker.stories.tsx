...
import { makeStyles, Button, Label, tokens } from '@fluentui/react-components';
import {
  AlphaSlider,
  ColorArea,
  ColorPicker,
...
export const ColorAndSwatchPicker = (): React.ReactNode => {
  ...
  const handleSelect: SwatchPickerProps['onSelectionChange'] = (_, data) => {
