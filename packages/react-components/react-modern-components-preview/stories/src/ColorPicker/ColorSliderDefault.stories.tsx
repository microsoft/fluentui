...
import { ColorSlider, type ColorSliderProps } from '@fluentui/react-modern-components-preview/color-picker';
...
export const ColorSliderDefault = (props: Partial<ColorSliderProps>): React.ReactNode => {
