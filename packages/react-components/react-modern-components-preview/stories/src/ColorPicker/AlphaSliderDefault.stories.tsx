...
import { AlphaSlider, type AlphaSliderProps } from '@fluentui/react-modern-components-preview/color-picker';
...
export const AlphaSliderDefault = (props: Partial<AlphaSliderProps>): React.ReactNode => {
