...
import type { MenuProps } from '@fluentui/react-modern-components-preview/menu';
...
export const NestedSubmenusResponsiveness = (): React.ReactNode => {
  ...
  return (
    <div className={styles.container}>
      <div id="boundary" className={mergeClasses(styles.container, styles.resizableArea)} ref={setBoundary}>
        <Menu open={open} onOpenChange={onOpenChange} positioning={{ positioningRef: positioningRefRoot }}>
