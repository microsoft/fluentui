...
import { Body1, Button, Caption1, Link, makeStyles, Subtitle1, Text, tokens } from '@fluentui/react-components';
...
export const WithAction = (): React.ReactNode => {
  const styles = useStyles();
  ...
  return (
    <div className={styles.main}>
      <section>
        ...
        />
        <Card className={styles.card} onClick={onActionCardClick} onKeyDown={onActionCardKeyDown}>
          <CardPreview>
      ...
      <section>
        ...
        />
        <Card className={styles.card} onClick={onLinkedCardClick} onKeyDown={onLinkedCardKeyDown}>
          <CardPreview>
            <img src={resolveAsset('office2.png')} alt="Sales Presentation Preview" />
          </CardPreview>
