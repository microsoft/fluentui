...
import type { DropdownProps, OptionProps, OptionGroupProps } from '@fluentui/react-modern-components-preview/dropdown';
import {
  AnimalCat24Filled,
  AnimalDog24Filled,
...
export const CustomOptions = (props: Partial<DropdownProps>): React.ReactNode => {
