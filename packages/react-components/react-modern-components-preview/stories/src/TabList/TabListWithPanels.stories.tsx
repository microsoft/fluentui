...
import type { TabListProps, TabValue } from '@fluentui/react-modern-components-preview/tab-list';
import {
  AirplaneRegular,
  AirplaneFilled,
...
type SelectTabEvent = Parameters<NonNullable<TabListProps['onTabSelect']>>[0];
type SelectTabData = Parameters<NonNullable<TabListProps['onTabSelect']>>[1];
...
export const WithPanels = (): React.ReactNode => {
