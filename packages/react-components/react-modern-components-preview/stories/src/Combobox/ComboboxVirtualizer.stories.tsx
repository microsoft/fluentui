...
import { makeStyles, useId, useMergedRefs, useTimeout } from '@fluentui/react-components';
...
export const ComboboxVirtualizer = (props: Partial<ComboboxProps>): React.ReactNode => {
