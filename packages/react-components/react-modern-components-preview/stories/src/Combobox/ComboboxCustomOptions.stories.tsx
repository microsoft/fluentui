...
import type { ComboboxProps, OptionProps, OptionGroupProps } from '@fluentui/react-modern-components-preview/combobox';
...
export const CustomOptions = (props: Partial<ComboboxProps>): React.ReactNode => {
