import { Overflow, OverflowItem, useIsOverflowItemVisible } from '@fluentui/react-modern-components-preview/overflow';
...
export const CustomComponent = (): React.ReactNode => {
