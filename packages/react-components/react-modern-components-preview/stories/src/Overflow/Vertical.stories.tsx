...
import type { OverflowItemProps } from '@fluentui/react-modern-components-preview/overflow';
import {
  Overflow,
  OverflowItem,
  useIsOverflowItemVisible,
  useOverflowMenu,
} from '@fluentui/react-modern-components-preview/overflow';
import {
  makeStyles,
  Button,
  Menu,
...
Vertical.parameters = {
  docs: {
    description: {
      story: ['Use the `overflowAxis` property to switch different orientations.'].join('\n'),
    },
  },
};
