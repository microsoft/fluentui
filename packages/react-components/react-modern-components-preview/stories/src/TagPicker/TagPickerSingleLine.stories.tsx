...
import type { TagPickerProps, TagPickerInputProps } from '@fluentui/react-modern-components-preview/tag-picker';
...
import { makeStyles, useOverflowCount, Avatar, Overflow, OverflowItem } from '@fluentui/react-components';
...
export const SingleLine = (): React.ReactNode => {
  const styles = useStyles();
