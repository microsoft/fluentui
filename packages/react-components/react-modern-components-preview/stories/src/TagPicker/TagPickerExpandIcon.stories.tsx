...
import type { TagPickerProps } from '@fluentui/react-modern-components-preview/tag-picker';
import {
  TagPicker,
  TagPickerList,
  TagPickerInput,
...
import { Avatar, Field } from '@fluentui/react-components';
...
export const ExpandIcon = (): React.ReactNode => {
