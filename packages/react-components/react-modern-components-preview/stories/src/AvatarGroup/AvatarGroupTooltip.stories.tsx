...
import type { AvatarGroupProps } from '@fluentui/react-modern-components-preview/avatar-group';
...
export const Tooltip = (props: Partial<AvatarGroupProps>): React.ReactNode => {
