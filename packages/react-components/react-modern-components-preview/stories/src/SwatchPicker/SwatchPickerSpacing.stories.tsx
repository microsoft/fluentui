...
import { SwatchPicker } from '@fluentui/react-modern-components-preview/swatch-picker';
import { renderSwatchPickerGrid } from './renderSwatchPickerGrid';
...
export const SwatchPickerSpacing = (): React.ReactNode => {
