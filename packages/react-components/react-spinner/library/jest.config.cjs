...
module.exports = {
   ...
   * so this package has to list the serializer itself.
   *
   * Griffel's jest serializer is dropped: react-spinner's only styles file is converted,
   * so nothing in this package renders Griffel atomics any more.
   */
  moduleNameMapper: {
