...
Using typography tokens is as simple as creating a custom style with any component. Simply import `typographyStyles` from the main `@fluentui/react-components` package and use it in your custom style:
