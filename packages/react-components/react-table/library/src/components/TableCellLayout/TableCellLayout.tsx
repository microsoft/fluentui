...
export const TableCellLayout: ForwardRefComponent<TableCellLayoutProps> = React.forwardRef((props, ref) => {
  let state = useTableCellLayout_unstable(props, ref);

  state = useTableCellLayoutStyles_unstable(state);

  state = useCustomStyleHook_unstable('useTableCellLayoutStyles_unstable')(state);
