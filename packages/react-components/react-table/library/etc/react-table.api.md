...
// @public (undocumented)
export const DataGridContextProvider: Provider<DataGridContextValue | undefined> &
  FC<ProviderProps<DataGridContextValue | undefined>>;
...
export type TableCellLayoutState = ComponentState<TableCellLayoutSlots> &
  Pick<TableCellLayoutProps, 'appearance' | 'truncate'> & {
...
// @public (undocumented)
export function useTableColumnSizing_unstable<TItem>(
...
// @public (undocumented)
export function useTableSort<TItem>(
