 ...
 *
 * Griffel → Tailwind + CSS Modules migration: the four `typographyStyles.caption2`
 ...
 */
const classes: Record<'root', string> = { root: styles.caption2 };

export const useCaption2Styles = (): Record<'root', string> => classes;
