 ...
 *
 * Griffel → Tailwind + CSS Modules migration: the four `typographyStyles.largeTitle`
 ...
 */
const classes: Record<'root', string> = { root: styles['large-title'] };

export const useLargeTitleStyles = (): Record<'root', string> => classes;
