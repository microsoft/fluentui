 ...
 *
 * Griffel → Tailwind + CSS Modules migration: the four `typographyStyles.subtitle1`
 ...
 */
const classes: Record<'root', string> = { root: styles.subtitle1 };

export const useSubtitle1Styles = (): Record<'root', string> => classes;
