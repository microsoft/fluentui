 ...
 *
 * Griffel → Tailwind + CSS Modules migration: the four `typographyStyles.title2`
 ...
 */
const classes: Record<'root', string> = { root: styles.title2 };

export const useTitle2Styles = (): Record<'root', string> => classes;
