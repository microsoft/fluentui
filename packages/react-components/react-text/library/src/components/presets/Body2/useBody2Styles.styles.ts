 ...
 *
 * Griffel → Tailwind + CSS Modules migration: the four `typographyStyles.body2`
 ...
 */
const classes: Record<'root', string> = { root: styles.body2 };

export const useBody2Styles = (): Record<'root', string> => classes;
