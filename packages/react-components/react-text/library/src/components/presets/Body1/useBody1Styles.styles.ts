 ...
 *
 * Griffel → Tailwind + CSS Modules migration: the four `typographyStyles.body1`
 ...
 */
const classes: Record<'root', string> = { root: styles.body1 };

export const useBody1Styles = (): Record<'root', string> => classes;
