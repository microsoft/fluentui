 ...
 *
 * Griffel → Tailwind + CSS Modules migration: the four `typographyStyles.display`
 ...
 */
const classes: Record<'root', string> = { root: styles.display };

export const useDisplayStyles = (): Record<'root', string> => classes;
