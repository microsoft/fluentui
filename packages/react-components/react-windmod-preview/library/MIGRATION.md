...
**144 component subpaths**, all kebab-case:
...
| Menu          | `./menu` `./menu-trigger` `./menu-popover` `./menu-list` `./menu-item` `./menu-item-checkbox` `./menu-item-radio` `./menu-item-link` `./menu-item-switch` `./menu-group` `./menu-group-header` `./menu-divider`                                                                                                                                                                                                                                                   |
...
| `MenuSplitGroup`                                                                                    | headless ships it, windmod has not reskinned it yet; the other twelve `Menu` subpaths all ship                                          |
