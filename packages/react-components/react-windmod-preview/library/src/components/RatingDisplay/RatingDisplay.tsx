 ...
 */
export const RatingDisplay: ForwardRefComponent<RatingDisplayProps> = React.forwardRef(
  ...
  ({ color = 'neutral', compact = false, icon = StarFilled, max = 5, size = 'medium', ...rest }, ref) => {
