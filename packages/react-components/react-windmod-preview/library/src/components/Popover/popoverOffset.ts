...
/** Same contract as tooltipOffset — see Tooltip.tsx. TeachingPopover calls this directly because
 * its arrow defaults on; Popover and AvatarGroupPopover go through resolvePopoverArrow. */
