...
| ------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- |
| installing, import order, the provider, wiring your own Tailwind, or a build error naming `#theme`, `@custom-variant` or a token     | [references/setup.md](references/setup.md)                                                                                                                                                                       | griffel-deltas, authoring-conventions |
