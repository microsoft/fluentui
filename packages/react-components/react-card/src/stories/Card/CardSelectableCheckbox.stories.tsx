...
SelectableWithCheckbox.parameters = {
  docs: {
    description: {
      story: `By default, selectable cards do not include a checkbox to represent its selection state. Checkboxes can be composed together as an additional component by using the \`select\` property.`,
    },
  },
};
