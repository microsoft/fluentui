...
- <kbd>Tab</kbd> moves focus out of the textarea (it does not insert a tab character). This is the standard HTML
  behavior and is what allows keyboard users to escape the field.
