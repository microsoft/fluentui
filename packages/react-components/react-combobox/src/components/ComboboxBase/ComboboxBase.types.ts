...
export type ComboboxBaseSlots = {
  ...
  input: NonNullable<Slot<'button', 'input'>>;
};

/**
 * ComboboxBase Props
 */
export type ComboboxBaseProps = ComponentProps<Partial<ComboboxBaseSlots>, 'input'> &
  SelectionProps & {
    /**
 ...
 */
export type ComboboxBaseState = ComponentState<ComboboxBaseSlots> &
  Required<Pick<ComboboxBaseProps, 'appearance' | 'open' | 'inline' | 'size'>> &
