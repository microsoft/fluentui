...
// @public (undocumented)
export const ListboxProvider: React_2.Provider<ListboxContextValue | undefined> &
  React_2.FC<React_2.ProviderProps<ListboxContextValue | undefined>>;
...
export type SelectionEvents =
  ...
  | React_2.KeyboardEvent<HTMLElement>
  | React_2.MouseEvent<HTMLElement>;
...
export function useComboboxFilter<
  T extends
    ...
    | string,
>(query: string, options: T[], config: UseComboboxFilterConfig<T>): JSX.Element[];
