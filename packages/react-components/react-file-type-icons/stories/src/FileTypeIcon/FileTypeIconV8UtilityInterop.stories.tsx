...
V8UtilityInterop.parameters = {
  docs: {
    description: {
      story:
        'Migration reference: this shows parity between utility resolvers and component rendering. Prefer FileTypeIcon for new UI, and keep utility APIs for incremental migration paths.',
    },
  },
};

V8UtilityInterop.storyName = 'Migration and Interop';
