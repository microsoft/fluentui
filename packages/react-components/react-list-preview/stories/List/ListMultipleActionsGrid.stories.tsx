...
export const ListMultipleActionsGrid = (props: Partial<ListProps>) => {
...
ListMultipleActionsGrid.parameters = {
  docs: {
    description: {
      story: ['You can select the items with a click or using a Spacebar key.'].join('\n'),
    },
  },
};
