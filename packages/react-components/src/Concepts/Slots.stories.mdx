...
- IntrinsicShorthandProps: The props for a slot that supports one or more HTML element types, such as 'div'.
- ObjectShorthandProps: The props for a slot that additionally supports a JSX component or component props object.
- ShorthandRenderFunction: A render function for a slot.
