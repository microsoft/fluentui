...
- ComponentSlotProps: The props for a slot that additionally supports a JSX component or component props object.
...
use to determine what the entirety of the slot props bag.
