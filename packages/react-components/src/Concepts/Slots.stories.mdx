...
- Slot: The props for a slot that supports one or more HTML element types like 'div', or component type like Button.
- SlotWithoutChildren: Same as Slot, but does not allow shorthand for children.
