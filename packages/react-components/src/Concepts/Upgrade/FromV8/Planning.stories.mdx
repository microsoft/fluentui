...
As mentioned before, Fluent React v9 was designed to allow you to incrementally upgrade.
You have a lot of flexibility on how your approach, plan, and execute moving to v9.
...
Scan over your codebase and to answer the following questions:
...
Basic usage of means you use the component with minimal customization.
...
Advanced usage includes things like passing complex custom styles objects, callbacks for custom rendering,
using refs to make imperatives calls,and complex data binding.
...
Incremental: upgrade a few components and ship, often with flighting the upgraded components to a subset of users.
The benefits of incremental are you get v9 improvements sooner, find issues earlier,
and can iteratively get faster upgrading components.

Since v9 does yet have all the components offered in v8, incremental allows you to gradually introduce v9
...
All-at-once: upgrade every v8 component to their v9 equivalent.
...
You also get the maximum benefits v9 including a new consistent style,
tree-shaking out v8 components from the bundles, build-time CSS optimizations, and render performance improvements.

**Horizontal** or **Vertical**

Horizontal: upgrading one component across your entire application.
...
Vertical: upgrading all the components in one part of your application.
...
Deep: upgrading components that are core to your application and re-used in many places.
...
Shallow: upgrading components that are appear in only one non-critical place in your application.
...
If you need style consistency, apply themeing and style customizations to make v8 components look like v9 components,
...
**Manual** or **Code mods** or **Shims**

Manual: update each usage of Fluent React by hand.
...
You may also have an existing wrapper around a component that allows you to pgrade at a single code location.
...
Code mod: author a script to update multiple locations in your code at once.
...
Shims: author or use a component that take v8 props and renders a v9 component.
