...
With the map function outside Menu component, you get a lot more control.
...
FluentProvider does **not** have a default theme like ThemeProvider, so you'll need to set the theme.
