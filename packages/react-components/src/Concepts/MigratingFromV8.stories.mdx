...
If you or your team are currently using version 8.x.x of `@fluentui/react` and are thinking of transitioning to use our 9.x.x-beta components, then we would first like to thank you for making the jump and tell you how excited we are for you to experience all the improvements and features we have been working on for the past couple of months.
