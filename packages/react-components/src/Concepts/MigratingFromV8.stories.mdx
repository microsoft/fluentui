...
We our modernizing our components in version 9 to adhere to the latest guidelines in the Fluent Design Language. That is the reason of any visual differences you might notice.
...
In this way, we can actually maintain the separation of concerns we had for types and styling before while also separating the concerns of state management and rendering logic into their own individually reusable parts.
