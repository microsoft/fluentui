...
When designing an application or a web page, keep in mind that the easiest way to make it accessible is to maintain a consistent and standard compliant document structure.
...
- verify usage of **[color and contrast](https://webaim.org/resources/contrastchecker/)** to convey information
