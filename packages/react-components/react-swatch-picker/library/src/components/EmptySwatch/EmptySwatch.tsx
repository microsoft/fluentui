...
export const EmptySwatch: ForwardRefComponent<EmptySwatchProps> = React.forwardRef((props, ref) => {
  let state = useEmptySwatch_unstable(props, ref);

  state = useEmptySwatchStyles_unstable(state);
  state = useCustomStyleHook_unstable('useEmptySwatchStyles_unstable')(state);
