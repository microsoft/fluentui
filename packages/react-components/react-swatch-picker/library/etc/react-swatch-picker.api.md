...
export type SwatchPickerContextValue = Pick<SwatchPickerProps, 'size' | 'shape' | 'spacing' | 'selectedValue'> & {
  ...
  requestSelectionChange: (
    event: React_2.MouseEvent<HTMLButtonElement>,
    data: {
...
// @public (undocumented)
export const SwatchPickerProvider: React_2.Provider<SwatchPickerContextValue> &
  React_2.FC<React_2.ProviderProps<SwatchPickerContextValue>>;
