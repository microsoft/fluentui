...
<table>
  ...
  <tbody>
    <tr>
      <td>Content before spin button</td>
      <td>Tab</td>
      <td>Rest</td>
    </tr>
    <tr>
      <td>Rest</td>
      <td>Tab</td>
      <td>Content after spin button</td>
    </tr>
    <tr>
      <td>Editing</td>
      <td>Tab</td>
      <td>Content after spin button (Value committed)</td>
    </tr>
    <tr>
      <td>Editing</td>
      <td>Enter</td>
      <td>Rest (Value committed)</td>
    </tr>
    <tr>
      <td>Rest</td>
      <td>Any Edit Key (that results in a change)</td>
      <td>Editing</td>
    </tr>
    <tr>
      <td>Editing</td>
...
<table>
  ...
  <tbody>
    <tr>
      <td>Home</td>
      <td>First item in defined range</td>
    </tr>
    <tr>
      <td>End</td>
      <td>Last item in defined range</td>
    </tr>
    <tr>
      <td>Up arrow</td>
      <td>Increments value higher, based on the step prop (defaulting to 1)</td>
    </tr>
    <tr>
      <td>Down arrow</td>
      <td>Increments value lower, based on the step prop (defaulting to 1)</td>
    </tr>
    <tr>
      <td>Page up</td>
      <td>Increments value higher, based on the stepPage prop (defaulting to 1)</td>
    </tr>
    <tr>
      <td>Page down</td>
      <td>Increments value lower, based on the stepPage prop (defaulting to 1)</td>
    </tr>
    <tr>
      <td>Typing valid value</td>
      <td>Valid value</td>
    </tr>
  </tbody>
</table>
