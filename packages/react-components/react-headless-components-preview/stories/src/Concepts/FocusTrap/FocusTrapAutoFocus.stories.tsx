...
const classes = {
  ...
  input:
    'px-3 py-2 rounded-md border border-gray-300 focus-visible:outline-2 focus-visible:outline-blue-500 focus-visible:outline-offset-2',
};

export const AutoFocus = (): React.ReactNode => {
  ...
  return (
    <div className="flex flex-col gap-4 max-w-md">
      ...
      <p className={classes.hint}>
        On open, focus jumps to the input marked with <code>data-autofocus</code> instead of the first tabbable element.
      </p>

      {open && (
        <div ref={trapRef} role="dialog" aria-label="Form panel" className={classes.panel}>
