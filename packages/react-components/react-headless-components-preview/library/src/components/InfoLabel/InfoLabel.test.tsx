...
describe('InfoLabel', () => {
  ...
  it("applies the popover id to aria-owns on the InfoLabel's wrapper when open", () => {
    const { container } = render(
      <InfoLabel className="info-label-wrapper" infoButton={{ popover: { id: 'test-id' } }} info="Test" />,
    );
