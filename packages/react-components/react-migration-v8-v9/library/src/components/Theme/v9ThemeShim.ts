...
const mapAliasColors = (palette: IPalette, inverted: boolean): ColorTokens => {
  return {
    ...
    colorNeutralBackground8Hover: inverted ? grey[96] : grey[24],
    colorNeutralBackground8Pressed: inverted ? grey[88] : grey[12],
    colorNeutralBackground8Selected: inverted ? grey[92] : grey[22],
