...
describe('createCSSRuleFromTheme', () => {
  ...
  it.each([
    ...
    { description: 'quoted line continuation', value: '"font\\\nfamily"' },
    { description: 'quoted CRLF continuation', value: '"font\\\r\nfamily"' },
    { description: 'quoted carriage return continuation', value: '"font\\\rfamily"' },
    { description: 'quoted form feed continuation', value: '"font\\\ffamily"' },
    { description: 'escapes in comments', value: String.raw`red /* \name \" \\ */` },
    { description: 'escaped unquoted URL characters', value: String.raw`url(image\20 name.png)` },
    { description: 'leading escape in unquoted URL content', value: String.raw`url(\69mage.png)` },
    { description: 'escape after unquoted URL whitespace', value: String.raw`url( \69mage.png)` },
    { description: 'escape in quoted URL content', value: String.raw`url("\69mage.png")` },
