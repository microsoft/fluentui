...
describe('Link', () => {
  isConformant<LinkProps>({
    ...
    //
    // `component-has-static-classnames-object` asserts `linkClassNames` still holds
    // `fui-Link` / `fui-Link__<slot>` strings AND that they are rendered. Both are false by
