...
// Monaco token colors must be hex. Syntax highlighting has no Fluent semantic tokens (keyword / string /
// type), so these stay curated GitHub-inspired palettes. Editor chrome below uses resolved Theme values.
