...
PreventClose.parameters = {
  docs: {
    description: {
      story: [
        'By setting the `modalType` prop to `alert` and not providing a onOpenChange handler, the Drawer will not be closable by clicking outside nor using the "ESC" key.',
