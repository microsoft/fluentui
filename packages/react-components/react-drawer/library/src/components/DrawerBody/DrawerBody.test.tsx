...
describe('DrawerBody', () => {
  isConformant({
    ...
    //
    // `component-has-static-classnames-object` asserts `drawerBodyClassNames` still holds
    // `fui-DrawerBody` AND that it is rendered. Both are false by design: DECISIONS.md
