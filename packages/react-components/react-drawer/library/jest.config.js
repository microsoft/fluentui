...
module.exports = {
   ...
   * `@fluentui/react-motion-components-preview` presence components and portal through
   * `@fluentui/react-portal`, and unconverted packages elsewhere in the tree still emit
