...
// @public
export const renderTeachingPopoverTrigger_unstable: (
  state: TeachingPopoverTriggerState,
...
// @public (undocumented)
export const TeachingPopoverCarouselProvider: Provider<TeachingPopoverCarouselContextValue> &
  FC<ProviderProps<TeachingPopoverCarouselContextValue>>;
...
export const useTeachingPopoverCarouselNavButton_unstable: (
  ...
  ref: React_2.Ref<HTMLAnchorElement | HTMLButtonElement>,
