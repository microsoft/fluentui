...
export type TeachingPopoverCarouselFooterButtonProps = ComponentProps<TeachingPopoverCarouselFooterButtonSlots> &
  ButtonProps & {
     ...
     * A null or undefined value hides the button. If it has focus, focus moves to the first registered
     * opposite navigation button that is mounted and focusable.
     */
