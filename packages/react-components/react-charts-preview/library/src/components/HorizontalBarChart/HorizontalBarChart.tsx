...
import { formatValueWithSIPrefix, getAccessibleDataObject, useRtl, getNextGradient } from '../../utilities/index';
...
>((props, forwardedRef) => {
  ...
  function _addDefaultGradients(dataPoints?: ChartDataPoint[]): ChartDataPoint[] {
    return dataPoints
