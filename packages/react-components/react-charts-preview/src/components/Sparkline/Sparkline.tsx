...
export const Sparkline: React.FunctionComponent<ISparklineProps> = React.forwardRef<HTMLDivElement, ISparklineProps>(
  (props, forwardedRef) => {
    ...
    const [height, setHight] = React.useState<number>(0);
    const [valueTextWidth, setValueTextWidth] = React.useState<number>(0);
    ...
    return !_isChartEmpty() ? (
      <FocusZone direction={FocusZoneDirection.horizontal} isCircularNavigation={true} className={classes.inlineBlock}>
