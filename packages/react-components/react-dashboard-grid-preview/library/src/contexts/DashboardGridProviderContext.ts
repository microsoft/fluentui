...
const DashboardGridProviderContext: Context<DashboardGridProviderContextValue | undefined> =
  createContext<DashboardGridProviderContextValue | undefined>(undefined);
...
export const useDashboardGridProviderContext_unstable = <T>(
  ...
  useContextSelector(DashboardGridProviderContext, value => (value ? selector(value) : undefined));
