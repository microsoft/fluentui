...
export type CalendarMonthGridCellState = ComponentState<CalendarMonthGridCellSlots> & {
  /**
   * Whether the month represented by this cell is the current month.
   */
  isCurrent: boolean;

  /**
   * Whether the month represented by this cell is within the allowed date bounds.
   */
  isInBounds: boolean;

  /**
   * Whether the month represented by this cell is currently selected.
   */
  isSelected: boolean;
};
