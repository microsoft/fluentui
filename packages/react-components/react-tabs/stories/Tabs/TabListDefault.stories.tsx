...
import { useIsOverflowItemVisible, useOverflowMenu, Overflow, OverflowItem } from '@fluentui/react-components';
...
const MoreHorizontal = bundleIcon(MoreHorizontalFilled, MoreHorizontalRegular); //----- Example Tab Data -----//
