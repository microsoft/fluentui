...
module.exports = {
   ...
   * Griffel's jest serializer does for Griffel atomics (DECISIONS.md D9). The mapper is
   ...
   *
   * Griffel's jest serializer stays: no react-tabs source imports Griffel any more, but
