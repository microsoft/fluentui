...
import { dataTreeItemValueAttrName, treeDataTypes } from '../../utils/tokens';
import { useTreeContext_unstable, useTreeItemContext_unstable, useSubtreeContext_unstable } from '../../contexts/index';
  ...
  return {
    ...
    root: slot.always(
      getNativeElementProps(as, {
        tabIndex: -1,
        [dataTreeItemValueAttrName]: treeType === 'flat' ? value : undefined,
        ...rest,
        ref,
        role: 'treeitem',
        'aria-level': level,
