...
const items = flattenTree_unstable([
  {
    ...
    subtree: [
      { id: 'item1__item1', children: <TreeItemLayout>level 2, item 1</TreeItemLayout> },
      { id: 'item1__item2', children: <TreeItemLayout>level 2, item 2</TreeItemLayout> },
      { id: 'item1__item3', children: <TreeItemLayout>level 2, item 3</TreeItemLayout> },
    ],
  },
  {
    id: 'item2',
    ...
    subtree: [
      {
        ...
        subtree: [{ id: 'item2__item1__item1', children: <TreeItemLayout>level 3, item 1</TreeItemLayout> }],
      },
    ],
  },
]);
...
const Example = (props: TreeProps) => {
  const flatTree = useFlatTree_unstable(items, props);
  return (
