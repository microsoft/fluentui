...
OpenItemControlled.parameters = {
  docs: {
    description: {
      story: `
You can also control the open/closed state of a single \`TreeItem\` component directly. This will override the internal value
of \`openItems\` in favor of the \`open\` property.
      `,
    },
  },
};
