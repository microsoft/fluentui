...
type PopoverBaseProps = Omit<PopoverProps, 'appearance' | 'size'>;
type PopoverBaseState = Omit<PopoverState, 'appearance' | 'size'>;
...
function useOpenState(
  state: Pick<PopoverBaseState, 'setContextTarget' | 'onOpenChange'> & Pick<PopoverProps, 'open' | 'defaultOpen'>,
) {
  'use no memo';
