...
export const ExperimentsSlideUnderAB = () => {
  ...
  return (
    <div className={classes.container}>
      ...
      <div style={{ perspective, perspectiveOrigin: '50% 50%', display: 'inline' }}>
        ...
        >
          <SlideUnder.In>{contentA}</SlideUnder.In>
          <Hold duration={2000}>{contentA}</Hold>
          <SlideUnder.Out>{contentA}</SlideUnder.Out>

          <SlideUnder.In>{contentB}</SlideUnder.In>
          <Hold duration={2000}>{contentB}</Hold>
          <SlideUnder.Out>{contentB}</SlideUnder.Out>
        </Series>
      </div>
    </div>
  );
...
ExperimentsSlideUnderAB.parameters = {
  docs: {
    description: {
      // story: description,
    },
