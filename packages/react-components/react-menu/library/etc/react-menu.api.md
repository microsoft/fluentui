...
// @public
export type MenuItemLinkProps = ComponentProps<MenuItemLinkSlots> &
  Pick<MenuItemProps, 'disabled'> & {
    href: string;
  };
...
// @public (undocumented)
export const MenuListProvider: React_2.Provider<MenuListContextValue> &
  React_2.FC<React_2.ProviderProps<MenuListContextValue>>;
...
export type SelectableHandler = (
  e: React_2.MouseEvent | React_2.KeyboardEvent,
  name: string,
  value: string,
  checked: boolean,
) => void;
...
export const useMenuItemCheckbox_unstable: (
  ...
  ref: React_2.Ref<ARIAButtonElement<'div'>>,
...
export const useMenuItemLink_unstable: (
  ...
  ref: React_2.Ref<HTMLAnchorElement>,
) => MenuItemLinkState;
