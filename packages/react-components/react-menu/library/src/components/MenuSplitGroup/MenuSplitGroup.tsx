...
export const MenuSplitGroup: ForwardRefComponent<MenuSplitGroupProps> = React.forwardRef((props, ref) => {
  let state = useMenuSplitGroup_unstable(props, ref);

  state = useMenuSplitGroupStyles_unstable(state);

  state = useCustomStyleHook_unstable('useMenuSplitGroupStyles_unstable')(state);
