...
import { IAddCardPanelProps, IAddCardPanelState, IAddCardPanelStyles, IAddCardPanelStyleProps } from './AddCardPanel.types';
import { IDGLCard, CardSize, DraggingAnimationType } from '../../../index';
import { ITheme } from 'office-ui-fabric-react/lib/Styling';

export class AddCardPanelBase extends BaseComponent<IAddCardPanelProps, IAddCardPanelState> {
  ...
  public render(): JSX.Element {
    const { header, isOpen, cards, closeButtonAriaLabel, theme } = this.props;
    return (
      <>
        <Panel
          closeButtonAriaLabel={closeButtonAriaLabel}
          onRenderBody={this._renderAddCardItems.bind(this, cards, header, isOpen, theme)}
  ...
  private _renderAddCardItems = (addCardItems: IDGLCard[], header: string, isOpen: boolean, theme: ITheme): JSX.Element => {
    const getClassNames = classNamesFunction<IAddCardPanelStyleProps, IAddCardPanelStyles>();
