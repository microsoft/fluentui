...
import { FullPageWizardExample } from './examples/FullPageWizard.Example';
...
const FullPageWizardExampleCode = require('!raw-loader!@uifabric/dashboard/src/components/Wizard/examples/FullPageWizard.Example.tsx') as string;
      ...
      <ComponentPage
        ...
        exampleCards={
          <div>
            ...
            <ExampleCard title="Full page wizard" code={FullPageWizardExampleCode}>
              <FullPageWizardExample />
            </ExampleCard>
          </div>
        }
        propertiesTables={
