...
const useRootStyles = makeStyles({
  ...
  small: {
    ...
    fontWeight: tokens.fontWeightRegular as CSSProperties['fontWeight'],
  ...
  medium: {
    ...
    fontWeight: tokens.fontWeightSemibold as CSSProperties['fontWeight'],
...
const useRootFocusStyles = makeStyles({
  ...
  // circular: theme =>
  //  createFocusOutlineStyle(theme, { style: { outlineRadius: tokens.global.borderRadius.circular } },
  // primary: theme => createFocusOutlineStyle(theme, { style: { outlineOffset: '2px' } },
  // square: theme => createFocusOutlineStyle(theme, { style: { outlineRadius: tokens.global.borderRadius.none } },
