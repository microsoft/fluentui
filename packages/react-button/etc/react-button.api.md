...
// @public (undocumented)
export const useButtonClasses: (state: ButtonState, options?: import("@fluentui/react-theme-provider/lib/makeStyles.compat").UseStylesOptions | undefined) => void;
...
// @public (undocumented)
export const useSplitButtonClasses: (state: SplitButtonState, options?: import("@fluentui/react-theme-provider/lib/makeStyles.compat").UseStylesOptions | undefined) => void;
