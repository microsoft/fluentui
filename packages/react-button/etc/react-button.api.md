...
// @public (undocumented)
export const useStaticButtonContentStyles: (selectors?: any, ...classNames: (string | undefined)[]) => string;

// @public (undocumented)
export const useStaticButtonIconStyles: (selectors?: any, ...classNames: (string | undefined)[]) => string;

// @public (undocumented)
export const useStaticButtonStyles: (selectors?: any, ...classNames: (string | undefined)[]) => string;
