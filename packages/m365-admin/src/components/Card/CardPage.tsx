...
const SmallCardExampleCode = require('!raw-loader!@uifabric/m365-admin/src/components/Card/examples/Card.Small.Basic.Example.tsx') as string;
const MediumTallCardExampleCode = require('!raw-loader!@uifabric/m365-admin/src/components/Card/examples/Card.MediumTall.Basic.Example.tsx') as string;
const MediumWideCardExampleCode = require('!raw-loader!@uifabric/m365-admin/src/components/Card/examples/Card.MediumWide.Basic.Example.tsx') as string;
const LargeCardExampleCode = require('!raw-loader!@uifabric/m365-admin/src/components/Card/examples/Card.Large.Basic.Example.tsx') as string;
    ...
    return (
      <ComponentPage
        ...
        propertiesTables={
          <PropertiesTableSet
            sources={[
              require<string>('!raw-loader!@uifabric/m365-admin/src/components/Card/Card.types.ts'),
              require<
                string
              >('!raw-loader!@uifabric/m365-admin/src/components/Card/ThumbnailList/ThumbnailList.types.ts'),
              require<string>('!raw-loader!@uifabric/m365-admin/src/components/Card/GridList/GridList.types.ts'),
              require<string>('!raw-loader!@uifabric/m365-admin/src/components/Card/Layout/Layout.types.ts'),
              require<
                string
              >('!raw-loader!@uifabric/m365-admin/src/components/Card/CompoundButtonStack/CompoundButtonStack.types.ts'),
              require<string>('!raw-loader!@uifabric/m365-admin/src/components/Card/BodyText/BodyText.types.ts'),
              require<string>('!raw-loader!@uifabric/m365-admin/src/components/Card/ActionBar/ActionBar.types.ts')
            ]}
            renderOnly={[
              'CardSize',
              'CardContentType',
