...
const NavExampleCode = require('!raw-loader!@uifabric/m365-admin/src/components/Nav/examples/Nav.Example.tsx') as string;
  ...
  public render(): JSX.Element {
    return (
      <ComponentPage
        ...
        propertiesTables={
          <PropertiesTableSet
            sources={[require<string>('!raw-loader!@uifabric/m365-admin/src/components/Nav/Nav.types.ts')]}
