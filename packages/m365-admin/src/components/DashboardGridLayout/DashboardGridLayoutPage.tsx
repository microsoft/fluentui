...
const DashboardGridLayoutExampleCode = require('!raw-loader!@uifabric/m365-admin/src/components/DashboardGridLayout/examples/DashboardGridLayout.Example.tsx') as string;
const DashboardGridLayoutCardExampleCode = require('!raw-loader!@uifabric/m365-admin/src/components/DashboardGridLayout/examples/DashboardGridLayout.Card.Example.tsx') as string;
        ...
        propertiesTables={
          <PropertiesTableSet
            sources={[
              require<
                string
              >('!raw-loader!@uifabric/m365-admin/src/components/DashboardGridLayout/DashboardGridLayout.types.ts')
            ]}
