...
const RecommendationExampleCode = require('!raw-loader!@uifabric/m365-admin/src/components/Recommendation/examples/Recommendation.Basic.Example.tsx') as string;

const DlpRecommendationCode = require('!raw-loader!@uifabric/m365-admin/src/components/Recommendation/examples/Recommendation.DLP.Example.tsx') as string;

const PasswordSettingsRecommendationCode = require('!raw-loader!@uifabric/m365-admin/src/components/Recommendation/examples/Recommendation.PasswordSettings.Example.tsx') as string;
    ...
    return (
      <ComponentPage
        ...
        propertiesTables={
          <PropertiesTableSet
            sources={[
              require<string>('!raw-loader!@uifabric/m365-admin/src/components/Recommendation/Recommendation.types.ts')
            ]}
          />
        }
