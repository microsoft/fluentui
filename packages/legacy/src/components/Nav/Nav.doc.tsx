...
export const NavPageProps: IDocPageProps = {
  ...
  propertiesTablesSources: [require<string>('!raw-loader!@uifabric/legacy/src/components/Nav/Nav.types.ts')],
  overview: require<string>('!raw-loader!@uifabric/legacy/src/components/Nav/docs/NavOverview.md'),
  bestPractices: '',
  dos: require<string>('!raw-loader!@uifabric/legacy/src/components/Nav/docs/NavDos.md'),
  donts: require<string>('!raw-loader!@uifabric/legacy/src/components/Nav/docs/NavDonts.md'),
