...
export const CalendarPageProps: IDocPageProps = {
  ...
  componentUrl: 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/packages/legacy/src/components/Calendar',
  examples: [
    {
  ...
  overview: require<string>('!raw-loader!@uifabric/legacy/src/components/Calendar/docs/CalendarOverview.md'),
  bestPractices: '',
  dos: require<string>('!raw-loader!@uifabric/legacy/src/components/Calendar/docs/CalendarDos.md'),
  donts: require<string>('!raw-loader!@uifabric/legacy/src/components/Calendar/docs/CalendarDonts.md'),
