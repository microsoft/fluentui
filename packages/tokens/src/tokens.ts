...
export const tokens: Record<keyof Theme, string> = {
  ...
  colorNeutralBackground8Hover: 'var(--colorNeutralBackground8Hover)',
  colorNeutralBackground8Pressed: 'var(--colorNeutralBackground8Pressed)',
  colorNeutralBackground8Selected: 'var(--colorNeutralBackground8Selected)',
