...
export const fontFamilies: FontFamilyTokens = {
  fontFamilyBase:
    ...
    "'Segoe UI', 'Segoe UI Web (West European)', BlinkMacSystemFont, Roboto, 'Helvetica Neue', sans-serif",
  fontFamilyMonospace: "Consolas, 'Courier New', Courier, monospace",
  fontFamilyNumeric:
    // eslint-disable-next-line @fluentui/max-len
    "Bahnschrift, 'Segoe UI', 'Segoe UI Web (West European)', BlinkMacSystemFont, Roboto, 'Helvetica Neue', sans-serif",
};
