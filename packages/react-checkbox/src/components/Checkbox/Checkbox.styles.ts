...
import { FluentTheme, Theme } from '@fluentui/theme';
...
const makeStylesTokens: Theme = FluentTheme;
const renderer = createDOMRenderer();
const makeStylesOptions = { renderer, tokens: makeStylesTokens, rtl: getRTL() };
...
export const useStyles = (props: ICheckboxStyleProps) => {
  return {
    root: useRootStylesImpl(props, GlobalClassNames.root),
    checkmark: useCheckmarkStylesImpl(props, GlobalClassNames.checkmark),
    input: useInputStylesImpl(props),
    text: useTextStylesImpl(props, GlobalClassNames.text),
    checkbox: useCheckboxStylesImp(props, GlobalClassNames.checkbox),
    label: useLabelStylesImpl(props, GlobalClassNames.label),
  };
};
