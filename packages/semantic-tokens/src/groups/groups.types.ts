export type GroupTokens = {
  ...
  groupInputPaddingHorizontal: string;
  groupInputForeground: string;
  groupInputBackground: string;
  groupInputStrokewidth: string;
  groupInputCorner: string;
  groupInputGap: string;
  groupInputMinheight: string;
  groupInputFontfamily: string;
  groupInputFontsize: string;
  ...
  groupInputStrokeInvalid: string;
  ...
  groupInputFilledDarkerBackground: string;
};
