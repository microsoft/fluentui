...
import { cornerCtrlLgRestRaw, cornerCtrlRestRaw, cornerCtrlSmRestRaw, foregroundCtrlNeutralSecondaryDisabledRaw, foregroundCtrlNeutralSecondaryRestRaw, nullNumberRaw } from "../../control/variables";
...
export const ctrlSegmentedBackgroundRest = `var(${ctrlSegmentedBackgroundRestRaw}, var(${backgroundCtrlOutlineRestRaw}, ${backgroundCtrlOutlineRestRaw}))`;
export const ctrlSegmentedBackgroundHover = `var(${ctrlSegmentedBackgroundHoverRaw}, var(${backgroundCtrlOutlineHoverRaw}, ${backgroundCtrlOutlineHoverRaw}))`;
export const ctrlSegmentedBackgroundPressed = `var(${ctrlSegmentedBackgroundPressedRaw}, var(${backgroundCtrlOutlinePressedRaw}, ${backgroundCtrlOutlinePressedRaw}))`;
export const ctrlSegmentedBackgroundDisabled = `var(${ctrlSegmentedBackgroundDisabledRaw}, var(${backgroundCtrlOutlineDisabledRaw}, ${backgroundCtrlOutlineDisabledRaw}))`;
