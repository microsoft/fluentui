...
import { backgroundCtrlBrandDisabledRaw, backgroundCtrlBrandHoverRaw, backgroundCtrlBrandPressedRaw, backgroundCtrlBrandRestRaw, cornerCircularRaw, foregroundCtrlNeutralSecondaryDisabledRaw, foregroundCtrlNeutralSecondaryRestRaw, foregroundCtrlOnbrandDisabledRaw, foregroundCtrlOnbrandRestRaw, nullColorRaw, nullNumberRaw, sizeCtrlIconRaw, sizeCtrlIconsecondaryRaw, sizeCtrlLgIconRaw, sizeCtrlSmIconRaw } from "../../control/variables";
...
export const ctrlChoiceBaseBackgroundRest = `var(${ctrlChoiceBaseBackgroundRestRaw}, var(${backgroundCtrlOutlineRestRaw}, ${backgroundCtrlOutlineRestRaw}))`;
export const ctrlChoiceBaseBackgroundHover = `var(${ctrlChoiceBaseBackgroundHoverRaw}, var(${backgroundCtrlOutlineHoverRaw}, ${backgroundCtrlOutlineHoverRaw}))`;
export const ctrlChoiceBaseBackgroundPressed = `var(${ctrlChoiceBaseBackgroundPressedRaw}, var(${backgroundCtrlOutlinePressedRaw}, ${backgroundCtrlOutlinePressedRaw}))`;
export const ctrlChoiceBaseBackgroundDisabled = `var(${ctrlChoiceBaseBackgroundDisabledRaw}, var(${backgroundCtrlOutlineDisabledRaw}, ${backgroundCtrlOutlineDisabledRaw}))`;
...
export const ctrlChoiceForegroundIndeterminateHover = `var(${ctrlChoiceForegroundIndeterminateHoverRaw}, var(${foregroundCtrlOnbrandHoverRaw}, ${foregroundCtrlOnbrandHoverRaw}))`;
export const ctrlChoiceForegroundIndeterminatePressed = `var(${ctrlChoiceForegroundIndeterminatePressedRaw}, var(${foregroundCtrlOnbrandPressedRaw}, ${foregroundCtrlOnbrandPressedRaw}))`;
