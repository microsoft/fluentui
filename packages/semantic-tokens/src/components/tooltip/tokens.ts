...
export const ctrlTooltipBackground = 'var(${ctrlTooltipBackgroundRaw}, ${neutralBackground1RestRaw})';
export const ctrlTooltipForeground = 'var(${ctrlTooltipForegroundRaw}, ${neutralForeground1RestRaw})';
