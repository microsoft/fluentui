...
export const ctrlListSmIndentLevel1 = `var(${ctrlListSmIndentLevel1Raw}, var(${paddingCtrlSmHorizontal - defaultRaw}))`;
...
export const ctrlListLgIndentLevel1 = `var(${ctrlListLgIndentLevel1Raw}, var(${paddingCtrlLgHorizontal - defaultRaw}))`;
