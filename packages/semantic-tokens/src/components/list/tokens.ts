...
export const ctrlListIndentLevel1 = 'var(${ctrlListIndentLevel1Raw}, ${paddingCtrlHorizontal-defaultRaw})';
...
export const ctrlListSmCornerRest = 'var(${ctrlListSmCornerRestRaw}, var(${cornerCtrl-smRestRaw}, ${mediumRaw}))';
export const ctrlListSmCornerHover = 'var(${ctrlListSmCornerHoverRaw}, var(${cornerCtrl-smRestRaw}, ${mediumRaw}))';
export const ctrlListSmCornerPressed = 'var(${ctrlListSmCornerPressedRaw}, var(${cornerCtrl-smRestRaw}, ${mediumRaw}))';
export const ctrlListSmIndentLevel1 = 'var(${ctrlListSmIndentLevel1Raw}, ${paddingCtrl-smHorizontal-defaultRaw})';
...
export const ctrlListLgCornerRest = 'var(${ctrlListLgCornerRestRaw}, var(${cornerCtrl-lgRestRaw}, ${mediumRaw}))';
export const ctrlListLgCornerHover = 'var(${ctrlListLgCornerHoverRaw}, var(${cornerCtrl-lgRestRaw}, ${mediumRaw}))';
export const ctrlListLgCornerPressed = 'var(${ctrlListLgCornerPressedRaw}, var(${cornerCtrl-lgRestRaw}, ${mediumRaw}))';
export const ctrlListLgIndentLevel1 = 'var(${ctrlListLgIndentLevel1Raw}, ${paddingCtrl-lgHorizontal-defaultRaw})';
