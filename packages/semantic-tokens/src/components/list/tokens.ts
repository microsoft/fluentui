...
export const ctrlListChoiceForegroundHover = `var(${ctrlListChoiceForegroundHoverRaw}, var(${foregroundCtrlHintDefaultRaw}, ${foregroundCtrlHintDefaultRaw}))`;
