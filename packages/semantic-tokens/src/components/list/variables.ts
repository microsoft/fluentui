...
export const ctrlListChoiceCheckboxIconSizeFigmaOnlyRaw = '--smtc-ctrl-list-choice-checkbox-icon-size (figma only)';
export const ctrlListChoiceDotSizeRaw = '--smtc-ctrl-list-choice-dot-size';
export const ctrlListChoiceDotSizeFigmaOnlyRaw = '--smtc-ctrl-list-choice-dot-size (figma only)';
