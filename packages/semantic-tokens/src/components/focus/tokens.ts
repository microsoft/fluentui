...
import { ctrlFocusInnerStrokeRaw, ctrlFocusInnerStrokewidthRaw, ctrlFocusOuterStrokeRaw, ctrlFocusOuterStrokewidthRaw, ctrlFocusPositionFigmaOnlyRaw } from "./variables";
