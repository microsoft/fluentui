...
export const ctrlDialogBaseCorner = `var(${ctrlDialogBaseCornerRaw}, var(var(${cornerCardRestRaw}), ${x-largeRaw}))`;
...
export const ctrlDialogLayerBackground = `var(${ctrlDialogLayerBackgroundRaw}, var(${backgroundLayerPrimary (solid)Raw}, ${tokens.colorNeutralBackground1}))`;
