...
export const shadowCtrlOndragKeyY = `var(${shadowCtrlOndragKeyYRaw}, var(${shadowFlyoutKeyYRaw}))`;
export const shadowCtrlOndragKeyX = `var(${shadowCtrlOndragKeyXRaw}, var(${shadowFlyoutKeyXRaw}))`;
export const shadowCtrlOndragKeyBlur = `var(${shadowCtrlOndragKeyBlurRaw}, var(${shadowFlyoutKeyBlurRaw}))`;
export const shadowCtrlOndragKeyColor = `var(${shadowCtrlOndragKeyColorRaw}, var(${shadowFlyoutKeyColorRaw}))`;
export const shadowCtrlOndragAmbientY = `var(${shadowCtrlOndragAmbientYRaw}, var(${shadowFlyoutAmbientYRaw}))`;
export const shadowCtrlOndragAmbientX = `var(${shadowCtrlOndragAmbientXRaw}, var(${shadowFlyoutAmbientXRaw}))`;
export const shadowCtrlOndragAmbientBlur = `var(${shadowCtrlOndragAmbientBlurRaw}, var(${shadowFlyoutAmbientBlurRaw}))`;
export const shadowCtrlOndragAmbientColor = `var(${shadowCtrlOndragAmbientColorRaw}, var(${shadowFlyoutAmbientColorRaw}))`;
...
export const shadowWindowInactiveKeyX = `var(${shadowWindowInactiveKeyXRaw}, var(${shadowWindowActiveKeyXRaw}))`;
export const shadowWindowInactiveKeyY = `var(${shadowWindowInactiveKeyYRaw}, var(${shadowWindowActiveKeyYRaw}))`;
export const shadowWindowInactiveKeyBlur = `var(${shadowWindowInactiveKeyBlurRaw}, var(${shadowWindowActiveKeyBlurRaw}))`;
export const shadowWindowInactiveKeyColor = `var(${shadowWindowInactiveKeyColorRaw}, var(${shadowWindowActiveKeyColorRaw}))`;
