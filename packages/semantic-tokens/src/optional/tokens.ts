...
export const strokeCtrlOnbrandRestStop2 = `var(${strokeCtrlOnbrandRestStop2Raw}, var(${strokeCtrlOnbrandRestRaw}, transparent))`;
export const strokeCtrlOnbrandHoverStop2 = `var(${strokeCtrlOnbrandHoverStop2Raw}, var(${strokeCtrlOnbrandHoverRaw}, transparent))`;
export const strokeCtrlOnbrandPressedStop2 = `var(${strokeCtrlOnbrandPressedStop2Raw}, var(${strokeCtrlOnbrandPressedRaw}, transparent))`;
export const strokeCtrlOnbrandDisabledStop2 = `var(${strokeCtrlOnbrandDisabledStop2Raw}, var(${strokeCtrlOnbrandDisabledRaw}, ${colorNeutralStrokeDisabled}))`;
...
export const strokeCtrlOnoutlineHoverStop2 = `var(${strokeCtrlOnoutlineHoverStop2Raw}, var(${strokeCtrlOnoutlineHoverRaw}, ${colorTransparentStroke}))`;
export const strokeCtrlOnoutlinePressedStop2 = `var(${strokeCtrlOnoutlinePressedStop2Raw}, var(${strokeCtrlOnoutlinePressedRaw}, ${colorTransparentStroke}))`;
