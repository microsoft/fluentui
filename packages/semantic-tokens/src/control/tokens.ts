...
export const paddingCtrlTextside = `var(${paddingCtrlTextsideRaw}, ${spacingHorizontalM})`;
...
export const gapInsideCtrlTosecondaryicon = `var(${gapInsideCtrlTosecondaryiconRaw}, ${spacingHorizontalSNudge})`;
...
export const cornerCtrlSmRest = `var(${cornerCtrlSmRestRaw}, ${borderRadiusSmall})`;
export const cornerCtrlLgRest = `var(${cornerCtrlLgRestRaw}, ${borderRadiusLarge})`;
