...
export const shadowCardRestKeyX = `var(${shadowCardRestKeyXRaw}, unset)`;
export const shadowCardRestKeyY = `var(${shadowCardRestKeyYRaw}, unset)`;
export const shadowCardRestKeyBlur = `var(${shadowCardRestKeyBlurRaw}, unset)`;
export const shadowCardRestKeyColor = `var(${shadowCardRestKeyColorRaw}, unset)`;
export const shadowCardHoverKeyX = `var(${shadowCardHoverKeyXRaw}, unset)`;
export const shadowCardHoverKeyY = `var(${shadowCardHoverKeyYRaw}, unset)`;
export const shadowCardHoverKeyBlur = `var(${shadowCardHoverKeyBlurRaw}, unset)`;
export const shadowCardHoverKeyColor = `var(${shadowCardHoverKeyColorRaw}, unset)`;
export const shadowCardPressedKeyX = `var(${shadowCardPressedKeyXRaw}, unset)`;
export const shadowCardPressedKeyY = `var(${shadowCardPressedKeyYRaw}, unset)`;
export const shadowCardPressedKeyBlur = `var(${shadowCardPressedKeyBlurRaw}, unset)`;
export const shadowCardPressedKeyColor = `var(${shadowCardPressedKeyColorRaw}, unset)`;
export const shadowCardDisabledKeyX = `var(${shadowCardDisabledKeyXRaw}, unset)`;
export const shadowCardDisabledKeyY = `var(${shadowCardDisabledKeyYRaw}, unset)`;
export const shadowCardDisabledKeyBlur = `var(${shadowCardDisabledKeyBlurRaw}, unset)`;
export const shadowCardDisabledKeyColor = `var(${shadowCardDisabledKeyColorRaw}, unset)`;
export const shadowCardRestAmbientX = `var(${shadowCardRestAmbientXRaw}, unset)`;
export const shadowCardRestAmbientY = `var(${shadowCardRestAmbientYRaw}, unset)`;
export const shadowCardRestAmbientBlur = `var(${shadowCardRestAmbientBlurRaw}, unset)`;
export const shadowCardRestAmbientColor = `var(${shadowCardRestAmbientColorRaw}, unset)`;
export const shadowLayerKeyX = `var(${shadowLayerKeyXRaw}, unset)`;
export const shadowLayerKeyY = `var(${shadowLayerKeyYRaw}, unset)`;
export const shadowLayerKeyBlur = `var(${shadowLayerKeyBlurRaw}, unset)`;
export const shadowLayerKeyColor = `var(${shadowLayerKeyColorRaw}, unset)`;
export const shadowLayerAmbientX = `var(${shadowLayerAmbientXRaw}, unset)`;
export const shadowLayerAmbientY = `var(${shadowLayerAmbientYRaw}, unset)`;
export const shadowLayerAmbientBlur = `var(${shadowLayerAmbientBlurRaw}, unset)`;
export const shadowLayerAmbientColor = `var(${shadowLayerAmbientColorRaw}, unset)`;
