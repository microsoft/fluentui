...
export const fluentOverrides: FluentOverrides = {
  ...
  ctrlChoiceBaseBackgroundHover: { f2Token: 'colorTransparentBackgroundHover' },
  ...
  ctrlChoiceSwitchPaddingHover: { rawValue: '2px' },
  ctrlChoiceSwitchPaddingPressed: { rawValue: '2px' },
  ctrlChoiceSwitchPaddingRest: { rawValue: '2px' },
