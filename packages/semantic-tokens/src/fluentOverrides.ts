...
export const fluentOverrides: FluentOverrides = {
  ...
  statusDangerTintBackground: { f2Token: 'colorPaletteRedBackground1' },
  statusDangerTintForeground: { f2Token: 'colorPaletteRedForeground3' },
  statusDangerTintStroke: { f2Token: 'colorPaletteRedBorder1' },
  ...
  statusImportantTintBackground: { f2Token: 'colorNeutralForeground3' },
  ...
  statusInformativeTintStroke: { f2Token: 'colorNeutralStroke2' },
  ...
  statusSuccessTintBackground: { f2Token: 'colorPaletteGreenBackground1' },
  statusSuccessTintForeground: { f2Token: 'colorPaletteGreenForeground3' },
  statusSuccessTintStroke: { f2Token: 'colorPaletteGreenBorder1' },
  statusWarningBackground: { f2Token: 'colorPaletteYellowBackground3' },
  statusWarningForeground: { f2Token: 'colorNeutralForeground1Static' },
  statusWarningTintBackground: { f2Token: 'colorPaletteYellowBackground1' },
  statusWarningTintForeground: { f2Token: 'colorPaletteYellowForeground2' },
  statusWarningTintStroke: { f2Token: 'colorPaletteYellowBorder1' },
