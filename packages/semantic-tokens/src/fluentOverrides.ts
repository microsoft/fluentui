...
export const fluentOverrides: FluentOverrides = {
  ...
  statusSuccessTintForeground: { f2Token: 'colorPaletteGreenForeground1'},
  statusWarningBackground: { f2Token: 'colorPaletteDarkOrangeBackground3' },
  statusWarningTintForeground: { f2Token: 'colorPaletteDarkOrangeForeground1' },
  ...
  textRampMetadataFontSize: { f2Token: 'fontSizeBase200' },
