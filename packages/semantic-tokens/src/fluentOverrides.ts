...
export const fluentOverrides: FluentOverrides = {
  ...
  ctrlDialogBaseShadowAmbient: { rawValue: 'rgba(0, 0, 0, 0.14) 0px 32px 64px 0px' },
  ctrlDialogBaseShadowKey: { rawValue: 'rgba(0, 0, 0, 0.12) 0px 0px 8px 0px' },
  ...
  paddingContentLarge: { rawValue: '24px' },
