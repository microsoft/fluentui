...
import { DayOfWeek, FirstWeekOfYear, DateRangeType } from '@uifabric/date-time-utilities/lib/dateValues/DateValues';
...
import { addMonths, addYears } from '@uifabric/date-time-utilities/lib/dateMath/DateMath';
