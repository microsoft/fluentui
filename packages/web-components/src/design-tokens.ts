...
export const baseHeightMultiplier = create<number>('base-height-multiplier').withDefault(10);
export const baseHorizontalSpacingMultiplier = create<number>('base-horizontal-spacing-multiplier').withDefault(3);
export const baseLayerLuminance = create<number>('base-layer-luminance').withDefault(StandardLuminance.DarkMode);
