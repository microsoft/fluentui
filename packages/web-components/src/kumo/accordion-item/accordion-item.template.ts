...
export function accordionItemTemplate<T extends BaseAccordionItem>(): ElementViewTemplate<T> {
  return html<T>`
    <div class="heading" part="heading" role="heading" aria-level="${x => x.headinglevel}">
      ...
      ${chevronDown20Filled} ${chevronRight20Filled}
    </div>
 ...
 * @public
 */
export const template: ElementViewTemplate<BaseAccordionItem> = accordionItemTemplate();
