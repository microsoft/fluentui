 ...
 * @attr open - Defines whether the menu is open or not.
 *
 * @csspart positioning-container - The positioning container of the menu.
 *
 * @cssproperty --z-index-menu - The z-index of the menu.
 *
 ...
 * @method openChanged - Called whenever the open state changes.
 ...
 * @method setPositioningTask - The task to set the positioning of the menu.
 * @method setPositioning - Sets the positioning of the menu.
 * @method addListeners - Adds event listeners.
 * @method removeListeners - Removes event listeners.
 * @method handleMenuKeydown - Handles keyboard interaction for the menu.
 * @method handleTriggerKeydown - Handles keyboard interaction for the trigger.
 * @method handleDocumentClick - Handles document click events to close the menu when a click occurs outside of the menu or the trigger.
 *
