...
import { type SliderConfiguration, SliderMode, SliderOrientation } from './slider.options.js';
 ...
 * @public
 */
export class BaseSlider extends FASTElement implements SliderConfiguration {
  /**
