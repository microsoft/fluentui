...
- Smaller bundle size (-29% compressed!)
...
- Form controls now use field wrapper to handle label spacing and errors
...
<tr>
  ...
  <td> ✅ </td>
  <td> ⚠️ </td>
  <td> ⛔️ Renamed → See `link`, `anchor-button` </td>
</tr>
<tr>
  <td> anchor-button </td>
  <td> </td>
...
<tr>
  ...
  <td> ✅ </td>
  <td> ✅ </td>
  <td> ⚠️ API Change → Split into two components to allow for more expressive modals. </td>
</tr>
<tr>
  <td> dialog-body </td>
  <td> </td>
...
<tr>
  ...
  <td> ✅ </td>
  <td> 🔀 </td>
  <td> ⛔️ Renamed → See `progress-bar` </td>
</tr>
<tr>
  <td> progress-bar </td>
  <td> </td>
...
<tr>
  ...
  <td> ✅ </td>
  <td> ⚠️ </td>
  <td> ⛔️ Deprecated → See `label`, `field` </td>
</tr>
<tr>
  <td> spinner </td>
  <td> </td>
...
<tr>
  ...
  <td> ✅ </td>
  <td> ⚠️ </td>
  <td> ⛔️ Deprecated → See `tablist` </td>
</tr>
<tr>
  <td> tab-panel </td>
  <td> ✅ </td>
...
<tr>
  ...
  <td> ✅ </td>
  <td> 🔀 </td>
  <td> ⛔️ Renamed→ See text-input </td>
</tr>
<tr>
  <td> text-input </td>
  <td> </td>
...
<tr>
  ...
  <td> ✅ </td>
  <td> ✅ </td>
  <td> ⚠️ API is different from React implementation </td>
</tr>
<tr>
  <td> tree-item </td>
  <td> ✅ </td>
