...
- **`web-components.js`** / **`web-components.min.js`** — Registers all components and exposes `setTheme` on `globalThis`. This is the recommended bundle for most CDN and script-tag consumers.
