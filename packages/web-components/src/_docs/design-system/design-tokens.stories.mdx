...
The FAST Design Token implementation for Fluent Web Components is designed to provide first-class support for Design Tokens and make setting, getting, and using Design Tokens simple.
