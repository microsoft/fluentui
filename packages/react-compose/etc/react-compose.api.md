...
// @public
export const createClassResolver: (classes: Record<string, string>) => (state: Record<string, any>, partialClasses?: Record<string, string> | undefined) => Record<string, string>;
