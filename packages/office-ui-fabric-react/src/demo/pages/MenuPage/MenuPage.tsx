...
const MenuBasicExampleCode = require('./examples/Menu.Basic.Example.tsx');

export class MenuPage extends React.Component<IComponentDemoPageProps, any> {
  private _url: string;
  ...
  public render() {
    return (
      <ComponentPage
        title='Menu'
        componentName='MenuBarExample'
        exampleCards={
          <ExampleCard
            title='Menus'
            code={ MenuBasicExampleCode }>
            <MenuBasicExample />
          </ExampleCard>
        }
        propertiesTables={
