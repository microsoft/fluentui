...
export class SpinButtonBase extends BaseComponent<ISpinButtonProps, ISpinButtonState> implements ISpinButton {
  ...
  */
  ...
  public render() {
    ...
    const upArrowButtonStyles = getUpArrowButtonStyles ? getUpArrowButtonStyles(
      {
        theme: this.props.theme!,
        upArrowButtonStyles: customUpArrowButtonStyles
      }
    ...
    const downArrowButtonStyles = getDownArrowButtonStyles ? getDownArrowButtonStyles(
      {
        theme: this.props.theme!,
        downArrowButtonStyles: customDownArrowButtonStyles
      },
