  ...
  public render(): JSX.Element {
    return (
      <ComponentPage
        ...
        exampleCards={
          <div>
            <ExampleCard title={'Basic SpinButton'} code={SpinButtonBasicExampleCode}>
              <SpinButtonBasicExample />
            </ExampleCard>
            <ExampleCard title={'Basic Disabled SpinButton'} code={SpinButtonBasicDisabledExampleCode}>
              <SpinButtonBasicDisabledExample />
            </ExampleCard>
            <ExampleCard title={'Stateful SpinButton'} code={SpinButtonStatefulExampleCode}>
        ...
        componentStatus={<ComponentStatus {...SpinButtonStatus} />}
      />
    );
  }
}
