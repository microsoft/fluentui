...
const SpinButtonBasicExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/components/SpinButton/SpinButton.Basic.Example.Codepen.txt') as string;
