...
import { IChicletPreviewProps, IChicletPreviewImage } from './Chiclet.types';
...
export class ChicletPreview extends BaseComponent<IChicletPreviewProps, any> {
  public render() {
  ...
  private _renderPreviewImage(previewImage: IChicletPreviewImage): React.ReactElement<React.HTMLAttributes<HTMLDivElement>> {
  ...
  private _renderPreviewList = (previewImages: IChicletPreviewImage[]): React.ReactElement<React.HTMLAttributes<HTMLDivElement>> => {
