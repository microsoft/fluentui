...
export interface IButtonProps extends React.HTMLProps<HTMLButtonElement | HTMLAnchorElement | ButtonBase> {
  /**
   ...
   */
  onClick?: React.MouseEventHandler<HTMLButtonElement | HTMLAnchorElement | ButtonBase>;
