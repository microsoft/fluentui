    ...
    return (
      <div className={css(classNames.example, classNames.twoup)}>
        <div>
          ...
          <CompoundButton description="You can create a new account here." disabled={disabled} checked={checked}>
            Create account
          </CompoundButton>
        </div>
        <div>
          <Label>Primary</Label>
          <CompoundButton primary={true} description="You can create a new account here." disabled={disabled} checked={checked}>
            Create account
          </CompoundButton>
        </div>
      </div>
