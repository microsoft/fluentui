...
const ImageDefaultExampleCode = require('!raw-loader!./examples/Image.Default.Example') as string;
const ImageCenterExampleCode = require('!raw-loader!./examples/Image.Center.Example') as string;
const ImageContainExampleCode = require('!raw-loader!./examples/Image.Contain.Example') as string;
const ImageCoverExampleCode = require('!raw-loader!./examples/Image.Cover.Example') as string;
const ImageNoneExampleCode = require('!raw-loader!./examples/Image.None.Example') as string;
const ImageMaximizeFrameExampleCode = require('!raw-loader!./examples/Image.MaximizeFrame.Example') as string;
