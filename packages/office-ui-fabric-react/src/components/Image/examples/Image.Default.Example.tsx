  ...
  public render() {
    return (
      <div>
        ...
        <Image src='http://placehold.it/350x150' alt='no height or width image fit example' />
        <br />
        ...
        <Image src='http://placehold.it/350x150' alt='width only image fit example' width={ 600 } />
        <br />
        ...
        <Image src='http://placehold.it/350x150' alt='height only image fit example' height={ 100 } />
        <br />
        ...
        <Image src='http://placehold.it/350x150' alt='width and height image fit example' width={ 100 } height={ 100 } />
      </div>
    );
  }
}