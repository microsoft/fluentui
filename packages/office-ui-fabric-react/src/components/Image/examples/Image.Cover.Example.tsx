  ...
  public render() {
    ...
    return (
      <div>
        ...
        <Image { ...imageProps as any } alt='wider image fit cover example' width={ 150 } height={ 250 } />
        <br />
        ...
        <Image { ...imageProps as any } alt='taller image fit cover example' width={ 250 } height={ 150 } />
      </div>
    );
  }
}