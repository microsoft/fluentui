  ...
  public render() {
    ...
    return (
      <div>
        ...
        <Image  { ...imageProps as any } src='http://placehold.it/800x300' alt='larger image fit center example' />
        <br />
        ...
        <Image  { ...imageProps as any } src='http://placehold.it/100x100' alt='smaller image fit center example' />
      </div>
    );
  }
}