  ...
  public render() {
    ...
    return (
      <div>
        ...
        <Image { ...imageProps as any } alt='wider image fit contain example' width={ 200 } height={ 200 } />
        <br />
        ...
        <Image { ...imageProps as any } alt='taller image fit contain example' width={ 300 } height={ 50 } />
      </div>
    );
  }
}