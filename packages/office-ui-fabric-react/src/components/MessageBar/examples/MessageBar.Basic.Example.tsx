...
export const MessageBarBasicExample = () => (
  <div className='ms-BasicMessageBarsExample'>
    ...
    <MessageBar
      ...
      actions={ <div><DefaultButton>Yes</DefaultButton><DefaultButton>No</DefaultButton></div> }>SevereWarning - lorem ipsum dolor sit amet, a elit sem interdum consectetur adipiscing elit.</MessageBar>
