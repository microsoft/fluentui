...
describe('MessageBar', () => {
  ...
  it('renders custom message bar icon correctly', () => {
    const wrapper = mount(<MessageBar messageBarType={MessageBarType.success} messageBarIcon={'AddFriend'} />);
  ...
  describe('dismiss', () => {
    describe('single-line', () => {
      ...
      it('has custom dismiss icon', () => {
        const wrapper = mount(<MessageBar onDismiss={noop} isMultiline={false} dismissIcon={'AddFriend'} />);
        const dismissIcon = wrapper.find('[data-icon-name="AddFriend"]');
        expect(dismissIcon.exists()).toBe(true);
      });
