...
const MessageBarBasicExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/components/MessageBar/MessageBar.Basic.Example.Codepen.txt') as string;
