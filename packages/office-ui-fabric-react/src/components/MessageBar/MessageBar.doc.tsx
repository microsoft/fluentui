...
const MessageBarBasicExampleCode = require('!raw-loader!office-ui-fabric-react/lib/components/MessageBar/examples/MessageBar.Basic.Example.tsx') as string;
...
export const MessageBarPageProps: IDocPageProps = {
  ...
  propertiesTablesSources: [require<string>('!raw-loader!office-ui-fabric-react/lib/components/MessageBar/MessageBar.types.ts')],
