...
const SearchBoxFullSizeExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/components/SearchBox/SearchBox.FullSize.Example.Codepen.txt') as string;
