...
const ActivityItemOverview = require<string>('raw-loader!./ActivityItemOverview.md');
const ActivityItemDos = require<string>('raw-loader!./ActivityItemDos.md');
const ActivityItemDonts = require<string>('!raw-loader!./ActivityItemDonts.md');
