...
const DatePickerBasicExampleCode = require('!raw-loader!./examples/DatePicker.Basic.Example') as string;
const DatePickerRequiredExampleCode = require('!raw-loader!./examples/DatePicker.Required.Example') as string;
const DatePickerInputExampleCode = require('!raw-loader!./examples/DatePicker.Input.Example') as string;
