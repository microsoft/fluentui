...
const DatePickerBasicExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/components/DatePicker/DatePicker.Basic.Example.Codepen.txt') as string;
