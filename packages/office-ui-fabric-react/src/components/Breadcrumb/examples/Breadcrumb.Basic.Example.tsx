...
const items: IBreadcrumbItem[] = [
  ...
  { text: 'Folder 4', key: 'f1', onClick: _onBreadcrumbItemClicked },
  { text: 'Folder 5', key: 'f2', onClick: _onBreadcrumbItemClicked },
  { text: 'Folder 6', key: 'f3', onClick: _onBreadcrumbItemClicked },
  { text: 'Folder 7', key: 'f1', onClick: _onBreadcrumbItemClicked },
  { text: 'Folder 8', key: 'f2', onClick: _onBreadcrumbItemClicked },
  { text: 'Folder 9', key: 'f3', onClick: _onBreadcrumbItemClicked },
  { text: 'Folder 10', key: 'f1', onClick: _onBreadcrumbItemClicked },
  { text: 'Folder 11', key: 'f2', onClick: _onBreadcrumbItemClicked },
  { text: 'Folder 12', key: 'f3', onClick: _onBreadcrumbItemClicked },
  { text: 'Folder 13', key: 'f1', onClick: _onBreadcrumbItemClicked },
  { text: 'Folder 14', key: 'f2', onClick: _onBreadcrumbItemClicked },
  { text: 'Folder 15', key: 'f3', onClick: _onBreadcrumbItemClicked },
  { text: 'Folder 16', key: 'f3', onClick: _onBreadcrumbItemClicked },
  { text: 'Folder 17', key: 'f3', onClick: _onBreadcrumbItemClicked },
  { text: 'Folder 18', key: 'f3', onClick: _onBreadcrumbItemClicked },
  { text: 'Folder 19', key: 'f3', onClick: _onBreadcrumbItemClicked },
  { text: 'Folder 20', key: 'f3', onClick: _onBreadcrumbItemClicked },
  { text: 'Folder 21', key: 'f3', onClick: _onBreadcrumbItemClicked },
  { text: 'Folder 22', key: 'f3', onClick: _onBreadcrumbItemClicked },
  { text: 'Folder 23', key: 'f3', onClick: _onBreadcrumbItemClicked },
  { text: 'Folder 24 (non-clickable)', key: 'f4' },
  { text: 'Folder 25', key: 'f5', onClick: _onBreadcrumbItemClicked, isCurrentItem: true },
];
