...
describe('Breadcrumb', () => {
  ...
  it('can call the callback when an item is clicked', () => {
    ...
    const component = ReactTestUtils.renderIntoDocument<Breadcrumb>(<Breadcrumb items={items} />);
  ...
  it('moves items to overflow in the correct order', () => {
    ...
    const component = ReactTestUtils.renderIntoDocument<Breadcrumb>(<Breadcrumb items={items} maxDisplayedItems={2} />);
