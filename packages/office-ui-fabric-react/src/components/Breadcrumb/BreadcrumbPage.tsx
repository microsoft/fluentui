  ...
  public render(): JSX.Element {
    return (
      <ComponentPage
        ...
        exampleCards={
          <div>
            <ExampleCard title="Default Breadcrumb" code={BreadcrumbBasicExampleCode}>
              <BreadcrumbBasicExample />
            </ExampleCard>
            <ExampleCard title="Breadcrumb with static width " code={BreadcrumbStaticExampleCode}>
        ...
        propertiesTables={
          <PropertiesTableSet
            sources={[require<string>('!raw-loader!office-ui-fabric-react/src/components/Breadcrumb/Breadcrumb.types.ts')]}
          />
        }
        overview={
          <PageMarkdown>
        ...
        componentStatus={<ComponentStatus {...BreadcrumbStatus} />}
      />
    );
  }
}
