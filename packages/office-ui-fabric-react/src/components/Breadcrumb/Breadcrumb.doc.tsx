...
const BreadcrumbStaticExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/components/Breadcrumb/Breadcrumb.Static.Example.Codepen.txt') as string;
