...
const BreadcrumbBasicExampleCode = require('!raw-loader!office-ui-fabric-react/lib/components/Breadcrumb/examples/Breadcrumb.Basic.Example.tsx') as string;
const BreadcrumbStaticExampleCode = require('!raw-loader!office-ui-fabric-react/lib/components/Breadcrumb/examples/Breadcrumb.Static.Example.tsx') as string;
...
export const BreadcrumbPageProps: IDocPageProps = {
  ...
  propertiesTablesSources: [require<string>('!raw-loader!office-ui-fabric-react/lib/components/Breadcrumb/Breadcrumb.types.ts')],
