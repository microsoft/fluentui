...
Note: although onRenderCell is an optional member of IListProps, if you opt not to use an onRender() method, you need to format your IList's props items member using the following format: {[name: *insert data here*]}.
