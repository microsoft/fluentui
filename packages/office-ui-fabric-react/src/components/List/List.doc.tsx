...
const ListBasicExampleCode = require('!raw-loader!office-ui-fabric-react/lib/components/List/examples/List.Basic.Example.tsx') as string;
const ListGridExampleCode = require('!raw-loader!office-ui-fabric-react/lib/components/List/examples/List.Grid.Example.tsx') as string;
const ListScrollingExampleCode = require('!raw-loader!office-ui-fabric-react/lib/components/List/examples/List.Scrolling.Example.tsx') as string;
const ListGhostingExampleCode = require('!raw-loader!office-ui-fabric-react/lib/components/List/examples/List.Ghosting.Example.tsx') as string;
...
export const ListPageProps: IDocPageProps = {
  ...
  propertiesTablesSources: [require<string>('!raw-loader!office-ui-fabric-react/lib/components/List/List.types.ts')],
  overview: require<string>('!raw-loader!office-ui-fabric-react/lib/components/List/docs/ListOverview.md'),
