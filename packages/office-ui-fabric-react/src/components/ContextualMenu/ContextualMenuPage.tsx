...
const ContextualMenuBasicExampleCode = require('!raw-loader!./examples/ContextualMenu.Basic.Example') as string;
const ContextualMenuCheckmarksExampleCode = require('!raw-loader!./examples/ContextualMenu.Checkmarks.Example') as string;
const ContextualMenuDirectionalExampleCode = require('!raw-loader!./examples/ContextualMenu.Directional.Example') as string;
const ContextualMenuCustomizationExampleCode = require('!raw-loader!./examples/ContextualMenu.Customization.Example') as string;
const ContextualMenuHeaderExampleCode = require('!raw-loader!./examples/ContextualMenu.Header.Example') as string;
