...
export class ContextualMenuBase extends BaseComponent<IContextualMenuProps, IContextualMenuState> {
  ...
  public componentDidUpdate(prevProps: IContextualMenuProps) {
    // If menu was closed, run onAfterMenuDismiss
    if (this.props.onAfterMenuDismiss && !prevProps.hidden && this.props.hidden) {
    ...
    if (items && items.length > 0) {
      ...
      return (
        <Callout
          ...
          skipPopupUpdate={this.props.skipPopupUpdate}
        >
          <div
            role={'menu'}
    ...
    const elementToFocus =
      ev.altKey || ev.metaKey
        ...
        : ev.which === KeyCodes.up
          ...
          : ev.which === KeyCodes.down ? getFirstFocusable(this._host, this._host.firstChild as HTMLElement, true) : null;
