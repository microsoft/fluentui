...
import { getStyles, getMenuItemStyles } from "./ContextualMenu.styles";
import {
  IMenuItemClassNames,
...
> {
  ...
  public render(): JSX.Element | null {
    ...
    let menuClassNames = this.props.getMenuClassNames
      ? this.props.getMenuClassNames
      : getContextualMenuClassNames;
  ...
  private _renderMenuItem(
    ...
    let subMenuIconClassName = item.submenuIconProps
      ...
      : "";
    let getClassNames = item.getItemClassNames
      ? item.getItemClassNames
      : getItemClassNames;
  ...
  private _renderButtonItem(
    ...
    const itemButtonProperties = {
      ...
      onKeyDown: hasSubmenuItems(item)
        ? this._onItemKeyDown.bind(this, item)
        : null,
