...
import { ITheme, mergeStyleSets, getFocusStyle, HighContrastSelector } from '../../Styling';
...
export const getClassNames = memoizeFunction(
  (theme: ITheme, styles: IToggleStyles, className: string, disabled: boolean, checked: boolean): IToggleClassNames => {
