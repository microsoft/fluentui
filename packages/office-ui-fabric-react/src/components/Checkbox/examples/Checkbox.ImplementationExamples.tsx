  ...
  public render(): JSX.Element {
    ...
    return (
      <div>
        ...
        <Checkbox label="Disabled uncontrolled checkbox" disabled={true} styles={styles} />
        ...
        <Checkbox label="Controlled checkbox" checked={isChecked} onChange={this._onControlledCheckboxChange} styles={styles} />

        <Checkbox label="Checkbox rendered with boxSide &quot;end&quot;" boxSide="end" styles={styles} />

        <Checkbox label="Persona Checkbox" styles={styles} onRenderLabel={this._renderPersonaLabel} />
      </div>
    );
  }
