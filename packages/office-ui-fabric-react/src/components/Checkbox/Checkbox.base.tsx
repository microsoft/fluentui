...
export class CheckboxBase extends BaseComponent<ICheckboxProps, ICheckboxState> implements ICheckboxProps {
  ...
  private _id: string;
  private _classNames: IClassNames<ICheckboxStyles>;
