...
// export const AnnouncedLazyLoadingExample: React.FunctionComponent = () => {
//   const [loading, { toggle: toggleLoading }] = useBoolean(false);
//   const [announced, setAnnounced] = React.useState(undefined);
//   const [total, setTotal] = React.useState(0);
//   const [timeSinceLastAnnounce, setTimeSinceLastAnnounce] = React.useState(0);
...
//         onClick={loading ? pauseLoading : tartLoading}
