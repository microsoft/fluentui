...
export class Sticky extends BaseComponent<IStickyProps, IStickyState> {
  ...
  public render(): JSX.Element {
    ...
    return (
      <div ref={this._root}>
        {this.canStickyTop && this._getStickyContent(StickyPositionType.Header, isStickyTop)}
        {this.canStickyBottom && this._getStickyContent(StickyPositionType.Footer, isStickyBottom)}
  ...
  public addSticky(stickyContent: HTMLDivElement): void {
    const placeholderUsedForStickyContent = this.context.scrollablePane.usePlaceholderForSticky();
  ...
  public resetSticky(): void {
    const placeholderUsedForContent = this.context.scrollablePane.usePlaceholderForSticky();
  ...
  private _getContentStyles(isSticky: boolean): React.CSSProperties {
    ...
    const isVisible = isSticky
      ? this._usePlaceholderForSticky(this.canStickyTop) || this._usePlaceholderForSticky(this.canStickyBottom)
      : true;
    return {
  ...
  private _getStickyContent(stickyPositionType: StickyPositionType, isSticky: boolean): JSX.Element {
    ...
    const usePlaceholderForStickyContent = scrollablePane.usePlaceholderForSticky();
    return (
      <div
  ...
  private _isOffsetHeightDifferent(): boolean {
    ...
    const usePlaceholderForStickyContentTop = this._usePlaceholderForSticky(this.canStickyTop);
    const usePlaceholderForStickyContentBottom = this._usePlaceholderForSticky(this.canStickyBottom);
    return (
  ...
  private _getNonStickyPlaceholderHeightAndWidth(): React.CSSProperties {
    const { isStickyTop, isStickyBottom } = this.state;
    const usePlaceholderForStickyTop = this._usePlaceholderForSticky(this.canStickyTop);
    const usePlaceholderForStickyBottom = this._usePlaceholderForSticky(this.canStickyBottom);
  ...
  private _usePlaceholderForSticky(canSticky: boolean): boolean {
    return canSticky && this.context.scrollablePane.usePlaceholderForSticky();
  }
