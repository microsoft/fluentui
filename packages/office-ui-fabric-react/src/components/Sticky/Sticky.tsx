...
import { PlaceholderPosition, StickyContainerBehaviorType } from '../ScrollablePane/ScrollablePane.types';
...
export class Sticky extends BaseComponent<IStickyProps, IStickyState> {
  ...
  public addSticky(stickyContent: HTMLDivElement, placeholderPosition: PlaceholderPosition): void {
    ...
    const placeholderUsedForStickyContent = scrollablePane.usePlaceholderForSticky(placeholderPosition);
  ...
  public resetSticky(): void {
    ...
    const placeholderUsedForContent = scrollablePane.usePlaceholderForSticky(this.canStickyTop ? 'top' : 'bottom');
  ...
  private _getNonStickyPlaceholderHeightAndWidth(): React.CSSProperties {
    ...
    const usePlaceholderForStickyTop = this.canStickyTop && scrollablePane.usePlaceholderForSticky('top');
    const usePlaceholderForStickyBottom = this.canStickyBottom && scrollablePane.usePlaceholderForSticky('bottom');
