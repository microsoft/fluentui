...
const ChoiceGroupBasicExampleCode = require('!raw-loader!office-ui-fabric-react/lib/components/ChoiceGroup/examples/ChoiceGroup.Basic.Example.tsx') as string;
...
const ChoiceGroupLabelExampleCode = require('!raw-loader!office-ui-fabric-react/lib/components/ChoiceGroup/examples/ChoiceGroup.Label.Example.tsx') as string;
...
const ChoiceGroupCustomExampleCode = require('!raw-loader!office-ui-fabric-react/lib/components/ChoiceGroup/examples/ChoiceGroup.Custom.Example.tsx') as string;
const ChoiceGroupImageExampleCode = require('!raw-loader!office-ui-fabric-react/lib/components/ChoiceGroup/examples/ChoiceGroup.Image.Example.tsx') as string;
const ChoiceGroupIconExampleCode = require('!raw-loader!office-ui-fabric-react/lib/components/ChoiceGroup/examples/ChoiceGroup.Icon.Example.tsx') as string;
...
export const ChoiceGroupPageProps: IDocPageProps = {
  ...
  propertiesTablesSources: [require<string>('!raw-loader!office-ui-fabric-react/lib/components/ChoiceGroup/ChoiceGroup.types.ts')],
