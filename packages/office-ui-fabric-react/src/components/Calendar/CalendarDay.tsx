...
> {
  ...
  public render() {
    ...
    let weekNumbers = showWeekNumbers
      ? this._getWeekNumbersInMonth(
          weeks!.length,
          firstDayOfWeek,
          firstWeekOfYear,
          navigatedDate
      ...
      : null;
    let selectedDateWeekNumber = showWeekNumbers
                      ...
                      <div
                        className={css("ms-DatePicker-day", styles.day, {
                          ...
                          styles.weekIsHighlighted]:
                            selectedDateWeekNumber === weekNumber
                        })}
                      >
                  ...
                  {week.map((day, dayIndex) => (
                    <td
                      ...
                      className={css({
                        ...
                        " " +
                        this._getHighlightedCornerStyle(
                          weekCorners,
                          dayIndex,
                          weekIndex
                        )]:
                    ...
                    >
                      <div
                        className={css("ms-DatePicker-day", styles.day, {
                          ...
                          styles.dayIsFocused]: day.isInMonth,
                          ["ms-DatePicker-day--outfocus " +
                          styles.dayIsUnfocused]: !day.isInMonth,
                          ["ms-DatePicker-day--today " +
                          styles.dayIsToday]: day.isToday,
                        ...
                        id={
                          compareDates(navigatedDate, day.originalDate) ? (
                            activeDescendantId
                          ) : (
                            undefined
                          )
  ...
  private _getHighlightedCornerStyle(
    ...
    let cornerStyle = weekCorners[weekIndex + "_" + dayIndex]
  ...
  private _getWeekNumbersInMonth(
    weeksInMonth: number,
    firstDayOfWeek: DayOfWeek,
    firstWeekOfYear: FirstWeekOfYear,
    navigatedDate: Date
    ...
    let firstWeekNumber = getWeekNumber(
      firstDayOfMonth,
      firstDayOfWeek,
      firstWeekOfYear
    );
