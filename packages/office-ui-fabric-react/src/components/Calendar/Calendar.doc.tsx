...
const CalendarButtonExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/components/Calendar/Calendar.Button.Example.Codepen.txt') as string;
...
const CalendarInlineExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/components/Calendar/Calendar.Inline.Example.Codepen.txt') as string;
