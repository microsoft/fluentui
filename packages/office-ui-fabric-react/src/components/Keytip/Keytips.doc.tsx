...
const KeytipsBasicCode = require('!raw-loader!office-ui-fabric-react/lib/components/Keytip/examples/Keytips.Basic.Example.tsx') as string;
const KeytipsButtonCode = require('!raw-loader!office-ui-fabric-react/lib/components/Keytip/examples/Keytips.Button.Example.tsx') as string;
const KeytipsCommandBarCode = require('!raw-loader!office-ui-fabric-react/lib/components/Keytip/examples/Keytips.CommandBar.Example.tsx') as string;
const KeytipsOverflowCode = require('!raw-loader!office-ui-fabric-react/lib/components/Keytip/examples/Keytips.Overflow.Example.tsx') as string;
export const KeytipsPageProps: IDocPageProps = {
  ...
  propertiesTablesSources: [
    require<string>('!raw-loader!office-ui-fabric-react/lib/components/Keytip/Keytip.types.ts'),
    require<string>('!raw-loader!office-ui-fabric-react/lib/components/KeytipLayer/KeytipLayer.types.ts')
  ],
