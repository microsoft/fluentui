    ...
    return (
      <div>
        <ComponentPage
          ...
          exampleCards={
            <div>
              <ExampleCard title='Keytips on Buttons'>
                <KeytipsButtonExample />
              </ExampleCard>
              <ExampleCard title='Keytips in a CommandBar'>
                <KeytipsCommandBarExample />
              </ExampleCard>
              <ExampleCard title='Keytips in an OverflowWell'>
                <KeytipsOverflowExample />
              </ExampleCard>
              <ExampleCard title='Keytips Example'>
                <KeytipsBasicExample />
              </ExampleCard>
            </div>
          }
