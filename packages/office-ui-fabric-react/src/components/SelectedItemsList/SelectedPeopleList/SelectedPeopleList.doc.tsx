...
const PeopleSelectedItemsListExampleCode = require('!raw-loader!office-ui-fabric-react/lib/components/SelectedItemsList/examples/SelectedPeopleList.Basic.Example.tsx') as string;
...
export const SelectedPeopleListPageProps: IDocPageProps = {
  ...
  propertiesTablesSources: [
    require<string>('!raw-loader!office-ui-fabric-react/lib/components/SelectedItemsList/BaseSelectedItemsList.types.ts')
  ],
  overview: '',
  bestPractices: '',
