...
describe("OverflowSet", () => {
  ...
  describe("keytip tests", () => {
    ...
    const onRenderOverflowButton = (
      overflowElements: any[] | undefined
    ): JSX.Element => {
      return (
        <CommandBarButton
    ...
    describe("without submenus", () => {
      it("should register regular and persisted keytips", () => {
        ...
        expect(
          getKeytip(
            keytipManager,
            overflowKeytips.overflowItemKeytip1.keySequences
          )
        ).toBeDefined();
        expect(
          getKeytip(
            keytipManager,
            overflowKeytips.overflowItemKeytip2.keySequences
          )
        ).toBeDefined();
        // Persisted keytips
        expect(
          getPersistedKeytip(
            keytipManager,
            overflowKeytips.overflowItemKeytip3.keySequences
          )
        ).toBeDefined();
        expect(
          getPersistedKeytip(
            keytipManager,
            overflowKeytips.overflowItemKeytip4.keySequences
          )
        ).toBeDefined();
        ...
        expect(
          getKeytip(
            keytipManager,
            overflowKeytips.overflowButtonKeytip.keySequences
          )
        ).toBeDefined();
      });
      ...
      it("triggering the overflow button keytip should register the menu item keytips with their modified sequence", () => {
        ...
        delay(750).then(() => {
          ...
          expect(
            getKeytip(keytipManager, modifiedKeytip3Sequence)
          ).toBeDefined();
          expect(
            getKeytip(keytipManager, modifiedKeytip4Sequence)
          ).toBeDefined();
      ...
      it("overflowSetSequence gets set correctly on overflowItems keytipProps when the overflow menu is opened", () => {
        ...
        delay(750).then(() => {
          // item3
          const item3Keytip = getKeytip(
            keytipManager,
            overflowKeytips.overflowItemKeytip3.keySequences
          );
          expect(
            arraysEqual(
              item3Keytip!.overflowSetSequence!,
              overflowKeytips.overflowButtonKeytip.keySequences
            )
          ).toEqual(true);
          // item4
          const item4Keytip = getKeytip(
            keytipManager,
            overflowKeytips.overflowItemKeytip4.keySequences
          );
          expect(
            arraysEqual(
              item4Keytip!.overflowSetSequence!,
              overflowKeytips.overflowButtonKeytip.keySequences
            )
          ).toEqual(true);
        });
    ...
    describe("with submenus", () => {
      ...
      describe("with children keytips", () => {
        it("should open the overflow and submenu when the persisted keytip is triggered", () => {
          ...
          const subMenu5Keytip = getKeytip(
            keytipManager,
            modifiedKeytip5Sequence
          );
          expect(subMenu5Keytip).toBeDefined();
          expect(subMenu5Keytip!.overflowSetSequence![0]).toEqual("x");
          const subMenu6Keytip = getKeytip(
            keytipManager,
            modifiedKeytip6Sequence
          );
          ...
          delay(750).then(() => {
            ...
            submenuKeytips.forEach((submenuKeytip: IKeytipProps) => {
              ...
              expect(
                arraysEqual(
                  submenuKeytip.overflowSetSequence!,
                  overflowKeytips.overflowButtonKeytip.keySequences
                )
              ).toEqual(true);
            });
