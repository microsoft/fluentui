...
export const OverflowSetPageProps: IDemoPageProps = {
  ...
  examples: [{
    ...
    "view": <LayerHost><OverflowSetBasicExample /></LayerHost>
  }, {
    "title": "OverflowSet Vertical Example",
    "code": OverflowSetVerticalExampleCode,
    "view": <LayerHost><OverflowSetVerticalExample /></LayerHost>
  }, {
    "title": "OverflowSet Custom Example",
    "code": OverflowSetCustomExampleCode,
    "view": <LayerHost><OverflowSetCustomExample /></LayerHost>
  }],
...
export const OverflowSetPage = (props: { isHeaderVisible: boolean }) => (<DemoPage { ...{ ...OverflowSetPageProps, ...props } } />);