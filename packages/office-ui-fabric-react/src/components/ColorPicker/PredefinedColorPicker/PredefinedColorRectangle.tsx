...
export class ColorRectangle extends BaseComponent<IColorRectangleProps, IPredefinedColorPickerState> {
  ...
  public render() {
    ...
    return (
      <div ref='root' className={ css('ms-PredefinedColorPicker-colorRect', styles.colorRect) } style={ { minWidth: minSize, minHeight: minSize, backgroundColor: fullColorString } } onMouseDown={ this._onMouseDown }>
        <div className={ css('ms-PredefinedColorPicker-light', styles.light) } />
        <div className={ css('ms-PredefinedColorPicker-dark', styles.dark) } />
        <div className={ css('ms-PredefinedColorPicker-thumb', styles.thumb) } style={ { left: color.s + '%', top: (MAX_COLOR_VALUE - color.v) + '%', backgroundColor: color.str } } />
      </div>
    );
  }
