...
export class ColorSlider extends BaseComponent<IColorSliderProps, IColorSliderState> {
  ...
  public render() {
    ...
    return (
      <div
        ref='root'
        className={ css('ms-PredefinedColorPicker-slider', styles.slider, className, {
          'is-adjusting': isAdjusting
        }) }
        onMouseDown={ this._onMouseDown }>
        <div className={ css('ms-PredefinedColorPicker-sliderOverlay', styles.sliderOverlay) } style={ overlayStyle } />
        <div className={ css('ms-PredefinedColorPicker-thumb is-slider', styles.thumb, styles.thumbIsSlider) } style={ { left: currentPercentage + '%' } } />
      </div>
    );
  }
