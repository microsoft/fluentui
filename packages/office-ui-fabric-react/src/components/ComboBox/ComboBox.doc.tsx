...
const ComboBoxBasicExampleCode = require('!raw-loader!office-ui-fabric-react/lib/components/ComboBox/examples/ComboBox.Basic.Example.tsx') as string;
...
const ComboBoxTogglesExampleCode = require('!raw-loader!office-ui-fabric-react/lib/components/ComboBox/examples/ComboBox.Toggles.Example.tsx') as string;
...
const ComboBoxControlledExampleCode = require('!raw-loader!office-ui-fabric-react/lib/components/ComboBox/examples/ComboBox.Controlled.Example.tsx') as string;
...
const ComboBoxVirtualizedExampleCode = require('!raw-loader!office-ui-fabric-react/lib/components/ComboBox/examples/ComboBox.Virtualized.Example.tsx') as string;
...
const ComboBoxCustomStyledExampleCode = require('!raw-loader!office-ui-fabric-react/lib/components/ComboBox/examples/ComboBox.CustomStyled.Example.tsx') as string;
...
export const ComboBoxPageProps: IDocPageProps = {
  ...
  propertiesTablesSources: [require<string>('!raw-loader!office-ui-fabric-react/lib/components/ComboBox/ComboBox.types.ts')],
  overview: require<string>('!raw-loader!office-ui-fabric-react/lib/components/ComboBox/docs/ComboBoxOverview.md'),
  bestPractices: '',
  dos: require<string>('!raw-loader!office-ui-fabric-react/lib/components/ComboBox/docs/ComboBoxDos.md'),
  donts: require<string>('!raw-loader!office-ui-fabric-react/lib/components/ComboBox/docs/ComboBoxDonts.md'),
