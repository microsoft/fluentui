...
const getClassNames = classNamesFunction<IComboBoxStyleProps, IComboBoxStyles>();
...
export class ComboBoxBase extends BaseComponent<IComboBoxProps, IComboBoxState> {
  ...
  private _classNames: {[key in keyof IComboBoxStyles]: string };
  ...
  public render() {
    ...
    let {
      ...
      styles: customStyles,
      caretDownButtonStyles: customCaretDownButtonStyles,
      theme,
      title,
      getStyles,
      getOptionStyles,
      ...
      <div { ...divProps } ref='root' className={ this._classNames.container } >
        ...
        >
          ...
          <IconButton
            ...
            styles={ getCaretDownButtonStyles && getCaretDownButtonStyles({ theme: this.props.theme!, customCaretDownButtonStyles }) }
            role='presentation'
  ...
  private _renderOption(item: IComboBoxOption): JSX.Element {
    ...
    const rootClassNames = getComboBoxOptionClassNames(this._getCurrentOptionStyles(item, this.props.getOptionStyles)).root;
    ...
    return (
      <CommandButton
        ...
        styles={ this._getCurrentOptionStyles(item, this.props.getOptionStyles) }
        checked={ isSelected }
  ...
  private _onRenderOption(item: IComboBoxOption): JSX.Element {
    const optionClassNames = getComboBoxOptionClassNames(this._getCurrentOptionStyles(item, this.props.getOptionStyles));
   ...
   */
  private _getCurrentOptionStyles(item: IComboBoxOption, getOptionStyles?: IStyleFunction<IComboBoxOptionStyleProps, IComboBoxStyles>) {
    const { comboBoxOptionStyles: customStylesForAllOptions } = this.props;
    const { styles: customStylesForCurrentOption } = item;

    return getOptionStyles ? getOptionStyles({ theme: this.props.theme!, customStylesForAllOptions, customStylesForCurrentOption }) : {};
  }
