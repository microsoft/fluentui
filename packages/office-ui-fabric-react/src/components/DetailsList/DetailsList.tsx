...
import { BaseComponent, KeyCodes, assign, css, elementContains, getRTLSafeKeyCode, IRenderFunction, createRef } from '../../Utilities';
import {
  CheckboxVisibility,
  ColumnActionsMode,
  ConstrainMode,
...
export class DetailsList extends BaseComponent<IDetailsListProps, IDetailsListState> implements IDetailsList {
  ...
  public focusIndex(index: number, forceIntoFirstElement: boolean = false, measureItem?: (itemIndex: number) => number): void {
