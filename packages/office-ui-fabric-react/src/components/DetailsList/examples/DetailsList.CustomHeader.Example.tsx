...
const _columns: IColumn[] = [
  {
    ...
    headerClassName: mergeStyles({ fontWeight: '800' })
  },
  {
    key: 'column2',
    name: 'Value',
    ...
    headerClassName: mergeStyles({ fontWeight: '200', fontFamily: 'serif', color: 'pink' })
  }
];

export class DetailsListCustomHeaderExample extends React.Component<
  {},
  {
    items: {}[];
    selectionDetails: {};
