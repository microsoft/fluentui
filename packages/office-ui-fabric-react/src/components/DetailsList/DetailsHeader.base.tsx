...
export class DetailsHeaderBase extends React.Component<IDetailsHeaderBaseProps, IDetailsHeaderState> implements IDetailsHeader {
  ...
  public render(): JSX.Element {
    ...
    // this._columnReorderProps is calculated, so get it once
  ...
  private get _columnReorderProps(): IColumnReorderHeaderProps | undefined {
  ...
  private _onDrop = (item?: any, event?: DragEvent): void => {
    // this._columnReorderProps is calculated, so get it once (we know it's defined since we're handling a reorder)
    const columnReorderProps = this._columnReorderProps!;
  ...
  private _updateDragInfo = (props: { itemIndex: number }, event?: MouseEvent) => {
    // this._columnReorderProps is calculated, so get it once (we know it's defined since we're dragging)
    const columnReorderProps = this._columnReorderProps!;
