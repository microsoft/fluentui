...
function getColorFromName(displayName: string | undefined): PersonaInitialsColor {
...
function getInitialsColorCode(personaInitialsColor: PersonaInitialsColor | undefined, primaryText: string | undefined): string {
  let initialsColor = personaInitialsColor !== undefined ? personaInitialsColor : getColorFromName(primaryText);
