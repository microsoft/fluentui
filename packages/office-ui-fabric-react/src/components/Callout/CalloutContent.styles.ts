...
function getBeakStyle(beakWidth?: number, beakStyle?: string): IRawStyle {
...
export const getStyles = (props: ICalloutContentStyleProps): ICalloutContentStyles => {
  const { theme, className, overflowYHidden, calloutWidth, contentMaxHeight, beakWidth, backgroundColor, beakStyle } = props;
