...
const DocumentCardBasicExampleCode = require('!raw-loader!./examples/DocumentCard.Basic.Example') as string;
const DocumentCardCompleteExampleCode = require('!raw-loader!./examples/DocumentCard.Complete.Example') as string;
const DocumentCardCompactExampleCode = require('!raw-loader!./examples/DocumentCard.Compact.Example') as string;
