...
describe('Slider', () => {
  ...
  it('renders a slider', () => {
    const component = ReactTestUtils.renderIntoDocument(<Slider label="slider" />);
  ...
  it('can slide to default min/max and execute onChange', () => {
    ...
    const component = ReactTestUtils.renderIntoDocument<React.ReactInstance>(<Slider onChange={onChange} />);
  ...
  it('has type=button on all buttons', () => {
    const component = ReactTestUtils.renderIntoDocument<React.ReactInstance>(<Slider />);
  ...
  it('renders correct aria-valuetext', () => {
    let component = ReactTestUtils.renderIntoDocument(<Slider />);
    ...
    component = ReactTestUtils.renderIntoDocument(<Slider value={selected} ariaValueText={getTextValue} />);
