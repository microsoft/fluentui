  ...
  public render(): JSX.Element {
    ...
    return (
      <div className={classNames.wrapper}>
        ...
        >
          <Sticky stickyPosition={StickyPositionType.Header} order={1} stickyBackgroundColor={getTheme().palette.white}>
            <TextField className={classNames.filter} label="Filter by name:" onChange={this._onFilterChange} />
          </Sticky>
          <Sticky stickyPosition={StickyPositionType.Header} order={2} stickyBackgroundColor={getTheme().palette.white}>
