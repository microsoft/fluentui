...
export class BaseFloatingPicker<
  ...
  > extends BaseComponent<P, IBasePickerState> implements IBaseFloatingPicker<T> {
  ...
  protected resolveNewValue(updatedValue: string, suggestions: T[]) {
    ...
    this.setState({
      ...
      suggestionsVisible: this.state.queryString !== ''
      && this.props.inputElement === document.activeElement
    });
  }
  ...
  protected onSuggestionClick(
    ...
    // TODO: a call back for suggestionclicked
