...
describe('Rating', () => {
  ...
  it('Can change rating.', () => {
    ...
    let rating;
    try {
      rating = ReactTestUtils.renderIntoDocument(<RatingBase getStyles={getStyles} rating={2} />);
    } catch (e) {
      threwException = true;
    }
  ...
  it('Clamps input rating to allowed range.', () => {
    ...
    let rating;
    try {
      rating = ReactTestUtils.renderIntoDocument(<RatingBase getStyles={getStyles} rating={10} />);
    } catch (e) {
      threwException = true;
    }
    expect(threwException).toEqual(false);
  ...
  it('Half star is displayed when 2.5 value is passed.', () => {
    ...
    let rating;
    try {
      rating = ReactTestUtils.renderIntoDocument<RatingBase>(<RatingBase getStyles={getStyles} rating={2.5} />);
    } catch (e) {
      threwException = true;
    }
    expect(threwException).toEqual(false);
  ...
  it('When rating is disabled cannot change rating', () => {
    ...
    let choiceGroup;
    try {
      choiceGroup = ReactTestUtils.renderIntoDocument<RatingBase>(<RatingBase getStyles={getStyles} disabled={true} />);
    } catch (e) {
      threwException = true;
    }
    expect(threwException).toEqual(false);
  ...
  it('When rating is readonly cannot change rating', () => {
    ...
    let choiceGroup;
    try {
      choiceGroup = ReactTestUtils.renderIntoDocument<RatingBase>(<RatingBase getStyles={getStyles} readOnly={true} rating={2} />);
    } catch (e) {
      threwException = true;
    }
    expect(threwException).toEqual(false);
