...
export class Facepile extends BaseComponent<IFacepileProps, {}> {
  ...
  private _onRenderVisiblePersonas(personas: IFacepilePersona[], singlePersona: boolean): void {
  ...
  private _getElementProps(persona: IFacepilePersona, index: number): void {
    return {
