- Ensure that the width of the parent component has a fixed width that doesn't depend on the dimensions of it's children. Failure to do so may result in ResizeGroup attempting to fill a width of 0px.
