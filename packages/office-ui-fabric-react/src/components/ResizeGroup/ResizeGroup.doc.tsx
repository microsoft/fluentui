...
const ResizeGroupBasicExampleCode = require('!raw-loader!office-ui-fabric-react/lib/components/ResizeGroup/examples/ResizeGroup.OverflowSet.Example.tsx') as string;

const ResizeGroupFlexBoxExampleCode = require('!raw-loader!office-ui-fabric-react/lib/components/ResizeGroup/examples/ResizeGroup.FlexBox.Example.tsx') as string;
...
export const ResizeGroupPageProps: IDocPageProps = {
  ...
  propertiesTablesSources: [require<string>('!raw-loader!office-ui-fabric-react/lib/components/ResizeGroup/ResizeGroup.types.ts')],
