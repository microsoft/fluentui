...
/**
 * Gets the first focusable element, given a root and the current element.
 *
 * @public
 */
...
/**
 * Gets the last focusable element, contained within the root element, starting at currentElement.
 *
 * @public
 */
...
/**
 * Determines if an element can be focused or not
 *
 * @public
 */
...
/**
 * Determines if an element is in a FocusZone or not.
 *
 * @public
 */
...
/**
 * Determines if an element is a sub focus zone.
 *
 * @public
 */
...
/**
 * Tests if an element, or one of its children, is focused.
 *
 * @public
 */
