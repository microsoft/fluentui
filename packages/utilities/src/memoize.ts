...
/**
 * memoize decorator. Note that when applied to a method within a class, it is done for
 * each instance and not one for all instances. Use memoizeFunction to memoize a static
 * function.
 *
 * @public
 */
