...
// @public
export function getNativeElementProps<TAttributes extends React.HTMLAttributes<any>>(tagName: string, props: Record<string, unknown>, excludedPropNames?: string[]): TAttributes;
