...
import type { DefaultObjectSlotProps, ShorthandProps } from './types';
...
/**
 * Resolves ShorthandProps into ObjectSlotProps, to ensure normalization of the signature
 * being passed down to getSlots method
 * @param value - the base ShorthandProps
 * @param options - options to resolve ShorthandProps
 */
export function resolveShorthand<Props extends DefaultObjectSlotProps, Required extends boolean = false>(
