...
export function getNeutralVariant(theme: IPartialTheme): ITheme {
  ...
  const partialSemantic: Partial<ISemanticColors> = {
    ...
    buttonBackground: !fullTheme.isInverted ? p.neutralQuaternaryAlt : p.neutralLight,
    buttonBackgroundHovered: !fullTheme.isInverted ? p.neutralQuaternary : p.neutralQuaternaryAlt,
    buttonBackgroundPressed: !fullTheme.isInverted ? p.neutralTertiaryAlt : p.neutralQuaternary,
    buttonBackgroundDisabled: p.neutralQuaternary,
...
export function getSoftVariant(theme: IPartialTheme): ITheme {
  ...
  const partialSemantic: Partial<ISemanticColors> = {
    ...
    buttonBackgroundHovered: !fullTheme.isInverted ? p.neutralQuaternary : p.neutralQuaternaryAlt,
    buttonBackgroundPressed: !fullTheme.isInverted ? p.neutralTertiaryAlt : p.neutralQuaternary,
    buttonBackgroundDisabled: !fullTheme.isInverted ? p.neutralQuaternary : p.neutralQuaternaryAlt,
    buttonBorder: 'transparent',
    buttonText: p.neutralPrimary,
    buttonTextHovered: !fullTheme.isInverted ? p.neutralDark : p.neutralPrimary,
    buttonTextPressed: !fullTheme.isInverted ? p.neutralDark : p.neutralPrimary,
