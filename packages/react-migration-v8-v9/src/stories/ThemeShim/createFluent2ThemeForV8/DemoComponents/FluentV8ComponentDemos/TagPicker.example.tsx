import type { IBasePicker, IBasePickerSuggestionsProps, IInputProps, ITag, IToggleStyles } from '@fluentui/react';
import { mergeStyles, TagPicker, Toggle } from '@fluentui/react';
...
export const TagPickerBasicExample: React.FunctionComponent = () => {
  ...
  return (
    <div className={rootClass}>
      <Toggle styles={toggleStyles} label="Disable tag picker" checked={tagPicker} onChange={_onToggledChanged} />
