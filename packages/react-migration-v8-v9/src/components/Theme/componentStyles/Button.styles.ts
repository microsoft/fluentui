...
export function getIconButtonStyles(props: IButtonProps): IStyleFunctionOrObject<IButtonProps, IButtonStyles> {
  const { theme } = props;
  const { effects, palette, semanticColors } = theme!; // tslint:disable-line:no-non-null-assertion
...
export function getDefaultButtonStyles(props: IButtonProps): IStyleFunctionOrObject<IButtonProps, IButtonStyles> {
  ...
  return concatStyleSets(
    getBaseButtonStyles(theme!), // tslint:disable-line:no-non-null-assertion
    primary
      ? getPrimaryButtonStyles(theme!) // tslint:disable-line:no-non-null-assertion
      : getStandardButtonStyles(theme!), // tslint:disable-line:no-non-null-assertion
  );
}
