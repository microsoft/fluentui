...
export class MarqueeSelectionBase extends React.Component<IMarqueeSelectionProps, IMarqueeSelectionState> {
  ...
  private _getRootRect(): IRectangle {
    return {
      left: this._rootRect.left + (this._scrollLeft - (this._scrollableSurface?.scrollLeft || 0)),
      top: this._rootRect.top + (this._scrollTop - (this._scrollableSurface?.scrollTop || 0)),
