...
const FocusZonePhotosExampleCode = require('!raw-loader!@fluentui/react-focus/src/components/FocusZone/examples/FocusZone.Photos.Example.tsx') as string;
const FocusZoneListExampleCode = require('!raw-loader!@fluentui/react-focus/src/components/FocusZone/examples/FocusZone.List.Example.tsx') as string;
const FocusZoneDisabledExampleCode = require('!raw-loader!@fluentui/react-focus/src/components/FocusZone/examples/FocusZone.Disabled.Example.tsx') as string;
const FocusZoneTabbableCode = require('!raw-loader!@fluentui/react-focus/src/components/FocusZone/examples/FocusZone.Tabbable.Example.tsx') as string;
const FocusZoneHorizontalMenuExampleCode = require('!raw-loader!@fluentui/react-focus/src/components/FocusZone/examples/FocusZone.HorizontalMenu.Example.tsx') as string;
  ...
  public render(): JSX.Element {
    return (
      <ComponentPage
        ...
        propertiesTables={
          <PropertiesTableSet
            sources={[require<string>('!raw-loader!@fluentui/react-focus/src/components/FocusZone/FocusZone.types.ts')]}
          />
        }
        overview={
          <Markdown>{require<string>('!raw-loader!@fluentui/react-focus/src/components/FocusZone/docs/FocusZoneOverview.md')}</Markdown>
        }
