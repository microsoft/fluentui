...
export const FontFamily = () => (
  <div style={{ display: 'grid', gridTemplateColumns: 'auto 1fr', gap: '10px', alignItems: 'center' }}>
    {Object.keys(theme)
      .filter(tokenName => tokenName.startsWith('fontFamily'))
      .map((fontFamily: keyof FontFamilyTokens) => [
...
export const FontSize = () => (
  <div style={{ fontFamily: theme.fontFamilyBase }}>
    <div style={{ display: 'grid', gridTemplateColumns: 'auto 1fr', gap: '10px', alignItems: 'center' }}>
      {Object.keys(theme)
        .filter(tokenName => tokenName.startsWith('fontSize'))
        .map(fontSize => [
...
export const LineHeight = () => (
  <div style={{ fontFamily: theme.fontFamilyBase }}>
    <div style={{ display: 'grid', gridTemplateColumns: 'auto 1fr', gap: '10px', alignItems: 'center' }}>
      {Object.keys(theme)
        .filter(tokenName => tokenName.startsWith('lineHeight'))
        .map(lineHeight => [
...
export const FontWeight = () => (
  <div style={{ fontFamily: theme.fontFamilyBase }}>
    <div style={{ display: 'grid', gridTemplateColumns: 'auto 1fr', gap: '10px', alignItems: 'center' }}>
      {Object.keys(theme)
        .filter(tokenName => tokenName.startsWith('fontWeight'))
        .map((fontWeight: keyof FontWeightTokens) => [
