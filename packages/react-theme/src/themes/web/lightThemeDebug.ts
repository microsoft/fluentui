...
export const webLightThemeDebug: Record<string, string> = {
  ...
  '--alias-color-brand-brandBackground': '--global-palette-brand-primary',
  '--alias-color-brand-brandBackgroundHover': '--global-palette-brand-shade10',
  '--alias-color-brand-brandBackgroundPressed': '--global-palette-brand-shade40',
  '--alias-color-brand-brandBackgroundSelected': '--global-palette-brand-shade20',
  '--alias-color-brand-brandBackgroundStatic': '--global-palette-brand-primary',

  // TODO: should this object include only mapping to tokens or also to values?
  '--global-color-white': '#ffffff',

  // '--global-color-black': '#000000',
  //
  // '--global-palette-brand-shade60': '#092C47',
  // '--global-palette-brand-shade50': '#043862',
  // '--global-palette-brand-shade40': '#004578',
  // '--global-palette-brand-shade30': '#004C87',
  // '--global-palette-brand-shade20': '#005A9E',
  // '--global-palette-brand-shade10': '#106EBE',
  // '--global-palette-brand-primary': '#0078D4',
  // '--global-palette-brand-tint10': '#2899F5',
  // '--global-palette-brand-tint20': '#3AA0F3',
  // '--global-palette-brand-tint30': '#6CB8F6',
  // '--global-palette-brand-tint40': '#C7E0F4',
  // '--global-palette-brand-tint50': '#DEECF9',
  // '--global-palette-brand-tint60': '#EFF6FC',
  //
  // //
