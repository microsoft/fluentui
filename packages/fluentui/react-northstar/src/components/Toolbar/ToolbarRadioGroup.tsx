...
const ToolbarRadioGroup: React.FC<WithAsProp<ToolbarRadioGroupProps>> &
  ...
  const { classes } = useStyles<ToolbarRadioGroupStylesProps>(ToolbarRadioGroup.displayName, {
    className: ToolbarRadioGroup.deprecated_className,
...
ToolbarRadioGroup.deprecated_className = 'ui-toolbars'; // FIXME: required by getComponentInfo/isConformant. But this is group inside a toolbar not a group of toolbars
