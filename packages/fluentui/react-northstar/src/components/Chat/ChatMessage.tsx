...
const ChatMessage = compose<'div', ChatMessageProps, ChatMessageStylesProps, {}, {}>(
  (props, ref, composeOptions) => {
    ...
    const badgeElement = createShorthand(composeOptions.slots.label, badge, {
      defaultProps: () => ({
    ...
    const authorElement = createShorthand(composeOptions.slots.author, author, {
      defaultProps: () => ({
        size: 'small',
    ...
    const timestampElement = createShorthand(composeOptions.slots.timestamp, timestamp, {
      defaultProps: () => ({
        size: 'small',
    ...
    const messageContent = createShorthand(composeOptions.slots.content, content, {
      defaultProps: () => ({
    ...
    const headerElement = createShorthand(composeOptions.slots.header, header, {
      defaultProps: () => ({
  ...
  },
  {
    ...
    handledProps: Object.keys(propTypes) as any,
  },
) as ComponentWithAs<'div', ChatMessageProps> & {
  create: ShorthandFactory<ChatMessageProps>;
};
...
ChatMessage.propTypes = propTypes as typeof ChatMessage.propTypes;
