...
export default (siteVars): Partial<DropdownVariables> => ({
  ...
  footerMessageBackgroundColor: siteVars.colors.grey[650],
  noResultsMessageBackgroundColor: siteVars.colors.grey[650],
  loadingMessageBackgroundColor: siteVars.colors.grey[650],
});
