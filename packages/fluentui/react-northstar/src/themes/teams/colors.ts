...
export const colorScheme: ColorSchemeMapping<ColorScheme, TeamsColorNames> = {
  ...
  green: createColorScheme({
    foreground: colors.green[650],
    foreground1: colors.white,
    foreground2: colors.green[500],
    foreground3: colors.white,
    background: colors.green[500],
    background1: colors.green[500],
    background2: colors.green[50],
    border: colors.green[150],
    border1: colors.green[500],
  }),
  ...
  red: createColorScheme({
    ...
    border: colors.red[150],
    border1: colors.red[500],
  ...
  yellow: createColorScheme({
    ...
    background1: colors.yellow[50],
    background2: colors.yellow[500],
    background3: colors.yellow[50],
    border: colors.yellow[150],
    border1: colors.yellow[500],
  }),
