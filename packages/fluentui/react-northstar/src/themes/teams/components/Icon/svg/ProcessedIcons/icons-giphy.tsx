    ...
    <svg role="presentation" focusable="false" viewBox="8 8 16 16" className={classes.svg}>
      <g>
        ...
        <path
          ...
          d="M22.043 8.627c-3.842-.833-8.244-.833-12.086 0A2.51 2.51 0 0 0 8 11.074v9.852c0 1.17.823 2.199 1.957 2.446C11.877 23.79 13.91 24 16 24s4.123-.21 6.043-.628A2.511 2.511 0 0 0 24 20.926v-9.852c0-1.171-.823-2.2-1.957-2.447zM14.5 14h-1.527c-.651 0-1.179.528-1.179 1.179v1.854c0 .535.433.967.968.967h.738v-1.5H13v-1h1.5V19h-1.74a1.967 1.967 0 0 1-1.966-1.967v-1.858c0-1.201.974-2.175 2.175-2.175H14.5v1zm2.5 5h-.997v-6H17v6zm4.347-5h-1.844v1.482H21v1h-1.497V19H18.5v-6h2.847v1z"
        />
      </g>
    </svg>
  ),
