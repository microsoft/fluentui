...
export const dropdownVariables = (siteVars): DropdownVariables => ({
  ...
  containerBorderRadius: siteVars.borderRadius,
  disabledColor: siteVars.colorScheme.default.foregroundDisabled,
  openAboveContainerBorderRadius: `0 0 ${siteVars.borderRadius} ${siteVars.borderRadius}`,
  openBelowContainerBorderRadius: `${siteVars.borderRadius} ${siteVars.borderRadius} 0 0`,
  ...
  aboveListBorderRadius: `${siteVars.borderRadius} ${siteVars.borderRadius} 0 0`,
  belowListBorderRadius: `0 0 ${siteVars.borderRadius} ${siteVars.borderRadius}`,
