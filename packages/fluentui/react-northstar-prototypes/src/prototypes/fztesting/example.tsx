...
import { Avatar, Chat, Divider, Provider, teamsTheme } from '@fluentui/react-northstar';
...
const ChatExample = () => {
  let [oneMoreMessage, setOneMoreMessage] = React.useState(false);
  !oneMoreMessage &&
    setTimeout(() => {
      setOneMoreMessage(true);
    }, 3000);
  return (
    <Provider theme={teamsTheme}>
      <Chat items={items(oneMoreMessage)} />
    </Provider>
  );
};
