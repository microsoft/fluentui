import { Avatar, Chat, Button, ChatMessageProps, Ref } from '@fluentui/react-northstar';
import { menuAsToolbarBehavior } from '@fluentui/accessibility';
            ...
            <CustomMessage
              ...
              content={
                <div id={`message-conent-${i}`}>
                  ...
                  accessibility. These powerful features are exposed behind simple APIs based on natural language.
