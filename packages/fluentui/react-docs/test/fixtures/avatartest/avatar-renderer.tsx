...
import { Avatar, AvatarProps, StatusProps, ShorthandRenderer } from '@fluentui/react';
...
export const AvatarRenderer: React.FunctionComponent<IAvatarRendererProps> = ({
  alt,
  url,
  presenceUserId,
  type,
  ...
  const props: any = {
    ...
    status: presenceUserId ? (render: ShorthandRenderer<StatusProps>) => render(undefined, () => <div></div>) : undefined,
    ...rest
  };
