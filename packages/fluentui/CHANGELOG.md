...
- Updated root padding for Dialog. @TanelVari ([#16528](https://github.com/microsoft/fluentui/pull/16528))
- Fix `Accordion` title and content margins. @TanelVari ([#16533](https://github.com/microsoft/fluentui/pull/16533))
- Fixes for `Dropdown`. Fix clear indicator visual styles (focus border, correct icon). Fix empty search result text style. Fix left/right padding for multiple selection labels. @TanelVari ([#](https://github.com/microsoft/fluentui/pull/))
