...
- Restricted prop sets in the `ItemLayout` component which are passed to styles functions, @assuncaocharles ([#13327](https://github.com/microsoft/fluentui/pull/13327))
