...
- Stop propagation of left and right arrow key in `SplitButton` for the integration with toolbar @jurokapsiar ([#13111](https://github.com/microsoft/fluentui/pull/13111))
