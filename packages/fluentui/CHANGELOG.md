...
- Restricted prop sets in the `PortalInner` component which are passed to styles functions, @assuncaocharles ([#13298](https://github.com/microsoft/fluentui/pull/13298))
