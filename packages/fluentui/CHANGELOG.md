...
- Icons. Added `icons-call-switch-camera`, `icons-panorama-off`, `icons-attendee` and `icons-gvc-grid`. Updated `icons-panorama`. @TanelVari ([#12571](https://github.com/microsoft/fluentui/pull/12571))
