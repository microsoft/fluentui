...
- Set menu item active on hover @assuncaocharles ([#14730](https://github.com/microsoft/fluentui/pull/14730))
...
- Do not always `preventDefault()` in `RadioGroupItem` @layershifter ([#14734](https://github.com/microsoft/fluentui/pull/14734))
