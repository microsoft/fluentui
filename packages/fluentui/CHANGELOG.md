...
- Added new `borderActive` color design token to `categoryColorScheme` ([15717])(https://github.com/microsoft/fluentui/pull/15717)
...
- Fixed category color scheme dropdown to show all available colors ([#15717])(https://github.com/microsoft/fluentui/pull/15717)
