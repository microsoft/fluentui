...
- Udating `raise hand`, `raise hand colored` and `raise hand disabled` icons after @TanelVari ([#12342](https://github.com/OfficeDev/office-ui-fabric-react/pull/12342))
