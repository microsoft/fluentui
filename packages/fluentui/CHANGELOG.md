...
- Export `componentNameClassName` and `componentNameSlotClassName` const inside `Box`, `Button`*, `Card`* @mnajdova ([#12733](https://github.com/microsoft/fluentui/pull/12733))
