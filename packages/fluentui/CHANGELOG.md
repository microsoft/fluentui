...
- Refactor `react-context-selector` to run update with prioriy and removed strict option. @assuncaocharles ([#16714](https://github.com/microsoft/fluentui/pull/16714))
