...
export type EnhancedAction<State, Actions extends AnyActions, Action extends AnyAction = AnyActions[keyof AnyActions]> = (
  ...args: Parameters<Action>
) => (state: State, actions: Actions) => Partial<State> | void;
...
export type ManagerFactory<State, Actions extends AnyActions> = (config: ManagerConfig<State, Actions>) => Manager<State, Actions>;
