...
const skipSpecChecksForFiles = [
  ...
  'buttonGroupBehavior', // tests are written new way in buttonGroupBehaviorDefinition.ts
  'toggleButtonBehavior', // tests are written new way in toggleButtonBehaviorDefinition.ts
