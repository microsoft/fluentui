...
// The json file is generated by task 'build:docs:behavior-info'. The task will generate json file from the behaviors description.
// If you change behavior description, then you need to run:
//  - 'gulp build:docs:behavior-info' in order to get json file generated
//  OR
