  ...
  svg: ({ classes }) => (
    <svg role="presentation" focusable="false" viewBox="2 2 16 16" className={classes.svgFlippingInRtl}>
      ...
      <g className={cx(iconClassNames.filled, classes.filledPart)}>
        ...
        <path d="M7.75 13.5C7.33579 13.5 7 13.8358 7 14.25C7 14.6642 7.33579 15 7.75 15H17.25C17.6642 15 18 14.6642 18 14.25C18 13.8358 17.6642 13.5 17.25 13.5H7.75Z" />
        ...
        <path d="M3.25 15.5C3.94036 15.5 4.5 14.9404 4.5 14.25C4.5 13.5596 3.94036 13 3.25 13C2.55964 13 2 13.5596 2 14.25C2 14.9404 2.55964 15.5 3.25 15.5Z" />
      </g>
    </svg>
  ),
