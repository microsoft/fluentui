...
export const HorizontalRuleIcon = createSvgIcon({
  svg: ({ classes }) => (
    <svg role="presentation" focusable="false" viewBox="8 8 20 20" className={classes.svg}>
      <g>
        <path
          className={cx(iconClassNames.outline, classes.outlinePart, classes.temp_8_8_16_16)}
        ...
        />
        <path
          className={cx(iconClassNames.filled, classes.filledPart, classes.temp_8_8_16_16)}
