  ...
  svg: ({ classes }) => (
    <svg role="presentation" focusable="false" viewBox="2 2 16 16" className={classes.svg}>
      ...
      <path
        ...
        d="M10 2C11.6569 2 13 3.34315 13 5V6H14C15.1046 6 16 6.89543 16 8V15C16 16.1046 15.1046 17 14 17H6C4.89543 17 4 16.1046 4 15V8C4 6.89543 4.89543 6 6 6H7V5C7 3.34315 8.34315 2 10 2ZM10 10.5C9.44772 10.5 9 10.9477 9 11.5C9 12.0523 9.44772 12.5 10 12.5C10.5523 12.5 11 12.0523 11 11.5C11 10.9477 10.5523 10.5 10 10.5ZM10 4C9.44772 4 9 4.44772 9 5V6H11V5C11 4.44772 10.5523 4 10 4Z"
      />
    </svg>
  ),
