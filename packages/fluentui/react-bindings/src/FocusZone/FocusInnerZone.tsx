...
const _allInstances: {
  [key: string]: FocusInnerZone;
} = {};

const outerZones = {
  _windowToOuterZoneMap: new Map<Window, Set<FocusInnerZone>>(),
  register(window: Window, FZ: FocusInnerZone) {
  ...
  unregister(window: Window, FZ: FocusInnerZone) {
...
export class FocusInnerZone extends React.Component<FocusZoneProps> implements IFocusZone {
  static propTypes = {
  ...
  render() {
    ...
    const unhandledProps = getUnhandledProps(_.keys(FocusInnerZone.propTypes) as any, this.props);
    ...
    return (
      <ElementType
        ...
        className={cx(FocusInnerZone.className, className)}
   ...
   */
  getFirstInnerZone(forRootElement?: HTMLElement | null): FocusInnerZone | null {
