...
import { Box, ThemePrepared, Grid, Header, HeaderProps, ShorthandCollection } from '@fluentui/react-northstar';
...
const ColorSchemes: React.FC<ColorVariantsProps> = ({ name, themes, headers }) => {
