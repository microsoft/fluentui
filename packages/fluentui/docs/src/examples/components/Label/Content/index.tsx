...
const Content = () => (
  <ExampleSection title="Content">
    ...
    <ComponentExample title="Image" description="A label can contain image." examplePath="components/Label/Content/LabelExampleImage" />
    <ComponentExample
    ...
    />
    <ComponentExample title="Icon" description="A label can contain icon." examplePath="components/Label/Content/LabelExampleIcon" />
    <ComponentExample
      title="Icon position"
