...
const Slots = () => (
  <ExampleSection title="Slots">
    <ComponentExample title="Content" description="A menu can have content." examplePath="components/Menu/Slots/MenuExampleSlot" />
    <ComponentExample title="Icon Only" description="A menu can have only icons." examplePath="components/Menu/Slots/MenuExampleIconOnly" />
    <ComponentExample
      title="Icon &amp; content"
