...
const doList = [
  <Text>Choose desired accessibility behavior depending on the use case. (Check the {link('Behaviors', '/behaviors/menu')} section).</Text>,
  ...
  <Text>For render tree customization, use {link('render callback argument', '/shorthand-props#render-callback-argument')}.</Text>
];
