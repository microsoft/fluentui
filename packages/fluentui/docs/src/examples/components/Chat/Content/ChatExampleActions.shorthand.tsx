...
const items: ShorthandCollection<ChatItemProps> = [
  {
    attached: 'top',
    contentPosition: 'end',
    message: <Chat.Message actionMenu={actionMenu} content="Hello" author="John Doe" timestamp="Yesterday, 10:15 PM" mine />,
    key: 'message-1'
  },
  {
    attached: 'bottom',
    contentPosition: 'end',
    key: 'message-2',
    message: <Chat.Message actionMenu={actionMenu} content="I'm back!" author="John Doe" timestamp="Yesterday, 10:15 PM" mine />
  },
  {
