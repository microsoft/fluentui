import { StyleOverridesConcatenation, StyleOverridesPseudo, StyleOverridesText, StyleOverridesSlots } from './examples';
...
Like in usual CSS in JS styles that exists in Fluent UI Northstar `useCSS()` also handles pseudo selectors and RTL.
