...
export function useCardStyles(state: CardState): CardState {
  ...
  state.className = useAx(
    ...
    state.onClick && styles.clickable,
    state.size === 'small' && styles.small,
    state.size === 'smaller' && styles.smaller,
    state.size === 'smallest' && styles.smallest,
    state.size === 'large' && styles.large,
    state.size === 'larger' && styles.larger,
    state.size === 'largest' && styles.largest,
    state.className,
  );
