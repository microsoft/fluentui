...
import { DEFAULT_CELL_STYLE_PROPS } from 'office-ui-fabric-react/lib/components/DetailsList/DetailsRow.styles';
import { CHECK_CELL_WIDTH } from 'office-ui-fabric-react/lib/components/DetailsList/DetailsRowCheck.styles';
