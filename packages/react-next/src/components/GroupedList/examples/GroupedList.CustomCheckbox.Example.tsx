...
import {
  ...
  IGroupHeaderProps,
} from '@fluentui/react-next/lib/GroupedList';
import { IColumn, DetailsRow } from '@fluentui/react-next/lib/DetailsList';
import { FocusZone } from '@fluentui/react-next/lib/FocusZone';
import { Selection, SelectionMode, SelectionZone } from '@fluentui/react-next/lib/Selection';
