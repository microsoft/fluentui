...
export class GroupedListBase<T> extends React.Component<IGroupedListProps<T>, IGroupedListState>
  ...
  public UNSAFE_componentWillReceiveProps(newProps: IGroupedListProps<T>): void {
