...
const GroupedListBasicExampleCode = require('!raw-loader!@fluentui/react-next/src/components/GroupedList/examples/GroupedList.Basic.Example.tsx') as string;
const GroupedListCustomExampleCode = require('!raw-loader!@fluentui/react-next/src/components/GroupedList/examples/GroupedList.Custom.Example.tsx') as string;
const GroupedListCustomCheckboxExampleCode = require('!raw-loader!@fluentui/react-next/src/components/GroupedList/examples/GroupedList.CustomCheckbox.Example.tsx') as string;
...
export const GroupedListPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@fluentui/react-next/src/components/GroupedList/docs/GroupedListOverview.md'),
  bestPractices: '',
  dos: '',
  donts: '',
