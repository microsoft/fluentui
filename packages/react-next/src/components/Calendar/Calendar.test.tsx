...
describe('Calendar', () => {
  ...
  describe('Test rendering simplest calendar', () => {
    ...
    beforeAll(() => {
      renderedComponent = mount(<Calendar strings={dayPickerStrings} isMonthPickerVisible={false} />);
    });
    ...
    it('Verify day picker header', () => {
      ...
      const dayPickerMonth = renderedComponent.getDOMNode().querySelector('.ms-DatePicker-monthAndYear');
    ...
    it('Verify first day of week', () => {
      const dayHeaders = renderedComponent.getDOMNode().querySelectorAll('.ms-DatePicker-weekday');
    ...
    it('Verify go to today', () => {
      const goToToday = renderedComponent.getDOMNode().querySelector('.ms-DatePicker-goToday');
  ...
  describe('Test rendering most complicated calendar', () => {
    ...
    it('Verify month picker seen', () => {
      const monthPicker = renderedComponent.getDOMNode().querySelector('.ms-DatePicker-monthPicker') as HTMLElement;
      expect(monthPicker).toBeDefined();
      expect(monthPicker.style.display).not.toEqual('none');
    });

    it('Verify month picker header', () => {
      const currentYear = renderedComponent.getDOMNode().querySelector('.ms-DatePicker-currentYear');
    ...
    it('Verify month picker months', () => {
      const months = renderedComponent.getDOMNode().querySelectorAll('.ms-DatePicker-monthOption');
    ...
    it('Verify navigate to different week in same month', () => {
      ...
      const days = renderedComponent.getDOMNode().querySelectorAll('.ms-DatePicker-day-button');
    ...
    it('Verify class name', () => {
      const root = renderedComponent.getDOMNode();
  ...
  describe('render with date boundaries', () => {
    it('out-of-bounds days should be disabled', () => {
      ...
      const days = (renderedComponent
        .getDOMNode()
        .querySelectorAll('.ms-DatePicker-day-button') as unknown) as Element[];
  ...
  it('navigators to out-of-bounds months should be disabled', () => {
    ...
    const prevMonth = renderedComponent.getDOMNode().querySelector('.ms-DatePicker-prevMonth');
    const nextMonth = renderedComponent.getDOMNode().querySelector('.ms-DatePicker-nextMonth');
  ...
  it('out-of-bounds months should be disabled', () => {
    ...
    const months = (renderedComponent
      .getDOMNode()
      .querySelectorAll('.ms-DatePicker-monthOption') as unknown) as Element[];
  ...
  it('navigators to out-of-bounds years should be disabled', () => {
    ...
    const prevMonth = renderedComponent.getDOMNode().querySelector('.ms-DatePicker-prevYear');
    const nextMonth = renderedComponent.getDOMNode().querySelector('.ms-DatePicker-nextYear');
  ...
  describe('Test Rendering Calendar with Year Picker', () => {
    ...
    it('month header should have button role', () => {
      const monthHeader = renderedComponent.getDOMNode().querySelector('.ms-DatePicker-currentYear');
    ...
    it('year picker should show when clicking month header', () => {
      ...
      const yearHeader = renderedComponent.getDOMNode().querySelector('.ms-DatePicker-currentDecade');
      expect(yearHeader).toBeTruthy();
      // month header shouldn't actually be rendered
      const monthHeaders = renderedComponent.getDOMNode().querySelectorAll('.ms-DatePicker-currentYear');
      expect(monthHeaders?.length).toBe(0);
    });

    it('year picker cells render as expected', () => {
      // working with the year grid
      const grid = renderedComponent.getDOMNode().querySelector('.ms-DatePicker-optionGrid')!;
