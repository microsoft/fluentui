...
export const SwatchColorPickerPageProps: IDocPageProps = {
  ...
  dos: require<
    string
  >('!raw-loader!@fluentui/react-next/src/components/SwatchColorPicker/docs/SwatchColorPickerDos.md'),
  donts: require<
    string
  >('!raw-loader!@fluentui/react-next/src/components/SwatchColorPicker/docs/SwatchColorPickerDonts.md'),
