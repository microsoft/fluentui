...
// const useComponentRef = (props: IToggleProps, nextProps: Readonly<IToggleProps>,
...
const useComponentRef = (props: IToggleProps, isChecked: boolean | undefined, toggleButton: React.RefObject) => {
  React.useImperativeHandle(
    props.componentRef,
    () => ({
      get checked() {
