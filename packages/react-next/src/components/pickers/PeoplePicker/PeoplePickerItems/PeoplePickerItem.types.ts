...
import { IPersonaStyles, IPersonaCoinStyles } from 'office-ui-fabric-react';
...
export interface IPeoplePickerItemSelectedSubComponentStyles {
  ...
  persona: IStyleFunctionOrObject<IPersonaStyleProps, IPersonaStyles>;

  /** Refers to the PersonaCoin in the Persona rendered within the PeoplePickerItemSelected */
  personaCoin?: IStyleFunctionOrObject<IPersonaCoinStyleProps, IPersonaCoinStyles>;
}
