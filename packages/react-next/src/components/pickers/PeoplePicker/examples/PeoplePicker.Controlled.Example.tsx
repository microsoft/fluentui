...
import { DefaultButton, IButtonStyles } from '@fluentui/react-next/lib/compat/Button';
import { Checkbox } from '@fluentui/react-next/lib/Checkbox';
import { IPersonaProps, Persona } from '@fluentui/react-next/lib/Persona';
import { IBasePickerSuggestionsProps, NormalPeoplePicker } from '@fluentui/react-next/lib/Pickers';
        ...
        {controlledItems.map((item, index) => (
          <div key={index}>
            <DefaultButton
              ...
              // eslint-disable-next-line react/jsx-no-bind
              onClick={() => setCurrentSelectedItems(currentSelectedItems?.concat([item]) ?? [item])}
            >
              <Persona {...item} />
            </DefaultButton>
          </div>
