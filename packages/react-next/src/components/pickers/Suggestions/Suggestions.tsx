...
const legacyStyles: Record<string, string> = stylesImport;

const getClassNames = classNamesFunction<ISuggestionsStyleProps<unknown>, ISuggestionsStyles>();

export interface ISuggestionsState {
  selectedActionType: SuggestionActionType;
}

const StyledSuggestionsItem = styled<ISuggestionItemProps<unknown>, ISuggestionsItemStyleProps, ISuggestionsItemStyles>(
  SuggestionsItem,
