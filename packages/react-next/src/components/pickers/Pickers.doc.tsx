...
const TagPickerExampleCode = require('!raw-loader!@fluentui/react-next/src/components/pickers/examples/TagPicker.Basic.Example.tsx') as string;
const PickerCustomResultExampleCode = require('!raw-loader!@fluentui/react-next/src/components/pickers/examples/Picker.CustomResult.Example.tsx') as string;
...
export const PickersPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@fluentui/react-next/src/components/pickers/docs/PickersOverview.md'),
