  ...
  (props, forwardedRef, composeOptions) => {
    ...
    return (
      <slots.root {...slotProps.root}>
        <slots.input {...slotProps.input} {...keytipData?.executeElementAttributes} />
        <slots.container {...slotProps.container}>
          <slots.checkbox {...slotProps.checkbox} {...keytipData?.targetElementAttributes}>
