...
const ComboBoxBasicExampleCode = require('!raw-loader!@fluentui/react-next/src/components/ComboBox/examples/ComboBox.Basic.Example.tsx') as string;

const ComboBoxTogglesExampleCode = require('!raw-loader!@fluentui/react-next/src/components/ComboBox/examples/ComboBox.Toggles.Example.tsx') as string;

const ComboBoxControlledExampleCode = require('!raw-loader!@fluentui/react-next/src/components/ComboBox/examples/ComboBox.Controlled.Example.tsx') as string;

const ComboBoxVirtualizedExampleCode = require('!raw-loader!@fluentui/react-next/src/components/ComboBox/examples/ComboBox.Virtualized.Example.tsx') as string;

const ComboBoxErrorHandlingExampleCode = require('!raw-loader!@fluentui/react-next/src/components/ComboBox/examples/ComboBox.ErrorHandling.Example.tsx') as string;

const ComboBoxCustomStyledExampleCode = require('!raw-loader!@fluentui/react-next/src/components/ComboBox/examples/ComboBox.CustomStyled.Example.tsx') as string;
...
export const ComboBoxPageProps: IDocPageProps = {
  ...
  overview: require<string>('!raw-loader!@fluentui/react-next/src/components/ComboBox/docs/ComboBoxOverview.md'),
  bestPractices: require<
    string
  >('!raw-loader!@fluentui/react-next/src/components/ComboBox/docs/ComboBoxBestPractices.md'),
