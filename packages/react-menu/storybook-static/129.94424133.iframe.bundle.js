(self.webpackChunk_fluentui_react_menu = self.webpackChunk_fluentui_react_menu || []).push([
  [129],
  {
    '../../node_modules/@storybook/components/dist/esm/tooltip/WithTooltip.js': (
      ...
      function Manager(_ref) {
        ...
        return (
          ...
          react.createElement(
            ...
            { value: referenceNode },
            react.createElement(ManagerReferenceNodeSetterContext.Provider, { value: setReferenceNode }, children),
          )
        );
      }
      ...
      function getParentNode(element) {
        return 'html' === getNodeName(element)
          ? element
          : element.assignedSlot || element.parentNode || element.host || getDocumentElement(element);
      }
      ...
      function listScrollParents(element, list) {
        ...
        var scrollParent = getScrollParent(element),
          isBody = scrollParent === element.ownerDocument.body,
      ...
      function getTrueOffsetParent(element) {
        ...
        if (offsetParent) {
          ...
          if (
            ...
            'static' !== getComputedStyle(html).position
          )
            return html;
        }
        return offsetParent;
            ...
            instance = {
              ...
              setOptions: function setOptions(options) {
                ...
                (state.orderedModifiers = orderedModifiers.filter(function (m) {
                  ...
                  'auto' === getBasePlacement(state.options.placement) &&
      ...
      function mapToStyles(_ref2) {
        ...
        if (adaptive) {
          ...
          offsetParent === getWindow(popper) && (offsetParent = getDocumentElement(popper)),
            placement === enums_top &&
              ((sideY = bottom), (y -= offsetParent.clientHeight - popperRect.height), (y *= gpuAcceleration ? 1 : -1)),
            placement === left &&
              ((sideX = right), (x -= offsetParent.clientWidth - popperRect.width), (x *= gpuAcceleration ? 1 : -1));
        }
        var _Object$assign,
      ...
      function mergePaddingObject(paddingObject) {
        return Object.assign(Object.assign({}, { top: 0, right: 0, bottom: 0, left: 0 }), paddingObject);
      }
      ...
      var popper_createPopper = popperGenerator({
                    ...
                    (state.styles.arrow = Object.assign(
                      ...
                      mapToStyles(
                        Object.assign(
                          Object.assign({}, commonStyles),
                          {},
                          { offsets: state.modifiersData.arrow, position: 'absolute', adaptive: !1, roundOffsets },
                        ),
                      ),
                    )),
        ...
        react_fast_compare = __webpack_require__(
          '../../node_modules/react-popper-tooltip/node_modules/react-fast-compare/index.js',
        ),
          ...
          _usePopper = (function usePopper(referenceElement, popperElement, options) {
            ...
            var prevOptions = react.useRef(null),
              ...
              _React$useState = react.useState({
                styles: { popper: { position: optionsWithDefaults.strategy, left: '0', top: '0' } },
                attributes: {},
              }),
              ...
              (_this.getArrowProps = function (props) {
                return (
                  ...
                  (0, esm_extends.Z)({}, props, {
                    style: (0, esm_extends.Z)({}, props.style, _this.props.arrowProps.style),
                  })
                );
              }),
    ...
    '../../node_modules/react-popper-tooltip/node_modules/react-fast-compare/index.js': module => {
    ...
    '../../node_modules/warning/warning.js': module => {
      ...
      var warning = function () {},
        printWarning = function printWarning(format, args) {
...
//# sourceMappingURL=129.94424133.iframe.bundle.js.map
