(self.webpackChunk_fluentui_react_menu = self.webpackChunk_fluentui_react_menu || []).push([
  [135],
  {
    '../../node_modules/@storybook/components/dist/esm/controls/Color.js': (
      ...
      var c = 'undefined' != typeof window ? react.useLayoutEffect : react.useEffect;
      function i(e) {
        var r = (0, react.useRef)(e);
        return (
      ...
      var s,
        ...
        m = react.memo(function (r) {
          var t = r.onMove,
            s = r.onKey,
            f = u(r, ['onMove', 'onKey']),
            m = (0, react.useRef)(null),
            g = (0, react.useRef)(!1),
            p = (0, react.useState)(!1),
            b = p[0],
            _ = p[1],
            C = i(t),
            x = i(s),
            ...
            H = (0, react.useCallback)(
              function (e) {
                ...
                h(t),
                  (r = t),
                  (g.current && !v(r)) || (g.current || (g.current = v(r)), 0) || !o || (o.focus(), C(d(o, t)), _(!0));
              },
              [C],
            ),
            M = (0, react.useCallback)(
              function (e) {
                ...
                r < 37 ||
                  r > 40 ||
                  (e.preventDefault(),
                  x({ left: 39 === r ? 0.05 : 37 === r ? -0.05 : 0, top: 40 === r ? 0.05 : 38 === r ? -0.05 : 0 }));
              },
              [x],
            ),
        ...
        N = function (e) {
          ...
          return {
            h: b(e.h),
            s: b(n > 0 && n < 200 ? ((r * t) / 100 / (n <= 100 ? n : 200 - n)) * 100 : 0),
            l: b(n / 2),
            a: b(o, 2),
          };
        },
        ...
        q = function (e) {
          ...
          var a = Math.floor(r),
            ...
            i = a % 6;
          return {
            r: b(255 * [o, u, l, l, c, o][i]),
            g: b(255 * [c, o, o, u, l, l][i]),
            b: b(255 * [l, l, c, o, o, u][i]),
            a: b(n, 2),
          };
        },
        I = function (e) {
      ...
      function S(e, r, l) {
        var u = i(l),
          ...
          s = c[0],
          f = c[1],
          v = (0, react.useRef)({ color: r, hsva: s });
        (0, react.useEffect)(
          function () {
      ...
      var P,
        ...
        $ = function (r) {
          ...
          return react.createElement(
            ...
            react.createElement(A, { hue: f.h, onChange: v, className: 'react-colorful__last-control' }),
          );
        },
        R = {
          defaultColor: '000',
        ...
        Q = function (r) {
          ...
          return react.createElement(
            ...
            l({}, i, { className: d }),
            react.createElement(L, { hsva: f, onChange: v }),
            react.createElement(A, { hue: f.h, onChange: v }),
      ...
      var COLOR_SPACES = Object.values(ColorSpace),
        ...
        ColorPicker =
          (_defineProperty((_ColorPicker = {}), ColorSpace.HEX, function (r) {
            return react.createElement($, l({}, r, { colorModel: R }));
          }),
          _defineProperty(_ColorPicker, ColorSpace.RGB, function (r) {
            return react.createElement(Q, l({}, r, { colorModel: he }));
          }),
          _defineProperty(_ColorPicker, ColorSpace.HSL, function (r) {
            return react.createElement(Q, l({}, r, { colorModel: W }));
          }),
          _ColorPicker),
        fallbackColor =
          ...
          if (value) {
            ...
            if (RGB_REGEXP.test(value)) {
              var _ref8,
                ...
                b = _stringToArgs2[2],
                a = _stringToArgs2[3],
                _ref7 = _slicedToArray(color_convert_default().rgb.hsl([r, g, b]) || [0, 0, 0], 3),
                h = _ref7[0],
                s = _ref7[1],
                l = _ref7[2];
              return (
                ...
                _defineProperty(
                  _ref8,
                  ColorSpace.HEX,
                  '#'.concat(color_convert_default().rgb.hex([r, g, b]).toLowerCase()),
                ),
                _ref8
              );
            }
            if (HSL_REGEXP.test(value)) {
              var _ref11,
                ...
                _l = _stringToArgs4[2],
                _a = _stringToArgs4[3],
                _ref10 = _slicedToArray(color_convert_default().hsl.rgb([_h, _s2, _l]) || [0, 0, 0], 3),
                _r = _ref10[0],
                _g = _ref10[1],
                _b = _ref10[2];
              return (
                ...
                _defineProperty(
                  _ref11,
                  ColorSpace.HEX,
                  '#'.concat(color_convert_default().hsl.hex([_h, _s2, _l]).toLowerCase()),
                ),
                _ref11
              );
            }
        ...
        useColorInput = function useColorInput(initialValue, onChange) {
          var _useState2 = _slicedToArray((0, react.useState)(initialValue || ''), 2),
            ...
            _useState6 = _slicedToArray(
              (0, react.useState)((null == color ? void 0 : color.colorSpace) || ColorSpace.HEX),
              2,
            ),
        ...
        ColorControl = function ColorControl(_ref13) {
          var name = _ref13.name,
            ...
            _useColorInput = useColorInput(initialValue, throttle_default()(onChange, 200)),
            ...
            _usePresets = (function usePresets(presetColors, currentColor, colorSpace) {
              var _useState8 = _slicedToArray(
                  (0, react.useState)(null != currentColor && currentColor.valid ? [currentColor] : []),
                  2,
                ),
                    ...
                    return (presetColors || [])
                      .map(function (preset) {
                        return 'string' == typeof preset
                          ? parseValue(preset)
                          : preset.title
                          ? Object.assign({}, parseValue(preset.color), { keyword: preset.title })
    ...
    '../../node_modules/@storybook/components/node_modules/color-convert/conversions.js': (
      ...
      (convert.rgb.hsl = function (rgb) {
        ...
        (convert.hsl.rgb = function (hsl) {
          ...
          for (var t1 = 2 * l - (t2 = l < 0.5 ? l * (1 + s) : l + s - l * s), rgb = [0, 0, 0], i = 0; i < 3; i++)
            (t3 = h + (1 / 3) * -(i - 1)) < 0 && t3++,
              t3 > 1 && t3--,
              (val =
                6 * t3 < 1
    ...
    '../../node_modules/@storybook/components/node_modules/color-convert/index.js': (
      ...
      var conversions = __webpack_require__(
        ...
        route = __webpack_require__('../../node_modules/@storybook/components/node_modules/color-convert/route.js'),
        convert = {};
...
//# sourceMappingURL=135.2ba59a88.iframe.bundle.js.map
