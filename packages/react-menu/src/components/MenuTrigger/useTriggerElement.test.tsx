...
describe('useTriggerElement', () => {
  ...
  describe('on click', () => {
    ...
    it('should open menu', () => {
      ...
      // Assert
      expect(spy).toHaveBeenCalledTimes(1);
      expect(spy).toHaveBeenCalledWith(expect.anything(), { shouldOpen: true, keyboard: false });
    });
  ...
  describe('on hover', () => {
    ...
    it.each([
      ...
      // Assert
      expect(spy).toHaveBeenCalledTimes(1);
      expect(spy).toHaveBeenCalledWith(expect.anything(), { shouldOpen: expectedValue, keyboard: false });
    });
  ...
  it('should open menu on right arrow for submenu trigger', () => {
    ...
    // Assert
    expect(spy).toHaveBeenCalledTimes(1);
    expect(spy).toHaveBeenCalledWith(expect.anything(), { shouldOpen: true, keyboard: true });
  });
