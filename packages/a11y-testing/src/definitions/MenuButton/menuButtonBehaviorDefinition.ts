...
const menuButtonBehaviorDefinitionTriggerSlot: Rule[] = [
  BehaviorRule.slot('trigger')
    .forProps({ open: true })
    .hasAttribute('aria-controls', 'menu'),
  BehaviorRule.slot('trigger')
    .forProps({ open: false })
  ...
  BehaviorRule.slot('trigger')
    ...
    .hide(),
  BehaviorRule.slot('trigger')
    .forProps({ contextMenu: false })
    .hasAttribute('aria-haspopup', 'true'),
  BehaviorRule.slot('trigger')
    .forProps({ contextMenu: true })
...
export const menuButtonBehaviorDefinitionMenuSlot: Rule[] = [
  BehaviorRule.slot('menu')
    .forProps({ open: true })
    .hasAttribute('aria-labelledby', 'trigger', true)
    .description(`if 'ID' is defined for the 'trigger' slot.`),
  BehaviorRule.slot('menu')
    .forProps({ open: true })
    .hasAttribute('id', 'menu', true)
