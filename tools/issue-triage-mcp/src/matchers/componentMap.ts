...
export const COMPONENT_MAP: ComponentEntry[] = [
  ...
  // ── FluentProvider / Theme ────────────────────────────────────
  {
    ...
    relatedDirs: ['packages/react-components/react-theme/src', 'packages/react-components/react-shared-contexts/src'],
  },
  ...
  // ── Charts (react-charting / react-charts) ────────────────────
  {
    ...
    keyFiles: [],
    relatedDirs: ['packages/charts/react-charts/library/src', 'packages/charts/chart-utilities/src'],
  },
];
