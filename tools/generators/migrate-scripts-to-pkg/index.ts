...
export default async function (tree: Tree, schema: MigrateScriptsToPkgGeneratorSchema) {
...
function normalizeOptions(tree: Tree, options: MigrateScriptsToPkgGeneratorSchema) {
