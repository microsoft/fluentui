...
We have been working for a bit on convergence and leaning the towers between libraries formerly known as Stardust and Fabric. We've made good progress on defining the [component model](https://github.com/microsoft/fluentui/tree/master/packages/react-compose/src/next) to use, and are now making progress on styling and theming components built upon it.
