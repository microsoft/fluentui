...
- [RFC: Support for components in the Fluent UI umbrella that are not core](#rfc-support-for-components-in-the-fluent-ui-umbrella-that-are-not-core)
  - [Summary](#summary)
  ...
  - [Detailed Design or Proposal](#detailed-design-or-proposal)
    - [Deviating from v9 core concepts](#deviating-from-v9-core-concepts)
      - [Pros](#pros)
      - [Cons](#cons)
    - [Breaking change cadence](#breaking-change-cadence)
      - [Same cadence as core components](#same-cadence-as-core-components)
        - [Pros](#pros-1)
        - [Cons](#cons-1)
      - [Faster than core components](#faster-than-core-components)
        - [Pros](#pros-2)
        - [Cons](#cons-2)
    - [Choosing a repo for](#choosing-a-repo-for)
      - [Current monorepo](#current-monorepo)
        - [Pros](#pros-3)
        - [Cons](#cons-3)
      - [Separate monorepo](#separate-monorepo)
        - [Pros](#pros-4)
        - [Cons](#cons-4)
    - [Package scope](#package-scope)
      - [@fluentui scope](#fluentui-scope)
        - [Pros](#pros-5)
        - [Cons](#cons-5)
      - [New package scope](#new-package-scope)
        - [Pros](#pros-6)
        - [Cons](#cons-6)
    - [How users should consume components](#how-users-should-consume-components)
      - [Suite packages](#suite-packages)
        - [Pros](#pros-7)
        - [Cons](#cons-7)
    ...
    - [How to depend on core components](#how-to-depend-on-core-components)
      - [Depend directly on components packages](#depend-directly-on-components-packages)
        - [Pros](#pros-9)
        - [Cons](#cons-9)
      - [Depend on suite package is peer dependency](#depend-on-suite-package-is-peer-dependency)
      - [Pros](#pros-10)
      - [Cons](#cons-10)
    - [Documentation](#documentation)
      ...
      - [New docsite](#new-docsite)
        - [Pros](#pros-12)
        - [Cons](#cons-12)
    - [Parnter ownership and collaboration](#parnter-ownership-and-collaboration)
      - [GitHub](#github)
        - [Pros](#pros-13)
        - [Cons](#cons-13)
